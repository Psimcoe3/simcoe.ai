...
namespace Revit.SDK.Samples.MultiplanarRebar.CS
{
    ...
    class Trapezoid
    {
        ...
        public RebarShape ConstructMultiplanarRebarShape(Document revitDoc, double bendDiameter)
        {
            ...
            RebarShapeTerminationsData rebarShapeTerminationsData = new RebarShapeTerminationsData(revitDoc);
            ...
            RebarShape newshape = RebarShape.Create(revitDoc, shapedef, multiPlanarDef,
                 RebarStyle.StirrupTie, StirrupTieAttachmentType.InteriorFace, 0, rebarShapeTerminationsData);
    ...
    class CorbelFrame
    {
        ...
        private void PlaceStraightBars(CorbelReinforcementOptions options)
        {
            ...
            BarTerminationsData barTerminationsData = new BarTerminationsData(options.RevitDoc);

            Rebar bars = Rebar.CreateFromCurves(options.RevitDoc, RebarStyle.Standard,
                options.TopBarType, m_corbel, extruDir, barCurves, barTerminationsData, true, true);
        ...
        private void PlaceCorbelHostBars(CorbelReinforcementOptions options)
        {
            ...
            Rebar bars = Rebar.CreateFromCurves(
                ...
                options.HostStraightBarType, m_corbel.Host, extruDir, 
                barCurves, barTerminationsData, true, true);
