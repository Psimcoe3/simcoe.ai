...
namespace Revit.SDK.Samples.Reinforcement.CS
{
    ...
    public class FramReinMaker : IFrameReinMaker
    {
      ...
      public bool Run()
        ...
        /// <param name="geomInfo">The geometry information of the rebar</param>
        ...
        protected Rebar PlaceRebars(RebarBarType rebarType, RebarHookType startHook,
                                            ...
                                            RebarTerminationOrientation startOrient, RebarTerminationOrientation endOrient)
        {
            ...
            BarTerminationsData barTerminationsData = new BarTerminationsData(m_revitDoc);
            barTerminationsData.HookTypeIdAtStart = startHook != null ? startHook.Id : ElementId.InvalidElementId;
            barTerminationsData.HookTypeIdAtEnd = endHook != null ? endHook.Id : ElementId.InvalidElementId;
            barTerminationsData.TerminationOrientationAtStart = startOrient;
            barTerminationsData.TerminationOrientationAtStart = endOrient;

            Rebar createdRebar = Rebar.CreateFromCurves(m_revitDoc, Autodesk.Revit.DB.Structure.RebarStyle.Standard, rebarType, 
                                         m_hostObject, normal, curves, barTerminationsData, false, true);
