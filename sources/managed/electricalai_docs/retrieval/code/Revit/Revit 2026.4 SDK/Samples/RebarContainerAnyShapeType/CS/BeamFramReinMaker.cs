...
namespace Revit.SDK.Samples.RebarContainerAnyShapeType.CS
{
   ...
   public class BeamFramReinMaker : FramReinMaker
   {
      ...
      public bool FillBottomItems(RebarContainer cont)
      {
         ...
         RebarContainerItem item = PlaceContainerItem(cont, m_bottomType, null, null, geomInfo, RebarTerminationOrientation.Left, RebarTerminationOrientation.Left);
         return (null != item);
      }
      ...
      public RebarContainerItem FillTransverseItem(RebarContainer cont, TransverseRebarLocation location)
      {
         ...
         RebarTerminationOrientation startHookOrientation = RebarTerminationOrientation.Left;
         RebarTerminationOrientation endHookOrientation = RebarTerminationOrientation.Left;
         if (!GeomUtil.IsInRightDir(geomInfo.Normal))
         {
            startHookOrientation = RebarTerminationOrientation.Right;
            endHookOrientation = RebarTerminationOrientation.Right;
         }

         // create the container item
         return PlaceContainerItem(cont, m_transverseType, m_transverseHookType, m_transverseHookType, geomInfo, startHookOrientation, endHookOrientation);
      }
      ...
      private RebarTerminationOrientation GetTopHookOrient(RebarGeometry geomInfo, TopRebarLocation location)
      {
      ...
      private RebarContainerItem FillTopItem(RebarContainer cont, TopRebarLocation location)
      {
         ...
         RebarTerminationOrientation startOrient = RebarTerminationOrientation.Right;// the start hook orient
         RebarTerminationOrientation endOrient = RebarTerminationOrientation.Left;  // the end hook orient
