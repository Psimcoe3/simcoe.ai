   ...
   public class BeamFramReinMaker : FramReinMaker
   {
      ...
      public bool FillBottomBars()
      {
         ...
         Rebar rebar = PlaceRebars(m_bottomType, null, null, geomInfo,
                                 RebarTerminationOrientation.Left, RebarTerminationOrientation.Left);
         return (null != rebar);
      }
      ...
      public Rebar FillTransverseBar(TransverseRebarLocation location)
      {
         ...
         RebarTerminationOrientation startHookOrient = RebarTerminationOrientation.Right;
         RebarTerminationOrientation endHookOrient = RebarTerminationOrientation.Left;
         if (!GeomUtil.IsInRightDir(geomInfo.Normal))
         {
            startHookOrient = RebarTerminationOrientation.Left;
            endHookOrient = RebarTerminationOrientation.Right;
         }

         // create the rebar
         return PlaceRebars(m_transverseType, m_transverseHookType, m_transverseHookType,
                                         geomInfo, startHookOrient, endHookOrient);
      }
