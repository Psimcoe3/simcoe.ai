...
| C# |
| --- |
| ``` public int SplitRegion( 	UV gridUV, 	RectangularGridSegmentOrientation splitDirection, 	out int newSegmentId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function SplitRegion ( _ 	gridUV As UV, _ 	splitDirection As RectangularGridSegmentOrientation, _ 	<OutAttribute> ByRef newSegmentId As Integer _ ) As Integer ``` |

 

| Visual C++ |
| --- |
| ``` public: int SplitRegion( 	UV^ gridUV,  	RectangularGridSegmentOrientation splitDirection,  	[OutAttribute] int% newSegmentId ) ``` |
