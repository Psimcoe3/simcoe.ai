...
| C# |
| --- |
| ``` public StructuralAsset( 	string name, 	StructuralAssetClass structuralAssetClass ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub New ( _ 	name As String, _ 	structuralAssetClass As StructuralAssetClass _ ) ``` |
...
:   Type:  [Autodesk.Revit.DB StructuralAssetClass](f62eea04-3d37-6450-9d5b-52627d3e677b.htm)    
