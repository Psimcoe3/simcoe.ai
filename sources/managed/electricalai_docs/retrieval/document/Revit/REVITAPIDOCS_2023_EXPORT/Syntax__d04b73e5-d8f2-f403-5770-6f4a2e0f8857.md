...
| C# |
| --- |
| ``` public void SetFilterVisibility( 	ElementId filterElementId, 	bool visibility ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub SetFilterVisibility ( _ 	filterElementId As ElementId, _ 	visibility As Boolean _ ) ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | ElementId is not associated with a FilterElement. |
