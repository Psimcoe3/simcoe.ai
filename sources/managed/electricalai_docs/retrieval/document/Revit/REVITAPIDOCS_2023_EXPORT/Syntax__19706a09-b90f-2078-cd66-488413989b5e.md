...
| C# |
| --- |
| ``` public static IList<ElementId> GetJoinedElementIds( 	Document document, 	ElementId massInstanceId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function GetJoinedElementIds ( _ 	document As Document, _ 	massInstanceId As ElementId _ ) As IList(Of ElementId) ``` |
