...
| Visual Basic |
| --- |
| ``` Public Shared Function CreateRevolvedGeometry ( _ 	coordinateFrame As Frame, _ 	profileLoops As IList(Of CurveLoop), _ 	startAngle As Double, _ 	endAngle As Double, _ 	solidOptions As SolidOptions _ ) As Solid ``` |
