...
| C# |
| --- |
| ``` public static ICollection<ElementId> GetDisplacedElementIds( 	View view ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function GetDisplacedElementIds ( _ 	view As View _ ) As ICollection(Of ElementId) ``` |
