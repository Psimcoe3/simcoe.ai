...
|  |
| --- |
| [GlobalParameter Class](b0e53a4a-84ad-abb4-358d-9797870f101b.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [GlobalParameter](b0e53a4a-84ad-abb4-358d-9797870f101b.htm)  type exposes the following members.
...
| Public method | [CanChangeReporting](4cb16ada-5e43-4307-3886-61a868c8a0dc.htm) | Tests whether the global parameter permits a change of its current value of the IsReporting attribute. |
...
| Public method | [CanLabelDimension](be059016-a7dc-6995-0f11-f56f59555183.htm) | Tests whether a dimension can be labeled by the global parameter. |
...
| Public method Static member | [Create](d3a16d9e-50d0-b1e6-3beb-126356afb73f.htm) | Creates a new Global Parameter in the given document. |
...
| Public method | [GetAffectedElements](c1eb340d-471d-4810-92fe-a2bd6374fc1f.htm) | Returns all elements of which properties are driven by this global parameter. |
| Public method | [GetAffectedGlobalParameters](2028f8a1-2691-e921-8a56-882b1e4080f3.htm) | Returns all other global parameters which refer to this global parameter in their formulas. |
| Public method | [GetDefinition](ec9b3cd3-4379-6eb8-7c7d-c220ba03f359.htm) | Get the definition representing this parameter element. (Inherited from  [ParameterElement](2ad60b36-07d6-6aed-62c7-89f388f05ffb.htm)  .) |
...
| Public method | [GetFormula](4fb83945-2484-3709-6036-adfa4f411f28.htm) | Returns the parameter's expression in form of a string. |
...
| Public method | [GetLabeledDimensions](97d29291-74c4-2da5-2ac5-2fa0c0ac9d0c.htm) | Returns all dimension elements that are currently labeled by this global parameter. |
| Public method | [GetLabelName](020d91e9-ebea-2449-a747-72a8613f4765.htm) | Returns the name of this parameter's label, which is used to label dimension elements. |
...
| Public method | [GetValue](56eb0e54-eac4-9b51-3122-e4fb065b63f0.htm) | Obtains the curent value of the global parameter. |
...
| Public method | [HasValidTypeForReporting](8ec3a25e-018b-8903-01d1-6201531c50a0.htm) | Tests that the global parameter has data of a type that supports reporting. |
...
| Public method | [IsValidFormula](50c83d89-22da-4398-bba8-197345f76192.htm) | Tests that the given expression is a valid as formula for this parameter. |
...
| Public method | [LabelDimension](99bc1f7d-82b8-7dc1-9919-e73834bb565c.htm) | Labels a dimension with this global parameter. |
...
| Public method | [SetDrivingDimension](017b2d21-0ed9-fc04-dd7c-19d78214859d.htm) | Set a dimension to drive the value of this parameter. |
...
| Public method | [SetFormula](7974796f-5771-6640-ce74-0be23eab58d0.htm) | Sets a formula expression for this parameter. |
| Public method | [SetValue](df012c22-6e65-8de5-1057-f15660d02288.htm) | Sets a new value of the global parameter. |
| Public method | ToString | Returns a string that represents the current object. (Inherited from  Object  .) |
| Public method | [UnlabelDimension](b862ea70-8b3a-2800-f434-7163a878deeb.htm) | Unlabels a dimension that is currently labeled by this global parameter. |
...
| Public property | [IsDrivenByDimension](201f3932-eece-37b0-be27-3e74ce0c3fb9.htm) | Indicates whether this parameter is driven by a dimension or not. |
| Public property | [IsDrivenByFormula](ee9c7baa-47b9-f84d-c2e2-103711fbb756.htm) | Indicates whether this parameter is driven by a formula or not. |
...
| Public property | [IsReporting](41d62d48-8d78-d056-b0ca-9ea4777dc827.htm) | Indicates whether this is a reporting global parameter or not. |
