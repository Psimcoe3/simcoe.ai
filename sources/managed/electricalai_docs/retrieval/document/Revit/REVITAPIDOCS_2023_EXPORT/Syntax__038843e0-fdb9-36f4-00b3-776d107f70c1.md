...
| C# |
| --- |
| ``` public static FilterRule CreateLessRule( 	ElementId parameter, 	string value ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateLessRule ( _ 	parameter As ElementId, _ 	value As String _ ) As FilterRule ``` |
