...
|  |
| --- |
| [PointCloudType Class](b7ba9b9c-fd96-7506-1585-6fc2b327e0e9.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [PointCloudType](b7ba9b9c-fd96-7506-1585-6fc2b327e0e9.htm)  type exposes the following members.
...
| Public method Static member | [Create](2a1fb419-d46e-1acb-90ee-a668ae3ff3eb.htm) | Creates a new point cloud type for a given point cloud engine. |
...
| Public method | [GetPath](0705dfa3-03c4-12ff-b2ef-7dfae8fa768b.htm) | Gets the path of the link source from which the points are loaded. |
...
| Public property | [ColorEncoding](322946b6-a9c1-ea15-ead5-5672be3644ea.htm) | The color encoding used by points extracted from instances of this point cloud. |
...
| Public property | [EngineIdentifier](4cb3c05e-4a87-ffe3-fcb2-fba451dd8004.htm) | The identifier of the engine responsible for handling of the point cloud. |
...
| Public property | [FoundStatus](4fdf0074-3b7e-e6dc-0bf2-2c9b47685a30.htm) | Shows whether the Point Cloud external file could be found. |
...
| Public property | [Offset](e6e7fa66-77d5-9bd4-e79f-6116494733c7.htm) | Returns the offset stored in the point cloud. |
...
| Public property | [Scale](5d96579f-ac8d-885e-ce1a-09caeff015ef.htm) | The multiplier applied to the points in all instances of this point cloud. |
