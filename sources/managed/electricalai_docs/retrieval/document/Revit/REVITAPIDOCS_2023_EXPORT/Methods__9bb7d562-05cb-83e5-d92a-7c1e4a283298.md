...
|  |
| --- |
| [ConnectorElement Class](cd7d7579-1058-e8ca-d55a-c3a914843667.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [ConnectorElement](cd7d7579-1058-e8ca-d55a-c3a914843667.htm)  type exposes the following members.
...
| Public method | [AssignAsPrimary](c6c21445-5e95-e15b-743d-f8fdfb369e79.htm) | Assign a connector as a primary connector. |
...
| Public method | [ChangeHostReference(Reference)](ab25dbec-9993-98b3-78e6-527bbd27fd1c.htm) | Changes the connector host reference to a new planar face. |
| Public method | [ChangeHostReference(Reference, Edge)](1761f9f3-3967-9d02-befb-401d16fd100d.htm) | Changes the connector host reference to a new planar face and a new edge loop. |
...
| Public method Static member | [CreateConduitConnector(Document, Reference)](7941cb35-59a1-1218-9272-844e20bbcc8a.htm) | Create a new conduit ConnectorElement. |
| Public method Static member | [CreateConduitConnector(Document, Reference, Edge)](d048d302-c184-b1b9-54c9-1b8fb7e35cab.htm) | Create a new conduit ConnectorElement. |
...
| Public method Static member | [CreateElectricalConnector(Document, ElectricalSystemType, Reference)](ba37da90-c759-890b-2a9f-a037ef54c971.htm) | Create a new electrical ConnectorElement. |
| Public method Static member | [CreateElectricalConnector(Document, ElectricalSystemType, Reference, Edge)](b98681a1-6e45-0eae-e2ce-2a6bb425d810.htm) | Create a new electrical ConnectorElement. |
| Public method Static member | [CreatePipeConnector(Document, PipeSystemType, Reference)](6fdcd1e4-61d0-2a01-2e5b-b5d918f0cfee.htm) | Create a new pipe ConnectorElement. |
| Public method Static member | [CreatePipeConnector(Document, PipeSystemType, Reference, Edge)](0b7d2ba8-2c72-aeb0-5936-effad6cc7bf6.htm) | Create a new pipe ConnectorElement with a face and an edge. |
...
| Public method | [FlipDirection](7990bca8-ff59-0bac-572f-0c32929e5221.htm) | Reverses the direction of the connector element. |
...
| Public method | [GetLinkedConnectorElement](f805f94d-74db-3f3f-711a-6e3e38cea61c.htm) | Get the linked connector element. |
...
| Public method | [IsSystemClassificationValid](fbb9b3ea-b312-de08-006c-916e85663f62.htm) | Checks that the MEPSystemType is valid for the domain of connector. |
...
| Public method | [SetLinkedConnectorElement](2d906fcc-bffc-2217-eae2-fd0c466850ba.htm) | Set the linked connector element. |
...
| Public property | [CoordinateSystem](9397e93e-b63f-ec7d-fa28-7a0befb68966.htm) | The coordinate system of the connector. |
...
| Public property | [Direction](c9150cc0-7df3-5f6a-7f5d-57ad1518bcd6.htm) | Gets the direction of the connector element. |
...
| Public property | [Domain](1312512f-c408-f59f-09ed-6c3080b2705d.htm) | The domain of the connector. |
...
| Public property | [Height](03719a7b-3a05-7d63-8b92-0fbe6474b046.htm) | The height of the connector. |
...
| Public property | [IsPrimary](92a0eddf-2414-903f-8872-898442426ded.htm) | Identifies if this is the primary connector in the family. |
...
| Public property | [Origin](bf9d9963-52de-d53b-488c-8a57bec94662.htm) | The location of the connector in family document. |
...
| Public property | [Radius](0b915ed7-c925-fafc-9f10-99541f549184.htm) | The radius of the connector. |
| Public property | [Shape](f4d2381c-9a7b-983d-d170-71cc3128c492.htm) | The shape of the connector. |
| Public property | [SystemClassification](5c9a9f68-7521-94bc-3bc1-7a3f5aa6ac69.htm) | The system classification of the connector. |
...
| Public property | [Width](47a7846f-c6e5-0207-f324-ed3d4e5814c1.htm) | The width of the connector. |
