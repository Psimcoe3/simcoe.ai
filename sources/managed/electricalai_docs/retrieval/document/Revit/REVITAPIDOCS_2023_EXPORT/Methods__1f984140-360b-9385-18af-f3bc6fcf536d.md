...
|  |
| --- |
| [RevisionNumberingSequence Class](52b6f8d8-4d5e-dfee-7782-5cd7a77ee543.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method Static member | [CreateAlphanumericSequence](295c5ef7-04e4-34c8-a25d-625ff61044cf.htm) | Creates a new alphanumeric revision numbering sequence in the document. |
| Public method Static member | [CreateNumericSequence](b3cc881b-67ea-8bf5-476e-ae9c5b9d455a.htm) | Creates a new numeric revision numbering sequence in the document. |
...
| Public method Static member | [GetAllRevisionNumberingSequences](dd3dd3e5-ed85-a7e4-6280-1a0e5464f5d0.htm) | Gets all of the revision numbering sequences from the document. |
| Public method | [GetAlphanumericRevisionSettings](46b8cc2b-f31d-f4e3-e140-7b05ce50730c.htm) | Returns a copy of the AlphanumericRevisionSettings owned by this revision numbering sequence. |
...
| Public method | [GetNumericRevisionSettings](63cbff5e-855c-9237-a160-e90f7e1f7a17.htm) | Returns a copy of the NumericRevisionSettings owned by this revision numbering sequence. |
...
| Public method | [HasValidAlphanumericRevisionSettings](4dd5b623-eac0-0940-cf51-8e4cd6d7dc9f.htm) | Checks whether the revision numbering sequence owns a valid alphanumeric revision settings. |
| Public method | [HasValidNumericRevisionSettings](4592ebc9-6662-6da7-0a59-0b038b60ef23.htm) | Checks whether the revision numbering sequence owns a valid numeric revision settings. |
| Public method | [HasValidRevisionSettingsForNumberType](e9934563-b89b-3e28-f83d-9a029578aa26.htm) | Checks whether the revision numbering sequence owns a valid revision settings for number type. |
...
| Public method | [SetAlphanumericRevisionSettings](e0c9a915-c30d-ed9c-eb5e-65a7e1f73e91.htm) | Replaces the current alphanumeric revision numbering settings with the provided settings. |
...
| Public method | [SetNumericRevisionSettings](70bd6afe-8775-cf7d-6f8e-3198f988ae71.htm) | Replaces the current numeric revision numbering settings with the provided settings. |
...
| Public property | [NumberType](40fa01d2-22a9-16aa-b363-ba9e1343aab6.htm) | Indicates the revision number type of the revision numbering sequence. |
...
| Public property | [SequenceName](443a595a-51e1-c93e-d32b-0986178c777d.htm) | The name of this revision numbering sequence. |
