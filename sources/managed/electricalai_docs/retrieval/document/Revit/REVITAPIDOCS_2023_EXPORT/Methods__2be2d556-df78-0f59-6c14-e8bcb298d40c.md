...
|  |
| --- |
| [ReferencePoint Class](b4b9baeb-2ec5-a2e1-1420-37f593d36aa4.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [ReferencePoint](b4b9baeb-2ec5-a2e1-1420-37f593d36aa4.htm)  type exposes the following members.
...
| Public method | [GetCoordinatePlaneReferenceXY](d32ec824-4333-7f68-2b38-83cd1aacb732.htm) | A reference for the XY plane of the coordinate system. |
| Public method | [GetCoordinatePlaneReferenceXZ](05a63882-e91c-fb83-e9d5-151459f0e1c3.htm) | A reference for the XZ plane of the coordinate system. |
| Public method | [GetCoordinatePlaneReferenceYZ](b1644ffd-1afe-9c08-9add-562747356733.htm) | A reference for the YZ plane of the coordinate system. |
| Public method | [GetCoordinateSystem](809b7a59-5911-a62d-4144-3e0d498d81a0.htm) | The position and orientation of the ReferencePoint. |
...
| Public method | [GetHubId](1f0de8b1-04fa-3513-a139-079cbb14853f.htm) | Id of associated Hub. |
| Public method | [GetInterpolatingCurves](1b1517e8-b244-e249-9f01-e6137b40c886.htm) | The set of CurveByPoints elements that interpolate a ReferencePoint. |
...
| Public method | [GetPointElementReference](9baba8f4-1cf5-3349-a6b5-5fc8a69ba761.htm) | Retrieve a copy of the rule that computes the location of the ReferencePoint relative to other elements in the document. |
...
| Public method | [GetVisibility](61c9a859-14a2-1e9e-455c-efa77220a149.htm) | Gets the visibility for the point. |
...
| Public method | [SetCoordinateSystem](1531d27f-9b12-57d7-533e-eda4daf99adb.htm) | The position and orientation of the ReferencePoint. |
...
| Public method | [SetPointElementReference](2fe8dd3a-06f6-42f0-52c6-49e83c2c28f2.htm) | Change the rule for computing the location of the ReferencePoint relative to other elements in the document. |
| Public method | [SetVisibility](6a4ba016-bc5e-8511-4990-c588a9311a6d.htm) | Sets the visibility for the point. |
...
| Public property | [CoordinatePlaneVisibility](bf3a953f-f4e0-8413-99ca-48f8b8440002.htm) | Visibility settings for the coordinate reference planes. |
...
| Public property | [Name](ce62ef45-46cc-6fe7-ffcc-1578c16f8d6b.htm) | (Overrides  [Element Name](e372092e-ff47-71c2-1272-50ab08e5a41d.htm)  .) |
...
| Public property | [Position](4f540b05-f562-8a72-37ef-834d45cea027.htm) | The position of the ReferencePoint. |
| Public property | [ShowNormalReferencePlaneOnly](8a713d3d-c2ac-3b64-3cf9-574a08bcbb64.htm) | Whether all three coordinate planes are shown, or only the normal (XY) plane. |
...
| Public property | [Visible](f0617f4c-2184-3bfe-e4f7-644abc06071b.htm) | Whether the point is visible when the family is loaded into a project. |
