...
|  |
| --- |
| [Pipe Class](aa1b8294-c12d-ece0-00af-b17c1f1c9e03.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [Pipe](aa1b8294-c12d-ece0-00af-b17c1f1c9e03.htm)  type exposes the following members.
...
| Public method Static member | [CreatePlaceholder](f291f914-aa0c-f6b0-c824-3fffe0191aba.htm) | Creates a new placeholder pipe. |
...
| Public method | [FindInserts](58990230-38cb-3af7-fd25-96ed3215a43d.htm) | Gets the ids of the instances inserted into this host object. (Inherited from  [HostObject](56a32e0b-df65-a6ba-40bd-8f50a1f31dcd.htm)  .) |
...
| Public method Static member | [IsPipeTypeId](49856957-ee68-6497-37e4-032f84f4e193.htm) | Checks if given type is valid pipe type. |
| Public method Static member | [IsPipingConnector](ef930ad5-4d7e-2fb6-441e-ff3c2a8681f8.htm) | Checks if the given connector is a valid piping connector. |
| Public method Static member | [IsPipingSystemTypeId](c770c18c-d93f-0e8f-b4c4-60a0468e9444.htm) | Checks if given type is valid piping system type. |
...
| Public method | [SetSystemType](dd13a0f2-4820-a6f2-3b8e-56c8d980060f.htm) | Updates the associated system type for the pipe. |
...
| Public property | [ConnectorManager](5498400a-b28b-786d-170e-383cc0e67875.htm) | The connector manager of this MEP curve. (Inherited from  [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.htm)  .) |
...
| Public property | [Diameter](ef86c674-b088-40b1-0b28-3b91a01c7b30.htm) | The diameter of the MEP curve. (Inherited from  [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.htm)  .) |
...
| Public property | [FlowState](fbd5a1a8-86ad-45a3-4099-01bc54ad99e1.htm) | The flow state of the pipe. |
...
| Public property | [Height](c8613f87-19b6-69e1-290c-53c0420cf9eb.htm) | The height of the MEP curve. (Inherited from  [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.htm)  .) |
...
| Public property | [IsPlaceholder](3f8c2daf-6f77-1288-fa37-9eebd54cedb6.htm) | Identifies if the pipe is a placeholder or not. |
...
| Public property | [LevelOffset](de6ae69a-d462-80c9-58e0-ea5bac2a1447.htm) | The offset of the MEP curve. (Inherited from  [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.htm)  .) |
...
| Public property | [MEPSystem](ad663cce-bb05-70bf-33f5-b3d32f9e9b62.htm) | The system of the MEP curve. (Inherited from  [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.htm)  .) |
...
| Public property | [PipeSegment](bc1e5201-3ba2-0e18-54bd-4377afc656fe.htm) | The pipe segment that was assigned to this pipe according to the routing preference. |
| Public property | [PipeType](cd80f438-0548-0863-b483-06cc678bd2b3.htm) | The pipe type of this pipe. |
| Public property | [ReferenceLevel](3d7248c5-558d-60ba-42da-c3b46d35f1cd.htm) | The reference level of the MEP curve. (Inherited from  [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.htm)  .) |
...
| Public property | [Width](978bbf62-3cba-1580-8080-61888b92b55d.htm) | The width of the MEP curve. (Inherited from  [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.htm)  .) |
