...
|  |
| --- |
| [ElementIntersectsFilter Class](b9e3bdcb-e85a-832d-0f51-312b3fd91cff.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [ElementIntersectsFilter](b9e3bdcb-e85a-832d-0f51-312b3fd91cff.htm)  type exposes the following members.
...
| Public method Static member | [IsCategorySupported](a85b752e-895f-1041-279e-bbab04ba6d1c.htm) | Identifies if the input element is of a category supported by element intersection filters. |
| Public method Static member | [IsElementSupported](d1143ae9-9086-020a-6d8e-cf4f99a8196f.htm) | Identifies if the input element is supported by element intersection filters. |
