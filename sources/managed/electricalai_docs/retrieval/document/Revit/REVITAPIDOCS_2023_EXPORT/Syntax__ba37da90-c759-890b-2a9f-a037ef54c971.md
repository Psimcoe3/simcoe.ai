...
| Visual Basic |
| --- |
| ``` Public Shared Function CreateElectricalConnector ( _ 	document As Document, _ 	electricalSystemType As ElectricalSystemType, _ 	planarFace As Reference _ ) As ConnectorElement ``` |
