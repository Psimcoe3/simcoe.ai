...
|  |
| --- |
| [WorksharingDisplaySettings Class](ec25e291-6582-7e8c-f273-efc0c391bcc4.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [WorksharingDisplaySettings](ec25e291-6582-7e8c-f273-efc0c391bcc4.htm)  type exposes the following members.
...
| Public method | [CanUserHaveOverrides](e50869c9-ce9d-6dad-44cf-e4d929b2196b.htm) | Checks whether a single username can have customized graphic overrides. |
...
| Public method | [GetAllUsersWithGraphicOverrides](4df2c37c-fca2-80a3-980d-50a478220c58.htm) | Returns all usernames that have graphic overrides. This list consists of all users included in the user table + all users who have explicitly been assigned overrides. |
...
| Public method | [GetGraphicOverrides(String)](e642ca72-5c5a-80f4-a2e6-a98b874254e6.htm) | Returns the graphic overrides assigned for elements owned by a particular user. |
| Public method | [GetGraphicOverrides(CheckoutStatus)](34582abf-6edd-d9c5-aa00-5d39268ac5a1.htm) | Returns the graphic overrides associated with a particular ownership status. |
| Public method | [GetGraphicOverrides(ModelUpdatesStatus)](192a99a8-62d4-7330-6552-5f7256de82eb.htm) | Returns the graphic overrides assigned to a particular model update status. |
| Public method | [GetGraphicOverrides(WorksetId)](6753b405-5170-1636-83ce-902c9a27526f.htm) | Returns the graphic overrides assigned to elements in a particular workset. |
...
| Public method Static member | [GetOrCreateWorksharingDisplaySettings](32871a69-64cd-adcb-7fd9-ae9a60f3615a.htm) | Returns the worksharing display settings for the document, creating new settings for the current user if necessary. |
...
| Public method | [GetRemovedUsers](1a79abbd-a072-2e11-1405-06252915fd9e.htm) | Returns the set of users who have been explicitly removed from the settings. |
...
| Public method | [RemoveUsers](d714db4a-2b0e-e8da-2002-3508a3d71772.htm) | Removes users from the list of displayed users and permanently discards any customization of the graphics. Note that a user cannot be removed if he or she owns any elements. |
| Public method | [RestoreUsers](da4f0c9e-3c5d-1869-3351-5c93d815fe7a.htm) | Adds users back to the list of displayed users and permits customization of the graphics. Any usernames that are not currently removed will be ignored. Returns the number of users who were actually restored. |
...
| Public method | [UserHasGraphicOverrides](84a5e6ac-480e-cc1e-936c-912f22080c1d.htm) | Checks whether there are graphic overrides that would apply to elements owned by the given user in the "Individual Owners" display mode. |
