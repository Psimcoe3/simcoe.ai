...
| C# |
| --- |
| ``` public bool CanFilterByParameterExistence( 	ScheduleFieldId fieldId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function CanFilterByParameterExistence ( _ 	fieldId As ScheduleFieldId _ ) As Boolean ``` |
