...
|  |
| --- |
| [DuctSizeSettings Class](68c1d227-424d-36da-0e5a-3f3e51e7f939.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [DuctSizeSettings](68c1d227-424d-36da-0e5a-3f3e51e7f939.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AddSize](ed95c206-c4f5-8aff-9c88-ff393dbb333e.htm) | Inserts a new MEPSize in to the duct size settings. The duct shape determines the location of the new size in the size table. |
...
| Protected method | [GetBasicIEnumerator](f64b5fd8-aa58-7785-c3e6-9d99283eb8cc.htm) | Returns an enumerator that iterates through a collection. |
...
| Public method | [GetDuctSizeSettingIterator](124c6b6d-9730-696e-1e96-66c3159512aa.htm) | Returns a DuctSizeSettingIterator object that iterates through the collection. |
| Public method Static member | [GetDuctSizeSettings](a402c704-e6fc-19d4-993f-a7fc7d61bc23.htm) | Get the duct size settings of the project. |
...
| Public method | [GetEnumerator](03568478-23c1-d14e-f151-f283d600f7a3.htm) | Returns an enumerator that iterates through a collection. |
...
| Public method | [GetSizeCount](3fbdf755-b50c-4d08-8a56-dac84a37e12a.htm) | Get the size count of the duct size table. The duct shape determines the location of the size in the size table. |
...
| Public method | [RemoveSize](9c4ba863-f8c4-574f-97e4-40fd3f2b6013.htm) | Erase the existing MEPSize with this nominal diameter. The duct shape determines the location of the size in the size table. |
...
| Public property | [Item](04a9f724-107f-17ff-12d5-92a309df53d1.htm) | Get the DuctSizes for this DuctShape. |
