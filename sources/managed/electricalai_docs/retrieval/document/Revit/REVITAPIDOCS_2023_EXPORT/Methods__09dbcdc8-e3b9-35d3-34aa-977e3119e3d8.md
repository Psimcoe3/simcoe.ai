...
|  |
| --- |
| [AreaLoad Class](5dc205a9-cafd-911b-6a56-26f2e8bfcdc1.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [AreaLoad](5dc205a9-cafd-911b-6a56-26f2e8bfcdc1.htm)  type exposes the following members.
...
| Public method Static member | [Create(Document, ElementId, XYZ, AreaLoadType)](e977990d-f0d6-520d-5846-3260e5f6ca60.htm) | Creates a new hosted area load within the project. |
| Public method Static member | [Create(Document, IList CurveLoop , XYZ, AreaLoadType)](59548020-5c47-a9a9-ad94-f6aac94addcb.htm) | Creates a new non-hosted area load within the project. |
| Public method Static member | [Create(Document, IList CurveLoop , IList XYZ , IList Int32 , IList Int32 , AreaLoadType)](65b15c08-d4f2-6200-732b-eac5c01dfe1c.htm) | Creates a new non-hosted area load within the project. |
...
| Public method | [GetLoops](6d423e73-bd6a-aaa7-7818-84297f2a6e1b.htm) | Returns curve loops that define geometry of the area load. |
...
| Public method | [GetRefPoint](3bd2e404-2705-ad16-42c3-42c808890bb4.htm) | Returns the physical location of the reference point. |
...
| Public method Static member | [IsValidHostId](25e62c90-a5b5-09d5-9c49-03058e5e51b0.htm) | Indicates if the provided host id can host area loads The document containing both the host and the load The id of the analytical panel that is about to host an area load True if an area load can be placed on the input host id |
...
| Public method | [SetLoops](264cfd98-5af1-1019-5055-e14816eae450.htm) | Sets curve loops that define geometry of the area load. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [Area](f5c2ce0d-e793-05b0-0f0c-2f24c1a13756.htm) | Returns area of the area load. |
...
| Public property | [ForceVector1](2fa5cdff-3d4c-a479-fbc6-f2bae9c06884.htm) | The force vector applied to the 1st reference point of the area load, oriented according to OrientTo setting. |
| Public property | [ForceVector2](c5f25cdc-7120-6e86-b0ec-70cc4ffec360.htm) | The force vector applied to the 2nd reference point of the area load, oriented according to OrientTo setting. |
| Public property | [ForceVector3](000a344f-d68f-8718-c6e5-72edef5ce04c.htm) | The force vector applied to the 3rd reference point of the area load, oriented according to OrientTo setting. |
...
| Public property | [IsProjected](56b7d8d9-6d4f-0d27-2395-e3991b69a29a.htm) | Indicates if the load is projected. |
...
| Public property | [NumRefPoints](8f5aea83-d302-f0a0-5e8a-57141b0f6549.htm) | Returns the total number of reference points for the area load. |
