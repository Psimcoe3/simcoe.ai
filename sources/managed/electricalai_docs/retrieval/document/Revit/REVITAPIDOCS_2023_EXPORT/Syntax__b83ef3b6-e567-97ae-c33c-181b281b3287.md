...
| Visual Basic |
| --- |
| ``` Public Shared Sub RegisterUpdater ( _ 	updater As IUpdater, _ 	document As Document, _ 	isOptional As Boolean _ ) ``` |
