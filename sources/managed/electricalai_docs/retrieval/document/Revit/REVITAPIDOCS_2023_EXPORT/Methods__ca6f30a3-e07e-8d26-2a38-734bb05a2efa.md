...
|  |
| --- |
| [StairsRunType Class](a76503c0-abd8-0043-883b-134149348542.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public property | [HasRisers](80526e1c-bfa5-643d-5b59-72b7390c51de.htm) | True if the stairs run will include risers on steps, false otherwise. |
| Public property | [HasTreads](afc95198-c67e-7de7-3237-67f03e106c2f.htm) | True if the stairs run will include treads on steps, false otherwise. |
...
| Public property | [IsMonolithic](e221f2fe-930c-3a7b-c731-6c1838f2d979.htm) | True if the stairs run is monolithic, false otherwise. |
| Public property | [IsSlanted](8585de07-e216-358a-7aff-0581c9c7d81a.htm) | True if risers will be slanted, false if they will be straight. |
...
| Public property | [MaterialId](f8b6de5f-2765-ad23-a271-ce65005b79e0.htm) | The material of the stairs run, only available for monolithic stairs run. |
...
| Public property | [NosingLength](df67964e-9f7b-f4b8-5b67-4e2faf985853.htm) | The amount of the tread depth that overhangs the next tread. |
| Public property | [NosingProfile](5f4c8bb3-da54-fb00-387a-2e7c13800840.htm) | The id of the nosing profile of the treads. |
...
| Public property | [RiserProfile](f9c01688-2700-8144-47f3-a41896ca071a.htm) | The id of the profile of the risers. |
| Public property | [RiserThickness](c1499b8a-f969-18f0-c7fd-b42609e5603a.htm) | The thickness of the risers. |
| Public property | [RiserToTreadConnect](38e441dd-7c1d-4c60-ab69-4a5f936f177c.htm) | The connection of the riser to tread in relation to each other. |
| Public property | [StructuralDepth](796c6515-9e91-e455-d0e8-91b15241074c.htm) | The structural depth of the stairs run, only available for monolithic stairs run. |
| Public property | [TotalDepth](00e10880-4a18-381a-44fb-51dd1ba226b8.htm) | The total depth of the stairs run, only available for monolithic stairs run. |
| Public property | [TreadNosingPosition](e5f0486c-4ca8-72fd-35cc-d8a0c9a77a7c.htm) | Represents on which edges of the nosing to apply the nosing profile. |
| Public property | [TreadProfile](9d40bd4c-480a-3cf6-6b48-f81dfd2e7ad9.htm) | The id of the profile of the treads. |
| Public property | [TreadThickness](0c6c2238-aba9-0056-4f1f-33793c18b012.htm) | The thickness of the treads. |
| Public property | [UndersideSurfaceStyle](4ac85f7d-ec42-335a-8bfb-ae2389fb1c28.htm) | The underside surface style of the stairs run, only available for monolithic stairs run. |
