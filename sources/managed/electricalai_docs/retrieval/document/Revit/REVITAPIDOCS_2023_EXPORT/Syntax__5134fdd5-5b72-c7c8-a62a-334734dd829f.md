...
| C# |
| --- |
| ``` public static string GetDefaultNameForKeySchedule( 	Document document, 	ElementId categoryId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function GetDefaultNameForKeySchedule ( _ 	document As Document, _ 	categoryId As ElementId _ ) As String ``` |
