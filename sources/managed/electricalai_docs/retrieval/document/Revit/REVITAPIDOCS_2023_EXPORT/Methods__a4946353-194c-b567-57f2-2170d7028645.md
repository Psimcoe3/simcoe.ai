...
|  |
| --- |
| [DisplacementPath Class](90ac4bbb-7f65-763a-bf5e-a76b2a167294.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [DisplacementPath](90ac4bbb-7f65-763a-bf5e-a76b2a167294.htm)  type exposes the following members.
...
| Public method Static member | [Create](c3a023a5-b875-4de1-a092-f62002a258cf.htm) | Creates a new DisplacementPath referencing a DisplacementElement and edge or curve and adds it to the document. |
...
| Public method Static member | [IsValidParam](2e1abd7d-718e-26af-7fbc-6746ec2963c2.htm) | Is the specified value a valid edge or curve parameter. |
| Public method Static member | [IsValidReference](f3c1aeed-e6e3-77cd-1c03-21280f06f755.htm) | Does the specified pick represent an edge or a curve belonging to one of the displaced elements. |
...
| Public method | [SetAnchorPoint](5d92709f-6736-b8b9-b31b-68f0af5f8ee1.htm) | Sets the reference that determines the origin of this DisplacementPath. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AncestorIdx](fed5f5e3-2f84-1ccf-458d-d2c3f30d3a02.htm) | Specifies the end point of the path. |
...
| Public property | [PathStyle](b812339e-d1c8-6303-5538-091fdbcaf838.htm) | Specifies the style of the path. |
