...
|  |
| --- |
| [DisplacementElement Class](08113547-eaaa-5ec1-5ff1-de609fe7c29c.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method Static member | [CanCategoryBeDisplaced](cdab956b-de93-bf5a-1698-5d5746447934.htm) | Indicates whether elements of the specified category are eligible as displaced elements. |
...
| Public method | [CanElementsBeAddedToDisplacementSet](45d2fc58-535b-2b9b-2bf5-ccefd5f93123.htm) | Indicates if these elements can be displaced by this DisplacementElement. |
| Public method Static member | [CanElementsBeDisplaced(View, ICollection ElementId )](c4dc323b-fd9d-816d-ab62-088a9a78c746.htm) | Indicates if elements can be assigned to a new DisplacementElement. |
| Public method Static member | [CanElementsBeDisplaced(View, ICollection ElementId , ElementId )](bcea307d-e573-de96-0769-642e74efa46b.htm) | Indicates if elements can be assigned to a new DisplacementElement. |
...
| Public method Static member | [Create](891b2088-81e0-aa88-5e8b-3ffacc3d35a3.htm) | Creates a new DisplacementElement as a child of the specified parent DisplacementElement. |
...
| Public method | [GetAbsoluteDisplacement](0debfbc3-451e-a43a-a1dd-99a25b35da25.htm) | The absolute displacement applied to the displaced elements. |
| Public method Static member | [GetAdditionalElementsToDisplace](97d02f11-7308-579c-031a-5102dc40ae4f.htm) | Identify a set of elements that potentially should be displaced along with a given element. |
| Public method | [GetChildren](d7e84ab1-d970-b926-eea8-00032962431a.htm) | Returns a set of DisplacementElements which have this DisplacementElement as a parent. |
...
| Public method | [GetDisplacedElementIds](653f228c-8b72-aa94-4ab0-131d1f1b322f.htm) | The ids of the elements affected by this DisplacementElement. |
| Public method Static member | [GetDisplacedElementIds(View)](e77c4376-b546-9939-53d8-af17afa16bd9.htm) | Returns the element ids of all displaced elements in the specified view. |
| Public method | [GetDisplacedElementIdsFromAllChildren](63740fb6-7911-9756-e4e1-c1377083216b.htm) | The element ids of elements displaced by this DisplacementElement and any DisplacementElement which declare this one as parent. |
| Public method Static member | [GetDisplacementElementId](c4790d71-c7a4-b298-8428-035de9981392.htm) | The element id of the DisplacementElement that includes the specified element. |
| Public method Static member | [GetDisplacementElementIds](a8f8e350-c1c1-c3f7-ff73-660388b40098.htm) | The element ids of all DisplacementElements owned by the specified view. |
...
| Public method | [GetRelativeDisplacement](a2e39847-b4bb-1d58-91e1-cbc16c89b638.htm) | The relative displacement applied to the displaced elements by this DisplacementElement. |
...
| Public method Static member | [IsAllowedAsDisplacedElement](4b243f84-5a2c-48de-2e6c-b9b9e3e4ab11.htm) | Indicates if the specified element is allowed to be displaced. |
...
| Public method Static member | [IsElementDisplacedInView](54e4ac85-61ee-0701-c682-3240bf640983.htm) | Indicates if the specified element displaced in the specified View. |
...
| Public method Static member | [IsNotEmpty](e8e91140-0a9e-fac8-ab7a-3de5fd57bf0a.htm) | Validates that the input set of element ids is valid for a DisplacementElement. |
...
| Public method Static member | [IsValidAsParentInView](d9da79d4-c559-96ec-a4cf-c2778221121c.htm) | Indicates whether the specified DisplacementElement can be used as a parent when creating a DisplacementElement in the specified view. |
...
| Public method | [RemoveDisplacedElement](a5d36a3a-e62a-ff86-bb7e-2572bef749f0.htm) | Remove a displaced element from this DisplacementElement. |
| Public method | [ResetDisplacedElements](47cc710d-262c-066f-84c9-a47b43183b0a.htm) | Sets the translation of the DisplacementElement to (0, 0, 0). The DisplacementElement continues to exist, but its elements are displayed in their actual location. |
| Public method | [SetDisplacedElementIds](e1071a6a-2856-6672-4e7d-8a60bb6fdbd7.htm) | Sets the ids of the elements affected by this DisplacementElement. |
...
| Public method | [SetRelativeDisplacement](8f1c4d35-4642-25de-7509-8f7917267186.htm) | Sets the relative displacement applied to the displaced elements by this DisplacementElement. |
...
| Public property | [ParentId](2faf0cca-a05a-45dc-d7e4-e61443a53623.htm) | The element id of the parent DisplacementElement. This DisplacementElement's relative transform will be concatenated with the absolute transform of its parent. |
