...
|  |
| --- |
| [EnergyAnalysisDetailModel Class](858aed23-8a94-a70a-c1fc-ca03523e2f02.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [EnergyAnalysisDetailModel](858aed23-8a94-a70a-c1fc-ca03523e2f02.htm)  type exposes the following members.
...
| Public method Static member | [Create](70c30770-b4ea-53e0-3906-1d5a5061c478.htm) | Creates a new energy analysis detailed model. |
...
| Public method | [GetAnalyticalOpenings](d6ce8e10-1ed0-6e28-960b-ce27647ed471.htm) | The collection of analytical openings. |
| Public method | [GetAnalyticalShadingSurfaces](077e6fbd-8634-346c-6f62-50b6dde554de.htm) | The collection of analytical shading surfaces. |
| Public method | [GetAnalyticalSpaces](eeb905e6-83f4-2097-8fc8-7b1d6b976be3.htm) | The collection of analytical spaces. |
| Public method | [GetAnalyticalSurfaces](5faf1c49-1cb3-6692-2b19-73fa44903766.htm) | The collection of analytical surfaces. |
...
| Public method Static member | [GetMainEnergyAnalysisDetailModel](622db406-ad7e-2a3a-7f3e-e80e803bb353.htm) | Gets the EnergyAnalysisDetailModel in given document. |
...
| Public method | [TransformModel](de9ef645-fadd-1ccc-f992-96f65c87c056.htm) | Transforms all surfaces in the model according to the document's active ground plane, shared coordinates and true north. |
...
| Public property | [BuildingTypeId](5ffc9723-8d17-e6b5-68fc-a10a96b02c55.htm) | The building type element. |
...
| Public property | [ExportCategory](220c4962-8aa4-f5ad-14cc-20b463a07efe.htm) | Export elements of this category in energy analysis. |
| Public property | [ExportMullions](cda25c0e-f426-4a95-96c7-2eaa668cee86.htm) | Indicates if to specify the setting for exporting mullions. |
...
| Public property | [IncludeShadingSurfaces](07a2b379-599f-ae27-1700-03bf0fb5b4b7.htm) | Indicates if to set and get the setting for if shading surfaces should be included. |
...
| Public property | [SimplifyCurtainSystems](10efe4ba-a85e-0315-81a8-e37699f379e6.htm) | Indicates if to specify the setting for simplified curtain systems. |
| Public property | [Tier](2fd1fab5-247f-4ec9-4bc9-9840c1b6eab8.htm) | Level of computation for energy analysis model. |
