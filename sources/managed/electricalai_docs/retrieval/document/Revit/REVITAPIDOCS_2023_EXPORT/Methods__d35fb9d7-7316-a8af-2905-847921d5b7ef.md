...
|  |
| --- |
| [RouteAnalysisSettings Class](e6742b6a-9c35-5344-736b-7bf9af6f4254.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method | [GetExcludedCategoryIds](d1cf8070-f971-feb0-df35-649982e68bc6.htm) | Returns ElementIds for Category elements which are excluded (not taken into account) by route calculation. These categories are always excluded, regardless of the  [EnableIgnoredCategoryIds](c146653a-ed81-ee52-7102-a6c2ad8a4d7c.htm)  value. If an excluded category has sub-categories, then the sub-categories will be excluded as well. |
...
| Public method | [GetIgnoredCategoryIds](e4115866-1e15-9b46-d783-7fc5786e88c5.htm) | Returns ElementIds for Category elements which are ignored (not taken into account) route calculation. To enable ignoring of these categories,  [EnableIgnoredCategoryIds](c146653a-ed81-ee52-7102-a6c2ad8a4d7c.htm)  must be set to true. If an ignored category has sub-categories, then the sub-categories will be ignored as well. |
...
| Public method Static member | [GetRouteAnalysisSettings](1bf0d99c-6255-441d-4019-cffc35bfde33.htm) | Returns the RouteAnalysisSettings element for a given document. |
...
| Public method | [IsLargeGeometryAllowed](1652ef5d-f6bb-2f50-57a4-69b5751ba671.htm) | Returns if large geometry is allowed for path of travel creation or not. |
...
| Public method | [SetIgnoredCategoryIds](e7f826a1-97f9-5181-2ddf-aa7a71d8bab7.htm) | Sets the ElementIds for Category elements which are ignored by route calculation. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AnalysisZoneBottomOffset](81229c75-be84-5d5e-7d90-cb61e6d08018.htm) | The bottom plane offset, in ft, of the zone used in route calculation. Default value is 8". |
| Public property | [AnalysisZoneTopOffset](9fe08a3f-976f-223b-6350-2e2565d9a16e.htm) | The top plane offset, in ft, for the zone used in route calculation. Default value is 6'8". |
...
| Public property | [EnableIgnoredCategoryIds](c146653a-ed81-ee52-7102-a6c2ad8a4d7c.htm) | When this setting is true, elements with category ids returned by  [GetIgnoredCategoryIds](e4115866-1e15-9b46-d783-7fc5786e88c5.htm)  will be ignored in route calculation. default is true as all elements with the Door Category Id are ignored by default. |
...
| Public property | [IgnoreImports](e3ffa1dd-7e29-7607-7bb1-8851227978fc.htm) | If true, import instances are ignored by route calculation. For imports to be ignored, also  [EnableIgnoredCategoryIds](c146653a-ed81-ee52-7102-a6c2ad8a4d7c.htm)  must be set to true. |
...
| Public property | [MinimumLength](3d1f5129-decb-de77-7bf1-7e4fd4f675d3.htm) | The constant storing minimum allowed length of path of travel |
