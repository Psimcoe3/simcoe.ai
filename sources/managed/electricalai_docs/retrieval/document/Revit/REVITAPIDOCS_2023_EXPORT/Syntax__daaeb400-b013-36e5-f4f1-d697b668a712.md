...
| C# |
| --- |
| ``` public IList<int> GetAllInsulationSpecifications( 	FabricationPart pFabPart ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function GetAllInsulationSpecifications ( _ 	pFabPart As FabricationPart _ ) As IList(Of Integer) ``` |
