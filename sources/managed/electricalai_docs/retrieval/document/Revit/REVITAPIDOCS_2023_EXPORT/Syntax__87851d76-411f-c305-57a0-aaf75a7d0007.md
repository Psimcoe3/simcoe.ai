...
| Visual Basic |
| --- |
| ``` Public Property StandardHookBendDiameter As Double 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property double StandardHookBendDiameter { 	double get (); 	void set (double value); } ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.htm) | When setting this property: the bend diameter standardHookBendDiam isn't between bar diameter and 99.0 |
