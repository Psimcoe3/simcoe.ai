...
| C# |
| --- |
| ``` public string GetFabricationConnectorName( 	int fabricationConnectorId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function GetFabricationConnectorName ( _ 	fabricationConnectorId As Integer _ ) As String ``` |
