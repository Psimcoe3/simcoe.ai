...
| C# |
| --- |
| ``` public static ExportDWGSettings Create( 	Document document, 	string name, 	DXFExportOptions options ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function Create ( _ 	document As Document, _ 	name As String, _ 	options As DXFExportOptions _ ) As ExportDWGSettings ``` |
