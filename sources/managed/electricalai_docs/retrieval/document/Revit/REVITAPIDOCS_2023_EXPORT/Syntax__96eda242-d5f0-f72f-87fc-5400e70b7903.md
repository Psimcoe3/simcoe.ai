...
| C# |
| --- |
| ``` public ElementId Import( 	string file, 	OBJImportOptions options, 	View pDBView ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function Import ( _ 	file As String, _ 	options As OBJImportOptions, _ 	pDBView As View _ ) As ElementId ``` |
