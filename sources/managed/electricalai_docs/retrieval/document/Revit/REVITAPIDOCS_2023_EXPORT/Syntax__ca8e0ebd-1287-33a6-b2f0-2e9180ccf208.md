...
| C# |
| --- |
| ``` public Dimension NewDiameterDimension( 	View view, 	Reference arcRef, 	XYZ origin ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function NewDiameterDimension ( _ 	view As View, _ 	arcRef As Reference, _ 	origin As XYZ _ ) As Dimension ``` |
