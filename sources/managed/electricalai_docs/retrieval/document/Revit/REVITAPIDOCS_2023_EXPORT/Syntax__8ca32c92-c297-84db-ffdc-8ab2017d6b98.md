...
| C# |
| --- |
| ``` public RebarFreeFormValidationResult SetCurves( 	IList<CurveLoop> curves ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function SetCurves ( _ 	curves As IList(Of CurveLoop) _ ) As RebarFreeFormValidationResult ``` |
