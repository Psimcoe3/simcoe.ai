...
| C# |
| --- |
| ``` public static IList<PathOfTravel> CreateMultiple( 	View DBView, 	IList<XYZ> pathStarts, 	IList<XYZ> pathEnds ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateMultiple ( _ 	DBView As View, _ 	pathStarts As IList(Of XYZ), _ 	pathEnds As IList(Of XYZ) _ ) As IList(Of PathOfTravel) ``` |
