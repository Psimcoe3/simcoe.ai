...
| C# |
| --- |
| ``` public void AddReferences( 	Document document, 	IList<Reference> picks ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub AddReferences ( _ 	document As Document, _ 	picks As IList(Of Reference) _ ) ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | One or more picks was not permitted to be add to the connection. -or- One or more picks was not permitted to be added to the connection. Picks should not be duplicated. |
