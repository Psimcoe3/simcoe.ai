...
| C# |
| --- |
| ``` public static bool IsValidCategoryForSchedule( 	ElementId categoryId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function IsValidCategoryForSchedule ( _ 	categoryId As ElementId _ ) As Boolean ``` |
