...
| C# |
| --- |
| ``` public ScheduleFilter( 	ScheduleFieldId fieldId, 	ScheduleFilterType filterType, 	int value ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub New ( _ 	fieldId As ScheduleFieldId, _ 	filterType As ScheduleFilterType, _ 	value As Integer _ ) ``` |
