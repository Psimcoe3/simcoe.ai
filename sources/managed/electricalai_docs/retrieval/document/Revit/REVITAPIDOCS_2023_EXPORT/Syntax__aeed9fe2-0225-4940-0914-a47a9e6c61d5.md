...
| C# |
| --- |
| ``` public ElementId GetCouplerIdAtIndex( 	int barPositionIndex, 	int end ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function GetCouplerIdAtIndex ( _ 	barPositionIndex As Integer, _ 	end As Integer _ ) As ElementId ``` |
