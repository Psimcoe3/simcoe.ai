...
| C# |
| --- |
| ``` public static bool IsValidCategoryForMaterialTakeoff( 	ElementId categoryId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function IsValidCategoryForMaterialTakeoff ( _ 	categoryId As ElementId _ ) As Boolean ``` |
