...
|  |
| --- |
| [DefaultDivideSettings Class](c4d57a70-3192-458c-faa7-619d11c69f60.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [DefaultDivideSettings](c4d57a70-3192-458c-faa7-619d11c69f60.htm)  type exposes the following members.
...
| Public method Static member | [GetDefaultDivideSettings](6919eb7d-3c9b-a1ad-9a73-3cc0e0b357d8.htm) | Obtains the DefaultDivideSettings object for the specified document. |
...
| Public method | [GetSurfaceDistance](4eb288d9-3f40-0e3b-7264-358e02dad22e.htm) | Gets the default Divided Surface distance for a fixed, minimum, or maximum distance layout for U or V gridlines. |
| Public method | [GetSurfaceLayout](c30c0676-0174-f6b5-5c5b-3b7f9ade3ac6.htm) | Gets the default Divided Surface layout for U or V gridlines. |
| Public method | [GetSurfaceNumber](d31775cf-ad0c-26d3-60b4-1e90f5663d2d.htm) | Gets the default Divided Surface number for a fixed number layout for U or V gridlines. |
...
| Public method | [SetSurfaceDistance](d9f9b486-3b4c-7ac6-5e9d-9068960708ac.htm) | Sets the default Divided Surface distance for a fixed, minimum, or maximum distance layout for U or V gridlines. |
| Public method | [SetSurfaceLayout](5555599e-ce36-8558-2120-aff759855072.htm) | Sets the default Divided Surface layout for U or V gridlines. |
| Public method | [SetSurfaceNumber](3d652d69-084c-3f2b-f966-e95760a6f038.htm) | Sets the default Divided Surface number for a fixed number layout for U or V gridlines. |
...
| Public property | [PathDistance](651d91ee-9edb-5106-fb10-0c06331e61cb.htm) | A default Divided Path distance for a fixed, minimum, or maximum distance layout. |
| Public property | [PathLayout](f945b3cf-7725-41b2-75ac-ff0f3cf60d42.htm) | A default Divided Path layout. |
| Public property | [PathMeasurementType](6f4f7a4d-112c-10ef-d675-da94d5ea4404.htm) | A default Divided Path measurement type for distance layouts. |
| Public property | [PathNumber](b9b98d23-5e6f-ec10-1264-458c3cf43472.htm) | A default Divided Path number for a fixed number layout. |
