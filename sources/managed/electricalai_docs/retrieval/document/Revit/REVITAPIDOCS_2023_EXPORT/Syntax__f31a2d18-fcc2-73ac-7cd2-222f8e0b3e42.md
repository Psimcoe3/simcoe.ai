...
| C# |
| --- |
| ``` public FamilyInstanceCreationData( 	XYZ location, 	FamilySymbol symbol, 	StructuralType structuralType ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub New ( _ 	location As XYZ, _ 	symbol As FamilySymbol, _ 	structuralType As StructuralType _ ) ``` |
