...
|  |
| --- |
| [CurveElement Class](61673852-2d08-003d-e9fd-4be89d533774.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [CurveElement](61673852-2d08-003d-e9fd-4be89d533774.htm)  type exposes the following members.
...
| Public method Static member | [CreateAreaBasedLoadBoundaryLine](71384e53-8fc6-faad-b0fa-616f3d692f34.htm) | Creates an area based load boundary line. |
| Public method Static member | [CreateAreaBasedLoadBoundaryLines](aee4c63d-0894-39d4-560f-971bd29bf948.htm) | Creates area based load boundary lines. |
...
| Public method | [GetAdjoinedCurveElements](5f3eaf8b-047e-d287-49a9-8777af3a67da.htm) | Returns elements that are joining with this curve element at the given end point. |
| Public method | [GetAreaBasedLoadBoundaryLineData](a99e772c-9f79-c81f-14ec-71703e19676e.htm) | Gets the area based load boundary line data from this curve, if applicable. |
...
| Public method | [GetLineStyleIds](3e30d0b4-6c74-18bf-043f-2430ff9ac17b.htm) | Ids of all line style Elements that are applicable to this curve element. |
...
| Public method | [GetTangentLock](7544e419-0805-5c12-8c12-9599e1b16065.htm) | Returns the state of a tangent join between this and another curve element at the given end-point. |
...
| Public method | [HasTangentJoin](a7b2da39-2bab-5cea-5441-eb3ad476a81f.htm) | Tests whether this curve element and the input curve element have common tangent join at the given end-point. |
| Public method | [HasTangentLocks](1be690bc-28ee-5d33-b253-7835c35cb158.htm) | Tests whether this curve element has any locked tangent joins at the given end-point. |
| Public method | [IsAdjoinedCurveElement](c72d52bd-4ca6-c3ea-1666-436d3f317456.htm) | This method tests whether this and the given curve elements are joined at the given end. |
...
| Public method | [SetGeometryCurve](9deec90c-4efc-9aa6-245d-061669022aa2.htm) | Sets the geometry of the curve element. After the curve geometry is set, other nearby curves may join to the new curve geometry. |
| Public method | [SetSketchPlaneAndCurve](99c03261-aeb7-032f-d71e-1e03716cbfb3.htm) | Sets the sketch plane and the curve for this CurveElement. |
| Public method | [SetTangentLock](34e01fde-176d-c53b-1a9e-bda92dbdf142.htm) | Sets a new status for an existing tangent join with another curve element at the given end-point. |
...
| Public property | [CenterPointReference](8e17164e-f2d0-828d-8fe2-9720fec91303.htm) | Centerpoint reference of curve element. Curves such as circles, arcs, ellipses, and partial ellipses support this property. |
...
| Public property | [CurveElementType](0d8763e7-6d5b-bdb9-c4a7-d19c63f53dc9.htm) | Type of the curve element. |
...
| Public property | [GeometryCurve](713ec948-c85c-24fa-0668-c2c2bbdc4c73.htm) | Geometry curve of the curve element. |
...
| Public property | [LineStyle](691e64a2-e5ea-b619-4362-1a2c17e23b2f.htm) | The line style of this curve element. |
...
| Public property | [SketchPlane](e8c6a9e9-e048-d750-2951-6f45ac7f350d.htm) | The sketch plane the curve element lies in. |
| Public property | [SupportsTangentLocks](b0fded94-12f7-963f-5e1b-7a67d8bc7ba3.htm) | Indicates whether or not this curve element can have a locked tangent join at either of its end-points shared with another curve element. |
