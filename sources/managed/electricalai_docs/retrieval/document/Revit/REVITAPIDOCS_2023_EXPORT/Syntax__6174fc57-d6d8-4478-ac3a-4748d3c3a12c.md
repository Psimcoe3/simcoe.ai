...
| Visual Basic |
| --- |
| ``` Public Property ProjectReportType As HVACLoadLoadsReportType 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property HVACLoadLoadsReportType ProjectReportType { 	HVACLoadLoadsReportType get (); 	void set (HVACLoadLoadsReportType value); } ``` |

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | When setting this property: The project report type does not fall within an appropriate range. |
