...
| C# |
| --- |
| ``` public void SetMajorLayoutAsFixedNumber( 	double overallWidth, 	double minorStartOverhang, 	double minorEndOverhang, 	int numberOfWires ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub SetMajorLayoutAsFixedNumber ( _ 	overallWidth As Double, _ 	minorStartOverhang As Double, _ 	minorEndOverhang As Double, _ 	numberOfWires As Integer _ ) ``` |
