...
|  |
| --- |
| [DuctSettings Class](cd632c8e-a520-2efb-a417-9dfa5677d134.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [DuctSettings](cd632c8e-a520-2efb-a417-9dfa5677d134.htm)  type exposes the following members.
...
| Public method Static member | [GetDuctSettings](80923557-908d-ce4b-b711-9134e567a658.htm) | Get the duct settings of the project. |
...
| Public method | [GetPressLossCalculationServerInfo](301d0233-9033-7ed8-9a66-aaa55c63ddfd.htm) | Get the MEPServerInfo of the current pipe pressure loss calculation server. |
| Public method | [GetSpecificFittingAngles](0f140871-90cc-03cb-81f7-0cc33a1b24bc.htm) | Gets the list of specific fitting angles. |
| Public method | [GetSpecificFittingAngleStatus](3d357c63-7ac9-01d1-7468-ebd4a3bf998a.htm) | Gets the status of given specific angle. |
...
| Public method | [IsValidSpecificFittingAngle](4bfcf63d-bb63-a480-0487-a1d75f1308f7.htm) | Checks that the given value is a valid specific fitting angle. The specific fitting angles are angles of 90, 60, 45, 30, 22.5 or 11.25 degrees. |
...
| Public method | [SetPressLossCalculationServerInfo](8632a1d8-5126-ead1-985e-ade923e55461.htm) | Set the MEPServerInfo of the current pipe pressure loss calculation server. |
| Public method | [SetSpecificFittingAngleStatus](9461503b-101d-ff04-6ad4-805578deb5f8.htm) | Sets the status of given specific angle. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AirDensity](fffd52f7-044c-1a46-6943-ff877dec3279.htm) | The air density. |
| Public property | [AirViscosity](6c77b0f7-1565-e199-eef0-ffadc4714b25.htm) | The air dynamic viscosity. |
...
| Public property | [Centerline](9a7b2e55-5810-62ea-76a4-5db9b5f2e5ab.htm) | The abbreviation of the Centerline (=) string. |
| Public property | [ConnectorSeparator](ca95fd1d-8c62-437a-f0be-feefe37ec20f.htm) | The duct connector separator string. |
...
| Public property | [FittingAngleUsage](8112e243-c20e-35e6-02aa-f0e061538cd0.htm) | Determine how to use fitting angle during duct layout or modifying layout. |
| Public property | [FittingAnnotationSize](ad1cbd39-b54e-6532-3db4-4621d0158663.htm) | The value of fitting annotation size. |
| Public property | [FlatOnBottom](6d4acd42-372e-9ed4-bad2-dc019b99239f.htm) | The abbreviation of the Flat On Bottom (FOB) string. |
| Public property | [FlatOnTop](717ef71c-64bf-953a-adad-213004aaf6ca.htm) | The abbreviation of the Flat On Top (FOT) string. |
...
| Public property | [OvalDuctSizeSeparator](fcde64b8-e345-25cd-29ad-0164438b16ef.htm) | The oval duct size separator string. |
| Public property | [OvalDuctSizeSuffix](01a4fd90-4660-a555-b3d4-4388b3e9b4c3.htm) | The oval duct size suffix string. |
...
| Public property | [RectangularDuctSizeSeparator](5bbed76e-f811-b98b-288a-6f74aa2b0f2c.htm) | The rectangular duct size separator string. |
| Public property | [RectangularDuctSizeSuffix](6f59f18c-7a72-2819-3670-19f80aede525.htm) | The rectangular duct size suffix string. |
| Public property | [RiseDropAnnotationSize](37074af6-8bb9-b562-2521-a0370382eed8.htm) | The rise drop annotation size. |
| Public property | [RoundDuctSizePrefix](d1f1f1df-ff92-8640-4aa1-72dd2ef1114c.htm) | The round duct size prefix string. |
| Public property | [RoundDuctSizeSuffix](abf0c448-17e8-dd63-bc37-8e695d268b75.htm) | The round duct size suffix string. |
| Public property | [SetDown](a6b3a1bd-acd6-6ed0-ff42-00cf4ef48d18.htm) | The abbreviation of the Set Down from top (TD) of fitting string. |
| Public property | [SetDownFromBottom](a58f3175-0d33-e7ae-fe40-e332b19ea490.htm) | The abbreviation of the Set Down from bottom (BD) of fitting string. |
| Public property | [SetUp](158723ab-631f-05b6-48d2-75cd9aa0edf0.htm) | The abbreviation of the Set Up from top (TU) of fitting string. |
| Public property | [SetUpFromBottom](45e7e748-e45b-1d98-04db-ea9a48314163.htm) | The abbreviation of the Set Up from bottom (BU) of fitting string. |
...
| Public property | [UseAnnotationScaleForSingleLineFittings](ca019bfb-0ff9-8e14-9848-797bd3fcdd9a.htm) | Indicates whether use annotation scale for single line fittings or not. |
