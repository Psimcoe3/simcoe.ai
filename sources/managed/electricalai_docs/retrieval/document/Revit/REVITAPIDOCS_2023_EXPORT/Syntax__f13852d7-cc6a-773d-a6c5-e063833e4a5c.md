...
| C# |
| --- |
| ``` public OverrideGraphicSettings SetCutBackgroundPatternId( 	ElementId fillPatternId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function SetCutBackgroundPatternId ( _ 	fillPatternId As ElementId _ ) As OverrideGraphicSettings ``` |
