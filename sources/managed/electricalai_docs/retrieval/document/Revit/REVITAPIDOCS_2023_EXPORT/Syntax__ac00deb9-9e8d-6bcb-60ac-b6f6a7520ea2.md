...
| Visual Basic |
| --- |
| ``` Public Function ComputeRawParameter ( _ 	normalizedParameter As Double _ ) As Double ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | Thrown when normalizedParameter is infinite. |
