...
| C# |
| --- |
| ``` public StructuralWallUsageFilter( 	StructuralWallUsage structuralWallUsage, 	bool inverted ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub New ( _ 	structuralWallUsage As StructuralWallUsage, _ 	inverted As Boolean _ ) ``` |
...
structuralWallUsage
:   Type:  [Autodesk.Revit.DB.Structure StructuralWallUsage](27172688-7a15-3991-240c-13705909ba51.htm)    
