...
| C# |
| --- |
| ``` public OverrideGraphicSettings SetCutLinePatternId( 	ElementId linePatternId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function SetCutLinePatternId ( _ 	linePatternId As ElementId _ ) As OverrideGraphicSettings ``` |
