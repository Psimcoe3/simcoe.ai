...
| Visual Basic |
| --- |
| ``` Public Function AddParameter ( _ 	familyDefinition As ExternalDefinition, _ 	parameterGroup As BuiltInParameterGroup, _ 	isInstance As Boolean _ ) As FamilyParameter ``` |
