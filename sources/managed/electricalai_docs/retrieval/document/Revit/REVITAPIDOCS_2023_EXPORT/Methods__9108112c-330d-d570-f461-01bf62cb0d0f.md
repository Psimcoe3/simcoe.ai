...
|  |
| --- |
| [EnergyDataSettings Class](63628109-daa0-e5b2-3dfd-153179e54816.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method Static member | [CheckAnalysisType](d0c7a1c6-96aa-482c-9b57-e1b0365b7f66.htm) | Checks that the analysis type falls within an appropriate range. |
| Public method Static member | [CheckBuildingConstructionClass](40d11195-0a0e-8867-9d92-74288ddc88ee.htm) | Checks that the building construction class falls within an appropriate range. |
| Public method Static member | [CheckBuildingEnvelope](1168066f-110b-cbcb-b983-12fdb7f44906.htm) | Checks that the building envelope determination method falls within an appropriate range. |
| Public method Static member | [CheckBuildingHVACSystem](54e37f5e-e7c7-1eb6-622e-f271775b8716.htm) | Checks that the building HVAC system falls within an appropriate range. |
| Public method Static member | [CheckBuildingOperatingSchedule](1cad3583-7bbc-ec0e-258e-f9d23464dee4.htm) | Checks that the building operating schedule falls within an appropriate range. |
| Public method Static member | [CheckBuildingType](5d9ab4ae-9c43-c7b7-f851-39f04ab95989.htm) | Checks that the building type falls within an appropriate range. |
| Public method | [CheckConstructionSetElement](88be30fb-288e-01ee-3ca3-c1b303ee8b56.htm) | Checks that the construction set ElementId is acceptable. |
| Public method Static member | [CheckExportCategory](a29a9a14-1b3f-c4ef-220e-011818b56e83.htm) | Checks whether the export category falls within the list:  1. OST\_Rooms 2. OST\_MEPSpaces |
| Public method Static member | [CheckExportComplexity](44fe6f91-8845-b285-d31e-21a818418503.htm) | Checks that the export complexity falls within an appropriate range. |
...
| Public method | [CheckProjectPhase](c6ab5f88-0895-3812-8d3e-89b6fd1103fa.htm) | Checks that the input element is a project phase. |
| Public method Static member | [CheckProjectReportType](a81fd0d4-13b2-1a7c-b1a1-e9290dc45336.htm) | Checks that the project report type falls within an appropriate range. |
| Public method Static member | [CheckRangeOfPercentageGlazing](ddb77c33-c1c1-76ad-3068-7b0dd03ff1ca.htm) | Checks that the percentage glazing value is between 0.00 and 0.95. |
| Public method Static member | [CheckRangeOfPercentageSkylights](99df2c0a-bdf5-f187-b1a6-5d34533d58de.htm) | Checks that the percentage skylights value is between 0.00 and 0.95. |
| Public method Static member | [CheckRangeOfShadeDepth](0533ab49-9519-10d2-ab53-103dde34a7fc.htm) | Checks that the shade depth is greater than or equal to zero. |
| Public method Static member | [CheckRangeOfSillHeight](484a4c0b-fa66-4049-af95-b6573aa0c78a.htm) | Checks that the sill height is greater than or equal to zero. |
| Public method Static member | [CheckRangeOfSkylightWidth](a224f2e3-ff95-7852-40dc-8875187c397d.htm) | Checks that the skylight width is greater than or equal to eight inches. |
| Public method Static member | [CheckRangeOfSliverSpaceTolerance](ea90ab77-c7f4-66aa-0b63-906d5281dd31.htm) | Checks that the sliver space tolerance is greater than or equal to zero. |
| Public method Static member | [CheckServiceType](b6738580-e388-c47d-e678-562eddee4690.htm) | Checks that the service type falls within an appropriate range. |
...
| Public method Static member | [EnableConceptualEnergyAnalyticalModel](4199a022-71af-a960-3a3a-371585f36188.htm) | **Obsolete.**   Turns on functionality related to conceptual energy analysis. |
| Public method | Equals | Determines whether the specified  Object  is equal to the current  Object  . (Inherited from  Object  .) |
| Public method Static member | [GetBuildingConstructionSetElementId](73394ff4-98f4-f782-061b-a3fc02e1352c.htm) | Id of the building construction set. |
...
| Public method Static member | [GetFromDocument](030c1184-846a-440c-d0df-72e756918d96.htm) | Every project document has a EnergyDataSettings element. Family documents do not have EnergyDataSettings elements. |
...
| Public method | [GetReportsFolderParsed](e657929e-c094-0b2b-a19f-e19538ef4378.htm) | Gets the absolute reports folder path that is parsed from the original input. |
...
| Public method Static member | [IsDocumentUsingEnergyDataAnalyticalModel](53794ee4-dc48-fadf-065a-dbf03467dd1b.htm) | Get EnergyDataSettings element and if it exists, return result from getCreateAnalyticalModel. |
...
| Public method | [SetCreateAnalyticalModel](2697cd0b-4f2b-bc05-eeeb-afe29f007fc6.htm) | **Obsolete.**   If this is true, data, features, and geometry related to the Energy Analytical Model will be created, allowing the energy performance to be analyzed through GreenBuilidingXML. |
...
| Public method | [SetReportsFolder](d13d3951-5f37-5774-6fde-44131f676aa5.htm) | Sets the reports folder path. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AnalysisType](95fb9ccf-29f0-ca97-895b-bd72c717a6f0.htm) | The type of analysis mode. |
| Public property | [AnalyticalGridCellSize](230702f7-ccf6-3c1d-b9a4-cb1b38c65f50.htm) | The cell size for the uniform cubical grid used when computing the building envelope |
...
| Public property | [BuildingConstructionClass](3427f2cb-5fde-abdc-3c6e-b513f2c58034.htm) | Used for both the detailed and conceptual energy model Construction class of building as defined by: loose, medium, tight, or none. |
| Public property | [BuildingEnvelopeDeterminationMethod](c2b5d048-aad6-989b-cd15-4386dc5c1080.htm) | Indicates if an analysis should be perform to find the model elements that are part of the building envelope |
| Public property | [BuildingHVACSystem](a587f6f0-b3e4-fc53-f0ca-0b168e21eb69.htm) | The type of HVAC system used by the building for conceptual model energy calculations. |
| Public property | [BuildingOperatingSchedule](371fc47a-dedc-d50b-1a00-3c9a6d9e7f2b.htm) | The operating schedule of the building used for conceptual model energy calculations. |
| Public property | [BuildingType](808808c3-841e-ba74-c5ed-17e8d788f024.htm) | The type of building. |
| Public property | [BuildingTypeId](b20ad078-bbc6-3c0a-84eb-f4414af6e5d7.htm) | The building type element. |
...
| Public property | [CoreOffset](c334bad0-d75f-2881-f6b2-a220453cd44e.htm) | The default offset used to determine the outer perimeter to be divided into zones. |
| Public property | [CreateAnalyticalModel](bdb566d6-054a-41f4-2508-081e097f34bf.htm) | If this is true, data, features, and geometry related to the Energy Analytical Model will be created, allowing the energy performance to be analyzed through GreenBuilidingXML. |
...
| Public property | [DividePerimeter](8e97b4d9-1db3-54dc-e1fe-3fa751954a68.htm) | If this is true, zones with exterior boundaries on each floor of the building will be divided based on geometric criteria. |
...
| Public property | [EnergyModel](bd93969d-9bdd-2c43-7be3-694cdcbf65c1.htm) | if this is on there should be an energy model dependent on the current AnalysisType if it is off the conceptual energy model should be turned off but setting this datum does not do the work, just reflects the state. |
| Public property | [ExportCategory](be269eca-22b1-9a1a-7e13-db7f8cdae1e0.htm) | Value is a category indicating which discipline model will be used for GreenBuildingXML export. |
| Public property | [ExportComplexity](422b9c1f-76ba-788b-9a32-2b7f063a8a7b.htm) | Value determines Export Complexity for GreenBuildingXML detailed model export. |
| Public property | [ExportDefaults](37e75308-01c8-5b08-e2f7-34eb199d9e59.htm) | Use for detailed model GreenBuildingXML export. When this setting is true, all building and space defaults, schedules, and constructions will be exported to GreenBuildingXML. When this setting is false, only values that are specified on the zone or space will be exported to GreenBuildingXML. |
...
| Public property | [GroundPlane](3a6a5942-1fd7-cd1c-306b-c582da4f2abf.htm) | Id of level which represents ground level. |
...
| Public property | [IncludeThermalProperties](ce7f8c60-211d-5f32-f4f4-8d44c638697c.htm) | Indicates if thermal information from model assemblies and components is included in GreenBuildingXML export of the detailed model. |
| Public property | [IsExportMullionsEnabled](968592ed-b618-386f-ca4e-79a07a67484c.htm) | Indicates if mullions are included in GreenBuildingXML export of the detailed model. |
| Public property | [IsExportShadingSurfacesEnabled](9d249657-2528-8e39-304f-c62e98d77778.htm) | Indicates if "shading surfaces" are included in GreenBuildingXML export of the detailed model. |
| Public property | [IsExportSimplifiedCurtainSystemsEnabled](96457e45-6195-50c6-653c-0976110d8657.htm) | Indicates if curtain system geometry is being simplified for GreenBuildingXML export of the detailed model. |
| Public property | [IsGlazingShaded](377c5e7c-edce-99fd-416a-25dcff31dddc.htm) | If this is true, glazing/windows that are auto-created on exterior walls will automatically have a shading device created on their top edge. |
...
| Public property | [OutsideAirChangesRatePerHour](17496b1f-31b1-55e1-09fe-10da1c84a765.htm) | The number of times the volume of air interchanges in the room in one hour. |
| Public property | [OutsideAirPerArea](e64e7fb7-db8b-f237-b5c1-ed612d9b72ec.htm) | The rate of flow of outside air available per unit area. |
| Public property | [OutsideAirPerPerson](f6eb8a89-7acc-96a4-f16e-8c9c4273d60b.htm) | The rate of flow of outside air available per person. |
...
| Public property | [PercentageGlazing](3b754027-2f58-c902-e232-073a663ab85b.htm) | Used for the conceptual energy model. The approximate percentage of the building exterior wall surfaces which are covered by windows or other glazing. |
| Public property | [PercentageSkylights](e9696dc1-548e-556a-57df-4571ec3474a7.htm) | Used for the conceptual energy model. The approximate percentage of the building roof surfaces in massing instances for the Conceptual Energy Analytical Model. |
...
| Public property | [ProjectPhase](dcecd10d-c80c-e1e2-11ba-c0ae57951deb.htm) | The project phase of the EnergyData information. |
| Public property | [ProjectReportType](6174fc57-d6d8-4478-ac3a-4748d3c3a12c.htm) | Report type: None, simple, standard, detailed |
| Public property | [ReportsFolder](fe7d556f-988a-9293-5fbd-651cd3690346.htm) | The folder path where all systems analysis reports are stored. It may include special label and relative path. |
| Public property | [ServiceType](f6fa2563-3e68-a8cb-16f2-e4188c54125e.htm) | The type of heating or cooling system. |
| Public property | [ShadeDepth](14040f22-1265-69ae-1224-da378fcff384.htm) | Used for the conceptual energy model. Amount that auto-generated shading will extend from auto-generated windows. |
| Public property | [SillHeight](812faa45-0613-5e51-2f87-b6b569c79485.htm) | Used for the conceptual energy model. The height from the nearest lower level used for auto-glazing created on walls. |
| Public property | [SkylightWidth](ea98f7ae-61f9-e86d-1049-34af57bb37a6.htm) | Used for the conceptual energy model. The approximate width used for the skylights in massing instances when the Energy Analytical model is being created. |
| Public property | [SliverSpaceTolerance](dbca870f-989e-1134-5ef9-b6a5b47c6508.htm) | Used for Detailed GreenBuildingXML export. This value is used to identify sliver spaces, i.e. spaces bounded by parallel surfaces belonging to different rooms. |
...
| Public property | [UseAirChangesPerHour](1803b1d4-db50-fb04-d72c-0f658bde445f.htm) | True if user is specifying air changes per hour, false otherwise. |
| Public property | [UseHeatingCredits](fdcb479b-a4f7-9ba8-b6f7-d8f7caba78fd.htm) | If true, Revit will use heating credits in the final load sum calculations. If false, Revit will ignore heating credits in the final load sum calculations. |
| Public property | [UseOutsideAirPerArea](d6be1399-07ff-844f-7b1b-f024cdf00b25.htm) | True is user is specifying outside air per area, false otherwise. |
| Public property | [UseOutsideAirPerPerson](9737b630-ea9c-8ab6-7718-a49dff95ccf7.htm) | True if user is specifying outside air per person, false otherwise. |
