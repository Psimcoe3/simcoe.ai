...
|  |
| --- |
| [LoadBase Class](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  type exposes the following members.
...
| Public method | [IsOrientToPermitted](8681b54f-c427-9024-9ede-98ec917d0f8d.htm) | Indicates if the provided orientation is permitted for this load. |
...
| Public property | [HostElementId](c0fc581d-431e-0749-e7d9-7218e9b426c8.htm) | The host element ID for the load. |
...
| Public property | [IsHosted](76965c6d-473a-9ad9-8a72-baa7a47b055a.htm) | Indicates if the Load is hosted or non-hosted. |
...
| Public property | [IsReaction](3d159400-28fb-9f92-b4b1-1aab870c21f0.htm) | The load is reaction option. |
...
| Public property | [LoadCase](f0d56d0d-dc16-1fb2-f27f-70a989f6bbcf.htm) | The load case for the load. |
| Public property | [LoadCaseId](8bb0908c-30a7-f090-7586-b1bab8e8cc42.htm) | The load case ID for the load. |
| Public property | [LoadCaseName](9bf650db-2f9c-08c3-ad05-33ce349b9134.htm) | The name of the load case to which this load belongs. |
| Public property | [LoadCategoryName](4a1c7865-8f07-b291-6cc8-fb23a842dad8.htm) | The name of the category to which this load belongs. |
| Public property | [LoadNatureName](3f764b90-19b0-8fbb-50ae-f38400a89676.htm) | A string representing the nature of the load. |
...
| Public property | [OrientTo](c1252918-899f-23f0-c3e8-c0e5817ef812.htm) | The load orientation option. |
...
| Public property | [WorkPlaneId](19d3d2d4-82e9-465a-5cf4-d3e613ad238f.htm) | Id of the work plane which may determine the orientation of the load. |
