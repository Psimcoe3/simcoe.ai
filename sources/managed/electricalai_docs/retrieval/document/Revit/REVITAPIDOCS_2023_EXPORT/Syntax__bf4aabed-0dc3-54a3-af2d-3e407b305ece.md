...
| C# |
| --- |
| ``` public static bool IsLessThanOrAlmostEqual( 	double value1, 	double value2 ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function IsLessThanOrAlmostEqual ( _ 	value1 As Double, _ 	value2 As Double _ ) As Boolean ``` |
