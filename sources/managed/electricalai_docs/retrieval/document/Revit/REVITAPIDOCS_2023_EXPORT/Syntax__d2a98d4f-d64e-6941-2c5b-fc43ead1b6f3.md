...
| C# |
| --- |
| ``` public ElementId Link( 	string file, 	STLImportOptions options, 	View pDBView ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function Link ( _ 	file As String, _ 	options As STLImportOptions, _ 	pDBView As View _ ) As ElementId ``` |
