...
|  |
| --- |
| [TemperatureRatingType Class](fe7e15d7-c31f-b24c-992f-332e54e9a5ba.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [TemperatureRatingType](fe7e15d7-c31f-b24c-992f-332e54e9a5ba.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AddCorrectionFactor](c8c0c7ac-34af-bc90-e55f-6f1a7baa0572.htm) | Add a new electrical correction factor type to this temperature rating type. The given temperature value should be quantified in the document's selected unit of electrical temperature. |
| Public method | [AddInsulationType](b8c6e5cd-0913-b410-f2c2-ef2592da1536.htm) | Add a new kind of insulation type into this temperature rating type. |
| Public method | [AddWireSize](21783809-813d-46fa-b237-e516e06517c2.htm) | Add a new kind of wire size type into this temperature rating type. |
...
| Public method | [RemoveCorrectionFactor](2f2d2223-1a23-bac7-4666-68c2ef5a92d0.htm) | Remove an existing correction factor from this temperature rating type in Revit MEP project. |
| Public method | [RemoveInsulationType](1195de62-fe29-f235-70f1-2e78c6e5f849.htm) | Remove an existing insulation type from this temperature rating type. |
| Public method | [RemoveWireSize](a6195154-d5f0-46f3-3bb4-f5325de5da17.htm) | Remove an existing wire size type from this temperature rating type. |
...
| Public property | [CorrectionFactors](e0b0df88-e174-3f9d-c33a-5a7f510a4c3a.htm) | Get all correction factors defined in this temperature rating type and its corresponding material type. |
...
| Public property | [InsulationTypes](5cdebb2b-28d5-c269-77a9-88397ec71ab8.htm) | Get all insulation types defined in this temperature rating type and its corresponding material type. |
| Public property | [IsInUse](299c4fea-6792-f095-ddeb-a5f0369c9b67.htm) | Indicate whether the temperature rating type is in use. |
...
| Public property | [MaterialType](866dd039-e888-66fb-d844-c99b2b14a11f.htm) | Get the material type information which this temperature rating type belongs to. |
| Public property | [Name](35bbef58-e76c-35bf-b2e2-1ccd3e99f1e1.htm) | Get name of temperature rating type. (Overrides  [ElementType Name](1198805b-fdbf-54bf-64d3-90dbd01b4c5f.htm)  .) |
...
| Public property | [WireSizes](e3774ff7-1914-815d-8611-abb1c3174021.htm) | Get all electrical wire sizes defined in this temperature rating type and its corresponding material type. |
