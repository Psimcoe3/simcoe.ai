...
|  |
| --- |
| [SelectionFilterElement Class](b0aaf230-e034-8466-c1e4-1d91e7162d19.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [SelectionFilterElement](b0aaf230-e034-8466-c1e4-1d91e7162d19.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AddSet](c486928c-cb19-29ab-3046-552e81674ccd.htm) | Adds a set of ElementIds to the filter's set. |
| Public method | [AddSingle](c8853934-1e21-98a7-0aa3-44bd2dd6bfd6.htm) | Adds a single ElementId to the filter's set. |
...
| Public method | [Clear](7f483abc-ae0f-3c0c-a3fc-b78ae1fcf54b.htm) | Removes all ElementIds from the filter. |
| Public method | [Contains](cae581e6-0aa0-10bd-827a-14392cacaf79.htm) | Returns true if the given ElementId is a member of this filter's set. |
| Public method Static member | [Create](5c70f0d8-1a1c-e850-eb69-52d36070eba9.htm) | Creates a new SelectionFilterElement in the given document. |
...
| Public method | [GetElementIds](42b70399-d151-8a68-8df6-546492c7091d.htm) | Returns the set of ElementIds contained by this filter. |
...
| Public method | [IsEmpty](343559df-977d-aa0f-d1c8-fdd75f439744.htm) | Determines whether this filter's set is empty or not. |
...
| Public method | [RemoveSet](c08b7b0f-8a65-e0d0-107e-ee9a9cc54806.htm) | Removes a set of ElementIds from the filter's set. |
| Public method | [RemoveSingle](6fdfc521-9c3c-5a9a-a549-85df55967a51.htm) | Removes a single ElementId from the filter's set. |
| Public method | [SetElementIds](1c3d03d1-e917-4513-f260-d8a33fa818ca.htm) | Replaces the set of ElementIds contained by this filter. |
