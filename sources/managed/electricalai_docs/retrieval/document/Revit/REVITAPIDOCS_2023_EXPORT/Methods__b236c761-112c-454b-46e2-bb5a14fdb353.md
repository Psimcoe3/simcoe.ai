...
|  |
| --- |
| [RebarBarType Class](467b44cc-54e7-3ecf-07e1-ad15d05fe800.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method Static member | [Create](87e9896d-863b-22e0-482c-92e032d42144.htm) | Creates a new RebarBarType object |
| Public method Static member | [CreateDefaultRebarBarType](be1c7098-bae0-2681-dea7-b081ce1bc698.htm) | Creates a new RebarBarType object with a default name. |
...
| Public method | [GetAutoCalcHookLengths](d31c3a4a-7ba2-0ed8-db11-65fa480c6f45.htm) | Identifies if the hook lengths of a hook type are automatically calculated for this bar type |
...
| Public method | [GetHookLength](abcf48ad-052f-40bd-ee5f-b5d59d607123.htm) | Identifies the hook length for a hook type |
| Public method | [GetHookOffsetLength](0a1cd042-dfeb-5a5f-734e-0b91d6a9e8dc.htm) | Identifies the hook offset length for a hook type |
| Public method | [GetHookPermission](bea2d183-cf94-dd90-97a0-04096f6c21a3.htm) | Identifies if a hook type is permitted for this bar type |
| Public method | [GetHookTangentLength](89dc8618-3109-4905-36b0-a8017044e651.htm) | Identifies the hook tangent length for a hook type |
...
| Public method | [GetReinforcementRoundingManager](2f5b170f-bb68-127e-adf7-5d0740e137c1.htm) | Returns an object for managing reinforcement rounding override settings. |
...
| Public method | [SetAutoCalcHookLengths](21dd89fe-8eac-3209-11f7-9c134f4ec9ef.htm) | Identifies if the hook lengths of a hook type are automatically calculated for this bar type |
| Public method | [SetBarTypeDiameters](cb45e0d8-18dc-2376-5952-9226ec8a0ca5.htm) | Sets all input diameters from diametersOptions in current RebarBarType. |
...
| Public method | [SetHookLength](d8a83bf6-d0ad-4bb2-d5b2-c7b026a4d4de.htm) | Identifies the hook length for a hook type |
| Public method | [SetHookOffsetLength](5e40bac1-64af-fa65-8825-58730e036daa.htm) | Identifies the hook offset length for a hook type |
| Public method | [SetHookPermission](7895d053-e52a-3c16-d39f-e1ae26d505e9.htm) | Identifies if a hook type is permitted for this bar type |
| Public method | [SetHookTangentLength](4c4ba82f-3645-13bd-1e3e-233f9b9c13b5.htm) | Identifies the hook tangent length for a hook type |
...
| Public property | [BarModelDiameter](f13299fd-9276-9263-a0cf-20e1b2161afb.htm) | Defines bar model diameter of rebar |
| Public property | [BarNominalDiameter](af82b6df-2053-aa48-ae42-f97349d875af.htm) | Defines bar nominal diameter of rebar |
...
| Public property | [DeformationType](72c74a9f-1091-5ddb-69d6-93837af6bfee.htm) | Defines bar deformation type. |
...
| Public property | [MaximumBendRadius](06aece02-da41-ef43-97e0-bc2d2f17e366.htm) | Defines maximum bend radius of rebar |
...
| Public property | [StandardBendDiameter](2ec8bbcf-f2e6-9511-ab34-1cdea8910ef2.htm) | Defines bar bend diameter for rebar whose style is standard |
| Public property | [StandardHookBendDiameter](87851d76-411f-c305-57a0-aaf75a7d0007.htm) | Defines hook bend diameter for rebar whose style is standard |
| Public property | [StirrupTieBendDiameter](5b62432d-4486-5df5-fc6a-1b2387924d64.htm) | Defines bar and hook bend diameter for rebar whose style is stirrup/tie |
