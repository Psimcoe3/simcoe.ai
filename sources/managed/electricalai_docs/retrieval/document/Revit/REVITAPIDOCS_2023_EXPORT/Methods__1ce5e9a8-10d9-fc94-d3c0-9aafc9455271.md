...
|  |
| --- |
| [CableTraySizes Class](dbd6f408-fbae-1fe0-0e61-7d611141d6b5.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [CableTraySizes](dbd6f408-fbae-1fe0-0e61-7d611141d6b5.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AddSize](3911b16c-b0e0-7730-0190-53b89974d697.htm) | Inserts a new MEPSize into the cable tray sizes. For cable tray, the nominal diameter of MEPSize is used . |
...
| Public method | [ClearAll](9be03014-448d-a06e-2b4c-6f8dafa914aa.htm) | Removes all MEPSizes in the cable tray sizes. |
| Public method | [Contains](041d076f-979f-6a91-854a-8e8e56f7a2fd.htm) | Checks whether a cable tray size with the nominal diameter exists. |
...
| Protected method | [GetBasicIEnumerator](61619f00-44c0-9693-a553-a2b76465e7cb.htm) | Returns an enumerator that iterates through a collection. |
| Public method Static member | [GetCableTraySizes](ed9b68ba-8759-16ad-e8e7-7d2c363c2662.htm) | Gets the cable tray sizes of the project. |
| Public method | [GetCableTraySizesIterator](a0aabc61-8f85-c9eb-c3ce-0026f4e5758d.htm) | Returns a CableTraySizeIterator to the MEP cable tray sizes. |
...
| Public method | [GetEnumerator](decc5942-dc4a-7508-b82f-cd5fe5c12a65.htm) | Returns an enumerator that iterates through a collection. |
...
| Public method | [GetSizeCount](3f140e73-ea0e-8d67-7061-63ff73d2de4c.htm) | Gets the size count of the cable tray size table. |
...
| Public method | [RemoveSize](06e0062d-fe6d-84dc-839b-ed50b8054eb4.htm) | Erases the existing MEPSize. For cable tray, the nominal diameter is used in MEPSize. |
