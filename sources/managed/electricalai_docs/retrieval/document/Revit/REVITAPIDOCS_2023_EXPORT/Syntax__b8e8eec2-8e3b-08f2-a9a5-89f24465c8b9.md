...
| Visual Basic |
| --- |
| ``` Public Shared Function Create ( _ 	document As Document, _ 	symId As ElementId, _ 	ownerDBViewId As ElementId, _ 	referenceToTag As Reference, _ 	addLeader As Boolean, _ 	tagOrientation As TagOrientation, _ 	pnt As XYZ _ ) As IndependentTag ``` |
