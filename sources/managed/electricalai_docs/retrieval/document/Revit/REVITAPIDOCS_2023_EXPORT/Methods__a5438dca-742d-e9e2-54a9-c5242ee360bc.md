...
|  |
| --- |
| [PointCloudInstance Class](d17686cb-b8c5-bee5-44d3-0311d27678e0.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [PointCloudInstance](d17686cb-b8c5-bee5-44d3-0311d27678e0.htm)  type exposes the following members.
...
| Public method | [ContainsScan](989fa5aa-6a04-2198-44e4-bde5d49fc2a9.htm) | Identifies whether the instance contains a scan. |
| Public method Static member | [Create](d348f6b8-75b5-dc11-821f-927d575d83f8.htm) | Creates a new instance of a point cloud based on an input point cloud type and transformation. |
...
| Public method | [GetPoints](6761fd71-e38e-d60f-90f7-9e034bf2d5c0.htm) | Extracts a collection of points based on a filter. |
| Public method | [GetRegions](6fd8f8f6-a0e1-c34f-fc82-4f72cea2aa81.htm) | Returns array of region names. |
| Public method | [GetScanOrigin](2c3c465d-8681-6eb3-284b-f75fdfa10c0c.htm) | Returns the origin point of a scan in model coordinates. |
| Public method | [GetScans](070a03d1-c33d-fc17-324e-60f727fcfb3c.htm) | Returns array of scan names. |
| Public method | [GetSelectionFilter](90e19864-52cf-2f0c-4792-698236b03c9b.htm) | Returns the currently active selection filter for this point cloud. |
...
| Public method | [HasColor](55cdf3f1-02a5-499f-99a4-97ae92f07c43.htm) | Returns true if at least one scan of the element have color, false otherwise. |
...
| Public method | [SetSelectionFilter](780c480f-88dc-54b4-0b89-b7448dc741b0.htm) | Sets active selection filter by cloning of the one passed to it. |
...
| Public property | [FilterAction](34b01a28-e1f7-b8b3-06fb-83f28e4b64c3.htm) | The action taken based on the results of the selection filter applied to this point cloud. |
...
| Public property | [SupportsOverrides](51fe7564-bb16-0ae4-5e2c-c2e80e77fce2.htm) | Identifies whether the instance can have graphic overrides. |
