...
| C# |
| --- |
| ``` public static Guid RegisterService( 	ISingleServerService service, 	Guid defaultServerId, 	ExternalServiceOptions options ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function RegisterService ( _ 	service As ISingleServerService, _ 	defaultServerId As Guid, _ 	options As ExternalServiceOptions _ ) As Guid ``` |
