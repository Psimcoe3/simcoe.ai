...
|  |
| --- |
| [ComponentRepeater Class](27dbc5bd-40e7-c044-11e6-7053adf92c6f.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [ComponentRepeater](27dbc5bd-40e7-c044-11e6-7053adf92c6f.htm)  type exposes the following members.
...
| Public method Static member | [CanElementBeRepeated](85030abd-7476-91fc-a67b-50dd8bcf9697.htm) | Determines whether an element can be repeated using the  **RepeatElements**  method. |
...
| Protected method | [GetBasicIEnumerator](f88e21de-e2b8-571f-5ba3-5cf746506737.htm) | Returns an enumerator that iterates through a collection. |
...
| Public method | [GetEnumerator](95071080-0ca2-ca24-76a2-5fd4ec2fb209.htm) | Returns an enumerator that iterates through a collection. |
...
| Public method | [IsTypeValidForRepeater](64b2d4bf-7c8f-e641-5d78-e95565bc5c77.htm) | Determines whether given family type can be used as the default type for the repeater. |
...
| Public method Static member | [RemoveRepeaters](f36b63f5-18dd-9279-7596-99548faf325e.htm) | Removes component repeaters from the document, but leaves the individual repeated components in their respective locations and hosted on their original hosts. |
| Public method Static member | [RepeatElements](fea4df07-ac92-08f3-ae93-8d0a512d0e76.htm) | Repeats a set of adaptive component hosted on one or more repeating references. |
...
| Public property | [DefaultFamilyType](5c58ac2c-7cf7-3fe1-dab4-7749c1b5a055.htm) | The default family type for the component repeater. |
...
| Public property | [DimensionCount](c958b9ec-0aeb-d97f-0fcb-a0ecc58b9db6.htm) | The dimension count of the component repeater. |
