...
|  |
| --- |
| [Stairs Class](45e2c068-7e52-c84a-cfb8-a53c531d28fa.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method | [GetAssociatedRailings](e4907577-c0b1-fd40-3ae5-99f6b2d2558d.htm) | Gets a list of the Railing elements which are associated to the boundaries of the stairs. |
...
| Public method | [GetStairsLandings](675ad372-825f-7e26-d2ed-147abc85f726.htm) | Returns all the stairs landing components in the stairs. |
| Public method | [GetStairsRuns](a8812cc1-6ba7-7908-bea6-92e5bcb19627.htm) | Returns all the stairs run components in the stairs. |
| Public method | [GetStairsSupports](25cddd3f-315f-7648-b87d-a12107613cde.htm) | Returns all the stairs support components in the stairs. |
...
| Public method Static member | [IsByComponent](a2a67884-d354-3e11-14e6-8dc6a1d06a5b.htm) | Indicates if the stairs is created by stairs components(runs, landings and supports). |
...
| Public method | [IsInEditMode](06d379fb-9d56-e9a1-909d-152194599997.htm) | Indicates whether the stairs is in edit mode or not. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [ActualRiserHeight](d3e335fe-ab3e-118b-156a-db30067ad523.htm) | The actual height of the stairs risers in the stairs. |
| Public property | [ActualRisersNumber](8a74a295-99ff-1a98-c0e5-cb84d86fed07.htm) | The total number of actually created risers in model. |
| Public property | [ActualTreadDepth](a29b78ff-5359-ff5f-c742-889e8f50eaa8.htm) | The actual depth of the stairs treads in the stairs, actual tread depth is equal to minimum tread depth by default. |
| Public property | [ActualTreadsNumber](224855f5-eb2b-84bc-864a-a3819cdf855c.htm) | The number of treads actually created in the stairs. |
...
| Public property | [BaseElevation](c53902d6-e634-b052-6327-2fcad8939807.htm) | The base elevation of the stairs. |
...
| Public property | [DesiredRisersNumber](a595b61c-47d2-0194-a4c6-5945c6bb591b.htm) | The number of risers is calculated based on the height between levels. |
...
| Public property | [Height](252de077-e133-070a-cb90-7737bf0f445d.htm) | The height of the stair between the base and top levels. |
...
| Public property | [MultistoryStairsId](c355cbe0-14d8-4644-97cc-14afde78a975.htm) | The id of the MultistoryStairs element to which this element belongs. If this stairs element is not a member of a MultistoryStairs element, this will be InvalidElementId. |
...
| Public property | [NumberOfStories](f8ac077d-035b-38d2-f669-642b6ae8c139.htm) | The number of stories of a multi-story stair, or 1 for a single-story stair. |
...
| Public property | [TopElevation](da7ad5d7-c683-a974-7a95-757c8c4367db.htm) | The top elevation of the stairs. |
