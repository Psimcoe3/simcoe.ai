...
| C# |
| --- |
| ``` public FamilyInstanceCreationData( 	XYZ location, 	FamilySymbol symbol, 	XYZ referenceDirection, 	Element host, 	StructuralType structuralType ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub New ( _ 	location As XYZ, _ 	symbol As FamilySymbol, _ 	referenceDirection As XYZ, _ 	host As Element, _ 	structuralType As StructuralType _ ) ``` |
