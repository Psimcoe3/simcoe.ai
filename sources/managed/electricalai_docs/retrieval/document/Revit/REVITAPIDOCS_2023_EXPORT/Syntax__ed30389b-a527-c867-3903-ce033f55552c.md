...
| Visual Basic |
| --- |
| ``` Public Function AddMapField ( _ 	fieldName As String, _ 	keyType As Type, _ 	valueType As Type _ ) As FieldBuilder ``` |
...
| [Autodesk.Revit.Exceptions ArgumentsInconsistentException](05972c68-fa6d-3a83-d720-ad84fbc4780f.htm) | The combination of key and value types is not supported. |
