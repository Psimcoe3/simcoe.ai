...
|  |
| --- |
| [Floor Class](96cc6685-003d-ff90-1c5b-c25a4830f0f7.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [Floor](96cc6685-003d-ff90-1c5b-c25a4830f0f7.htm)  type exposes the following members.
...
| Public method Static member | [GetDefaultFloorType](3eebff6a-ccfa-d4ab-fcf8-239d4d2ec8de.htm) | Returns id of default floor type. |
...
| Public method | [GetNormalAtVerticalProjectionPoint](f27752c0-4c9e-df9f-e3cd-34a1465cf11a.htm) | Return a surface normal on either the top or bottom face of a floor slab at a point corresponding to the vertical projection of an arbitrary point in project space. |
...
| Public method | [GetSpanDirectionSymbolIds](253ac763-7b9b-7efb-8eca-5b6599fd8d5f.htm) | Retrieves span direction symbol ElementIds. |
...
| Public method | [GetVerticalProjectionPoint](7c9e72b2-c058-44cb-e355-4bf819b4371d.htm) | Return a surface point on either the top or bottom face of a floor slab corresponding to the vertical projection of an arbitrary point in project space. |
...
| Public property | [FloorType](18c20723-c74e-6924-406d-fd0d8bae7ae1.htm) | Retrieves/sets an object that represents the type of the floor. |
...
| Public property | [SketchId](33130afb-7bc9-0229-0c54-b99a3edc21dd.htm) | Returns id of the sketch. |
| Public property | [SlabShapeEditor](efa9b741-145a-b1e1-a1ec-40abda11919d.htm) | Get the SlabShapeEditor used for slab shape editing. |
| Public property | [SpanDirectionAngle](d029779d-cc65-5ed5-5ff1-a7abab977dc6.htm) | Retrieve the span direction angle of the floor. |
