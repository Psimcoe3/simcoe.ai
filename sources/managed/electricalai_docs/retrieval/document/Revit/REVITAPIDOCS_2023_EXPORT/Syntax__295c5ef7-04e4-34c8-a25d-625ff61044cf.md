...
| C# |
| --- |
| ``` public static RevisionNumberingSequence CreateAlphanumericSequence( 	Document document, 	string name, 	AlphanumericRevisionSettings settings ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateAlphanumericSequence ( _ 	document As Document, _ 	name As String, _ 	settings As AlphanumericRevisionSettings _ ) As RevisionNumberingSequence ``` |
