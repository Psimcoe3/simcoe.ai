...
| C# |
| --- |
| ``` public void SetSuperscriptStatus( 	TextRange textRange, 	bool isSuperscript ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub SetSuperscriptStatus ( _ 	textRange As TextRange, _ 	isSuperscript As Boolean _ ) ``` |
