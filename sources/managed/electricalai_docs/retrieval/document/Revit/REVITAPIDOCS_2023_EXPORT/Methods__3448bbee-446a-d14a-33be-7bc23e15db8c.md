...
|  |
| --- |
| [CableTrayType Class](7ff5138f-5bd6-dbf4-3b57-7ee762bbd7af.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [CableTrayType](7ff5138f-5bd6-dbf4-3b57-7ee762bbd7af.htm)  type exposes the following members.
...
| Public method | [GetCompoundStructure](a1ec47e5-c552-944d-2152-74d7bd3f2a31.htm) | Returns an object that represents the compound structure of the element. (Inherited from  [HostObjAttributes](a3d349c5-d457-3b56-eec4-c2fa2757c860.htm)  .) |
...
| Public method | [IsValidBendMultiplier](e5a6d9f0-b8ee-bd35-312e-1c2061b4733f.htm) | Identifies if the input bend multiplier is valid. |
...
| Public method | [SetCompoundStructure](45f77d1a-c538-6fd2-7649-e461e66efbdd.htm) | Sets the compound structure of the element. (Inherited from  [HostObjAttributes](a3d349c5-d457-3b56-eec4-c2fa2757c860.htm)  .) |
...
| Public property | [BendMultiplier](219e7ed7-5c65-17ce-2afb-b56d54be95e4.htm) | Bend multiplier. |
...
| Public property | [Cross](33d098c2-e4bc-410d-75d9-83575e83a622.htm) | The default cross fitting of the MEP curve type. (Inherited from  [MEPCurveType](97c98bd6-0966-5b0c-6f75-4c34f16adce1.htm)  .) |
...
| Public property | [Elbow](3eec7500-a2e5-bd1f-2eac-5e2ea6953104.htm) | The default elbow fitting of the MEP curve type. (Inherited from  [MEPCurveType](97c98bd6-0966-5b0c-6f75-4c34f16adce1.htm)  .) |
...
| Public property | [IsWithFitting](e3a9e255-4622-c09d-af53-9b8f3af9cf26.htm) | Whether this cable tray type is with fitting |
...
| Public property | [MultiShapeTransition](43b3040f-1d0f-a8ee-5fac-bb5380562e45.htm) | The default multi shape transition fitting of the MEP curve type. (Inherited from  [MEPCurveType](97c98bd6-0966-5b0c-6f75-4c34f16adce1.htm)  .) |
...
| Public property | [PreferredJunctionType](26a24a77-3bea-a5be-3d49-4b8f1bf1a06e.htm) | The preferred junction type of the MEP curve type. (Inherited from  [MEPCurveType](97c98bd6-0966-5b0c-6f75-4c34f16adce1.htm)  .) |
| Public property | [Roughness](fc36ea5c-e146-394a-3bb4-e1f001623117.htm) | The roughness of the MEP curve type. For PipeTypes, please use Segment::Roughness (Inherited from  [MEPCurveType](97c98bd6-0966-5b0c-6f75-4c34f16adce1.htm)  .) |
| Public property | [RoutingPreferenceManager](9fd171c5-b908-07d0-6fdc-bbcdcfae35a4.htm) | The RoutingPreferenceManager for the MEPCurveType (Inherited from  [MEPCurveType](97c98bd6-0966-5b0c-6f75-4c34f16adce1.htm)  .) |
| Public property | [Shape](06152f02-9c8c-7f53-8e0b-a0d2adac505a.htm) | The shape of the profile. (Inherited from  [MEPCurveType](97c98bd6-0966-5b0c-6f75-4c34f16adce1.htm)  .) |
| Public property | [ShapeType](b12eb74f-7b7d-bc8e-3bb6-ca5366aec367.htm) | Shape of this cable tray type. |
| Public property | [Tap](2e1d5217-01f2-e1f7-ebab-d3c8d2afa8a6.htm) | The default tap fitting of the MEP curve type. (Inherited from  [MEPCurveType](97c98bd6-0966-5b0c-6f75-4c34f16adce1.htm)  .) |
| Public property | [Tee](bd5c961c-3e70-0727-e12c-6fef6a4c1ffa.htm) | The default tee fitting of the MEP curve type. (Inherited from  [MEPCurveType](97c98bd6-0966-5b0c-6f75-4c34f16adce1.htm)  .) |
| Public property | [Transition](33842660-06e1-ad7f-096f-01b722ad10c1.htm) | The default transition fitting of the MEP curve type. (Inherited from  [MEPCurveType](97c98bd6-0966-5b0c-6f75-4c34f16adce1.htm)  .) |
| Public property | [Union](e74b59ea-3367-c980-030a-831c1733c4e3.htm) | The default union fitting of the MEP curve type. (Inherited from  [MEPCurveType](97c98bd6-0966-5b0c-6f75-4c34f16adce1.htm)  .) |
