...
| C# |
| --- |
| ``` public bool IsAcceptableParamIdAndCategoryId( 	ElementId paramId, 	ElementId categoryId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function IsAcceptableParamIdAndCategoryId ( _ 	paramId As ElementId, _ 	categoryId As ElementId _ ) As Boolean ``` |
