...
|  |
| --- |
| [PanelScheduleTemplate Class](cf7e5cbb-7df4-ae55-8178-f449827b5752.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [PanelScheduleTemplate](cf7e5cbb-7df4-ae55-8178-f449827b5752.htm)  type exposes the following members.
...
| Public method | [CopyFrom](9d71d5fd-d9bb-dd85-d58d-709e089e9d2b.htm) | Copies all values from other element to this object. |
| Public method Static member | [Create](e8890707-6930-e739-1f09-8690885410de.htm) | Creates a new instance of a panel schedule template. |
...
| Public method | [GetPanelScheduleType](8a9ee9e3-1d73-d65a-517a-014f43ba1b22.htm) | Returns the panel schedule type. |
...
| Public method | [GetSectionData](232a1d1e-9112-362c-7539-4ce3b68689b9.htm) | Gets the writable section data object. |
...
| Public method | [GetTableData](0e1fec60-7429-5eba-b2a4-25ac0439e3c5.htm) | Gets the writable table data object. |
...
| Public method | [HasSameType](03c9e112-1fb3-5e42-1114-e99555cd1bfd.htm) | Checks if given template has the same panel schedule type with this template. |
...
| Public method Static member | [IsValidPanelConfiguration](d665ea95-a150-8f0b-43bf-6894bb9c0f5d.htm) | Checks if given panel configuration is valid for given panel schedule type. |
...
| Public method | [SetTableData](130f4d8a-fdbf-f00c-7f6f-6638fe37c48b.htm) | Assigns table data to this template |
...
| Public property | [IsBranchPanelSchedule](6c9ef6ab-a248-040f-f717-a0a8fc9b74f2.htm) | Checks to see if this object is branch panel schedule template element. |
| Public property | [IsDataPanelSchedule](065e52f3-c115-160a-c681-51e5a78e956b.htm) | Checks to see if this object is data panel schedule template element. |
| Public property | [IsDefault](06c3a815-be62-eb35-d3cd-cda4e948adbf.htm) | Checks to see if this is default template for the given panel schedule type. |
...
| Public property | [IsSwitchboardSchedule](30f565e3-fb0a-9738-ce07-cf07d679b032.htm) | Checks to see if this object is switchboard schedule template element. |
