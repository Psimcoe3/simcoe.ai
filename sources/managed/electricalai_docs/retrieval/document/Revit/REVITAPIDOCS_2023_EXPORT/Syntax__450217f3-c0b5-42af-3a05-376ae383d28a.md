...
| Visual Basic |
| --- |
| ``` Public Function CreateOffset ( _ 	offsetDist As Double, _ 	referenceVector As XYZ _ ) As Curve ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.htm) | Cannot create the offset of the curve. |
