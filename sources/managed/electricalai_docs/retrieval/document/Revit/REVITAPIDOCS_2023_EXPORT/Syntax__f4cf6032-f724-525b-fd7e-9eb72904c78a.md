...
| C# |
| --- |
| ``` public void SetAttribute( 	string name, 	ISet<double> values ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub SetAttribute ( _ 	name As String, _ 	values As ISet(Of Double) _ ) ``` |
...
values
:   Type:  [System.Collections.Generic ISet](http://msdn2.microsoft.com/en-us/library/dd412081)   [Double](http://msdn2.microsoft.com/en-us/library/643eft0t)
