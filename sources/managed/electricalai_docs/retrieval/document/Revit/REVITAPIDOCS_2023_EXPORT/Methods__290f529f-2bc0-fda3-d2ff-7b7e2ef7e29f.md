...
|  |
| --- |
| [FilledRegion Class](3685651c-a789-3550-f6bb-7c1decc29079.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [FilledRegion](3685651c-a789-3550-f6bb-7c1decc29079.htm)  type exposes the following members.
...
| Public method Static member | [Create(Document, ElementId, ElementId, IList CurveLoop )](ca304caa-7f95-4638-67d9-a138be609b9f.htm) | Creates a view-specific filled region from the given boundaries. |
| Public method Static member | [Create(Document, ElementId, SketchPlane, IList CurveLoop )](2b534d9c-666e-b8a8-0af0-931029f72e9f.htm) | Creates a filled region on a sketch plane in a 3d model family. |
...
| Public method | [GetBoundaries](5309fd5b-4a99-2d1d-665c-6153a8607012.htm) | Gets the boundaries. |
...
| Public method Static member | [GetValidLineStyleIdsForFilledRegion](d85532a7-8165-1701-90ac-cf665b47b58a.htm) | Gets the line style Ids which are permitted to be assigned to a filled region. |
...
| Public method Static member | [IsValidFilledRegionTypeId](5abb7cd1-e4c1-7565-e591-a9d79ccb46c0.htm) | Indicates whether the given Id is a valid filled region type Id. |
| Public method Static member | [IsValidLineStyleIdForFilledRegion](81b206f9-39bb-ecaf-36e3-3a4c31718972.htm) | Indicates whether the given Id is a valid line style Id. |
...
| Public method | [SetLineStyleId](799a16c2-dba1-f9bf-1d5c-4215d238bee1.htm) | Sets the line style Id for all boundaries. |
...
| Public property | [IsMasking](2f06036b-8970-0638-470d-379ebd30b46e.htm) | Indicates whether this element is a 'Filled Region or a 'Masking Region'. |
