...
| C# |
| --- |
| ``` public static FilterRule CreateEndsWithRule( 	ElementId parameter, 	string value ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateEndsWithRule ( _ 	parameter As ElementId, _ 	value As String _ ) As FilterRule ``` |
