...
|  |
| --- |
| [ParameterFilterElement Class](b231dc85-516a-5e75-c634-c6cd81b43fc5.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [ParameterFilterElement](b231dc85-516a-5e75-c634-c6cd81b43fc5.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AllRuleParametersApplicable(ElementFilter)](31407a8e-893f-4b89-bc25-1346ef387db4.htm) | Checks that the parameters of the rules used by the given ElementFilter are valid for this filter's categories. |
| Public method Static member | [AllRuleParametersApplicable(Document, ICollection ElementId , ElementFilter)](93e1ec59-4604-19cc-a010-246b918ddd8a.htm) | Checks that the parameters of the given ElementFilter (representing a combination of rules) are valid for the given set of categories. |
...
| Public method | [ClearRules](c6ad088a-38c2-8d3f-947a-83fe0dff11eb.htm) | Removes all rules from this filter. |
...
| Public method | [ElementFilterIsAcceptableForParameterFilterElement(ElementFilter)](b04518c6-7501-b41e-e1a0-56970f23f64e.htm) | Checks that an ElementFilter is acceptable for use in defining the filtering rules for a ParameterFilterElement (i.e., for view filtering). |
| Public method Static member | [ElementFilterIsAcceptableForParameterFilterElement(Document, ISet ElementId , ElementFilter)](7439c67a-bd5b-d15f-28cc-b9cffe8ec8e8.htm) | Checks that an ElementFilter is acceptable for use in defining the filtering rules for a given list of categories (i.e., for view filtering). |
| Public method | Equals | Determines whether the specified  Object  is equal to the current  Object  . (Inherited from  Object  .) |
| Public method | [GetCategories](7e497437-277e-8e15-bdc5-9065d868f464.htm) | Gets the categories admitted by this filter. |
...
| Public method | [GetElementFilter](9b14bfc0-597d-36ab-77d6-d801c3053873.htm) | Returns an ElementFilter representing the combination of rules used by this filter. |
| Public method | [GetElementFilterParameters](132d12c4-20b4-0b81-7c06-e5ad6f3f903f.htm) | Retrieves a list of the parameters associated with each rule in the filter. |
| Public method | [GetElementFilterParametersForCategory](7b1992bb-a55f-f872-b35b-0a2db840bf68.htm) | Retrieves a list of the parameters associated with all rules in the filter that are combined (using logical AND) with a FilterCategoryRule corresponding to single %categoryId%. |
...
| Public method | [IsNameUnique(String)](018d3415-a9b7-0935-98cd-453022be6f59.htm) | Determines whether a potential filter element name is unique. (Inherited from  [FilterElement](909615cd-8abd-044a-cff2-f21fd95b8ee7.htm)  .) |
...
| Public method | [SetCategories](a124ea27-f102-fa18-aa6c-72038f89cc7a.htm) | Sets the categories admitted by this filter. |
| Public method | [SetElementFilter](42927817-dfe1-2787-b133-af3480ae0921.htm) | Sets the rules that must be satisfied for a given element to pass this filter. |
