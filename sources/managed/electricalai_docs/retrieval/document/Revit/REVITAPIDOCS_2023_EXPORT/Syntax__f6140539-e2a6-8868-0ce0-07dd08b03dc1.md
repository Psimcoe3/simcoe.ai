...
| C# |
| --- |
| ``` public static StructuralConnectionHandlerType Create( 	Document pADoc, 	string name, 	Guid guid, 	string familyName ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function Create ( _ 	pADoc As Document, _ 	name As String, _ 	guid As Guid, _ 	familyName As String _ ) As StructuralConnectionHandlerType ``` |
