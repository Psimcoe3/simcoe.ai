...
|  |
| --- |
| [LoadNature Class](0c83b295-7a01-105b-2ae7-29e6c37be32d.htm)   [Example](#exampleToggle)   [See Also](#seeAlsoToggle) |
...
| C# |
| --- |
| ``` public static LoadNature Create( 	Document document, 	string name ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function Create ( _ 	document As Document, _ 	name As String _ ) As LoadNature ``` |
...
The newly created load nature element if successful,    a null reference (  Nothing  in Visual Basic)  otherwise.
