...
|  |
| --- |
| [MultipleValuesIndicationSettings Class](f23f984b-7cbf-54be-b2b9-a7069adaa339.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [MultipleValuesIndicationSettings](f23f984b-7cbf-54be-b2b9-a7069adaa339.htm)  type exposes the following members.
...
| Public method Static member | [GetMultipleValuesIndicationSettings](9f006777-7f5e-4bac-a7c9-ce951c0184ac.htm) | Returns the MultipleValuesIndicationSettings element for a given document. |
...
| Public property | [Custom](5bae32ca-edb3-80b4-e809-50cb7e0e720d.htm) | If true,  [CustomValue](c1d337d1-c676-cdd5-0945-bb60c0b1d2ee.htm)  is used as multiple values indication, otherwise a hardcoded standard value. |
| Public property | [CustomValue](c1d337d1-c676-cdd5-0945-bb60c0b1d2ee.htm) | Value used as multiple values indication if  [Custom](5bae32ca-edb3-80b4-e809-50cb7e0e720d.htm)  is set to true. |
...
| Public property | [Value](c2d9f859-179c-ee21-4bed-4480d4112e06.htm) | Value to be used as multiple values indication in the document. If  [Custom](5bae32ca-edb3-80b4-e809-50cb7e0e720d.htm)  is true, returns  [CustomValue](c1d337d1-c676-cdd5-0945-bb60c0b1d2ee.htm)  , otherwise returns a hardcoded standard value. |
