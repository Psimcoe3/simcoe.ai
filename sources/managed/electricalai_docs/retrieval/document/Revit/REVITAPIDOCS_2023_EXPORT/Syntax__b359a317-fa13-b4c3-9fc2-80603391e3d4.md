...
| Visual Basic |
| --- |
| ``` Public Property AssignedKCoefficient As Double 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property double AssignedKCoefficient { 	double get (); 	void set (double value); } ``` |
...
| [Autodesk.Revit.Exceptions InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.htm) | Thrown on failure to get or set kCoefficient. |
