...
|  |
| --- |
| [FabricSheetType Class](892f0ce6-5548-d299-c976-9355ac4109ee.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method Static member | [CreateDefaultFabricSheetType](20f37de8-a912-d25c-e16e-aa89256e2e90.htm) | Creates a new FabricSheetType object with a default name. |
...
| Public method | [GetReinforcementRoundingManager](bcb66de9-4e74-6ddf-5a01-d2a009d25224.htm) | Returns an object for managing reinforcement rounding override settings. |
...
| Public method | [GetWireItem](2cceb1d7-9370-8e64-c2eb-80d8e4083e4b.htm) | Gets the Wire stored in the FabricSheetType at the associated index. |
...
| Public method | [IsCustom](27448574-3a94-df24-58d9-f12202caa8c6.htm) | Verifies if the type is Custom Fabric Sheet |
...
| Public method | [IsValidMajorLapSplice](6273ad31-b98a-0dd5-ac36-b7e96e23df00.htm) | Identifies if the input value is valid to be applied as the major lap splice value for this FabricSheetType. |
| Public method | [IsValidMinorLapSplice](9ceacf3d-8ffc-6f9b-ae5e-364efdd2d864.htm) | Identifies if the input value is valid to be applied as the minor lap splice value for this FabricSheetType. |
...
| Public method | [SetLayoutAsCustomPattern](1544f3ff-e03d-7f32-a1d5-9a51ce7e47e0.htm) | Sets the minor and major layout patterns as Custom, while specifying the needed parameters for this pattern. |
| Public method | [SetMajorLayoutAsActualSpacing](76f4ef42-0dc5-8c84-42dc-27d4898b9ec0.htm) | Sets the major layout pattern as ActualSpacing, while specifying the needed parameters for this pattern. |
| Public method | [SetMajorLayoutAsFixedNumber](67722d68-3d89-6572-a6cd-44924f628089.htm) | Sets the major layout pattern as FixedNumber, while specifying the needed parameters for this pattern. |
| Public method | [SetMajorLayoutAsMaximumSpacing](9d0a435c-4dec-544b-921c-c43b89010c38.htm) | Sets the major layout pattern as MaximumSpacing, while specifying the needed parameters for this pattern. |
| Public method | [SetMajorLayoutAsNumberWithSpacing](f90b996d-9897-2822-05df-01e3dd6e0031.htm) | Sets the major layout pattern as NumberWithSpacing, while specifying the needed parameters for this pattern. |
| Public method | [SetMinorLayoutAsActualSpacing](60b34d65-63f4-3e3f-ac8c-8011ce682184.htm) | Sets the minor layout pattern as ActualSpacing, while specifying the needed parameters for this pattern. |
| Public method | [SetMinorLayoutAsFixedNumber](43c7e4cf-b84e-793b-5b4b-2b4d52d384c8.htm) | Sets the major layout pattern as FixedNumber, while specifying the needed parameters for this pattern. |
| Public method | [SetMinorLayoutAsMaximumSpacing](f2923888-3c22-97fa-13bf-c5b9affb12fa.htm) | Sets the major layout pattern as MaximumSpacing, while specifying the needed parameters for this pattern. |
| Public method | [SetMinorLayoutAsNumberWithSpacing](26e9f566-af82-f06f-1a72-25e6eb19fc0b.htm) | Sets the major layout pattern as NumberWithSpacing, while specifying the needed parameters for this pattern. |
...
| Public property | [MajorDirectionWireType](bdf9641d-5810-e238-1dd4-42c127a9477e.htm) | The id of the FabricWireType to be used in the major direction. |
| Public property | [MajorEndOverhang](c4722125-f837-463b-fc16-e9e0ac29071c.htm) | The distance from the edge of the sheet to the last wire (measured in the major direction). |
| Public property | [MajorLapSpliceLength](059e1c99-2258-4f73-e7a1-91d010277028.htm) | The lap splice length in the major direction. |
| Public property | [MajorLayoutPattern](19be065b-cbae-e934-09bc-216cc240795c.htm) | The layout pattern in the major direction. |
| Public property | [MajorNumberOfWires](5857f4d9-e80b-d1bf-599f-8a506819fcfb.htm) | The number of wires used in the major direction (includes the first and last wires). |
| Public property | [MajorReinforcementArea](cbcc7e28-2405-e3c1-6f0b-1bfafb103509.htm) | The area of fabric divided by the spacing of the wire in the major direction. This method does not apply to custom fabric sheet |
| Public property | [MajorSpacing](4c9b24f5-1b3d-830f-16e5-5428000840d6.htm) | The spacing between the wires in the major direction (not including the overhangs). |
| Public property | [MajorStartOverhang](1be17f8f-a952-1b25-5938-508c9825271c.htm) | The distance from the edge of the sheet to the first wire (measured in the major direction). |
| Public property | [Material](7d91df23-bddb-9052-f05d-782a3bb4e618.htm) | The id of the material assigned to wires. |
| Public property | [MinorDirectionWireType](963f96c5-6e30-3dd7-1fa6-a31a6cee9856.htm) | The id of the FabricWireType to be used in the minor direction. |
| Public property | [MinorEndOverhang](6342323f-22d9-c461-ab28-6e90bbb2b1a7.htm) | The distance from the edge of the sheet to the last wire (measured in the minor direction). |
| Public property | [MinorLapSpliceLength](dfd6b271-06a8-4694-85b4-55dc6ad6cd49.htm) | The lap splice length in the minor direction. |
| Public property | [MinorLayoutPattern](3618f2ea-4b5b-ffb5-15c6-42e819160332.htm) | The layout pattern in the minor direction. |
| Public property | [MinorNumberOfWires](374f0b3a-3041-1aaf-f1c7-ddb3ffb44f76.htm) | The number of wires used in the minor direction (includes the 1st and last wires). |
| Public property | [MinorReinforcementArea](a38613fe-3ceb-a2f8-2690-8813d3bd1923.htm) | The area of fabric divided by the spacing of the wire in the minor direction. This method does not apply to custom fabric sheet |
| Public property | [MinorSpacing](1f6363a9-f8c9-b837-88f8-1c5eb13005b0.htm) | The spacing between the wires in the minor direction (not including the overhangs). |
| Public property | [MinorStartOverhang](ba4af9d7-7f67-3468-5d6d-d519d15bf320.htm) | The distance from the edge of the sheet to the first wire (measured in the minor direction). |
...
| Public property | [OverallLength](55a5614f-61c8-3808-1ffd-6d6b6faf14e4.htm) | The length of the wire sheet (including overhangs) in the major direction. |
| Public property | [OverallWidth](1202c1f6-df13-66a1-a097-8a0c30d5715e.htm) | The length of the wire sheet (including overhangs) in the minor direction. |
...
| Public property | [SheetMass](d300cae8-6398-d321-4fb9-dcac1973e038.htm) | The sheet mass. |
| Public property | [SheetMassUnit](b9a2806b-22ce-2def-00f9-78727ddc4ad0.htm) | The sheet mass per area unit. |
