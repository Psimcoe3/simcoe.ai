...
| C# |
| --- |
| ``` public static FilterRule CreateLessOrEqualRule( 	ElementId parameter, 	string value ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateLessOrEqualRule ( _ 	parameter As ElementId, _ 	value As String _ ) As FilterRule ``` |
