...
| C# |
| --- |
| ``` public LinkLoadResult LoadFrom( 	ExternalResourceReference resourceReference ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function LoadFrom ( _ 	resourceReference As ExternalResourceReference _ ) As LinkLoadResult ``` |
