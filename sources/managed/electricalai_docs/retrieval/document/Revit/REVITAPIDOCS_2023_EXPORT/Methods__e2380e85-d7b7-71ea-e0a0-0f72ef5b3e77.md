...
|  |
| --- |
| [ElectricalSystem Class](158b4be3-bbe5-11eb-cccc-788edd3a7590.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
|  | Name | Description |
| --- | --- | --- |
| Public method | [Add](f40dba23-b703-6a37-0e09-7dfcd2eb1955.htm) | Add elements into the system and connect them with the system using given connectors. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public method | [AddToCircuit](88440699-56ba-439b-48ec-6741b620df6f.htm) | Add a set of exist components to the Electrical System. |
...
| Public method Static member | [Create(Connector, ElectricalSystemType)](bf9ecfac-db2f-385e-251d-eec44e791d87.htm) | Creates a new MEP Electrical System element from an unused Connector. |
| Public method Static member | [Create(Document, IList ElementId , ElectricalSystemType)](66f12d78-a4ab-9b99-ef49-92c3a3e1835e.htm) | Creates a new MEP Electrical System element from a set of electrical components. |
...
| Public method | [DisconnectPanel](af36bfe7-48ac-c38f-dac2-5682228f8037.htm) | Disconnect the panel for the Electrical System. |
...
| Public method | [DivideSystem](1bb1e7d5-a9f6-0c2d-e413-064bd4aa2c02.htm) | Divide the phyisical networks in the system and create a new system for each network. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public method | Equals | Determines whether the specified  Object  is equal to the current  Object  . (Inherited from  Object  .) |
| Public method | [GetCircuitPath](0448a0ee-c9bf-f037-c1b7-d49ce03ffa71.htm) | Gets the list of the electrical system circuit path node position. |
| Public method | [GetCriticalPathSectionNumbers](b68ff5b9-e8cf-2565-2b50-03a8d2489ac3.htm) | Obtains a list of the critical path section numbers. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
...
| Public method | [GetPhysicalNetworksNumber](23ca7db4-fa65-1149-95d7-9f17b80e073a.htm) | Get the physical networks number in the system. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public method | [GetSectionByIndex](dd53cbe2-37e6-19a1-e627-74a2aacb3433.htm) | Get the section from the index. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public method | [GetSectionByNumber](11cc783a-32f8-b0e0-2da6-5ecc6b9e57a6.htm) | Get the Section from section number (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
...
| Public method | [IsCircuitPathValid](d92fa2ae-b129-af44-e166-b7a37516a72b.htm) | Checks whether the list of the electrical system circuit path node position is valid. |
...
| Public method | [IsSystemDividable](4764bc4f-7ca7-820e-2b06-ac1a25750971.htm) | Checks if the system is dividable. The system is dividable if there is more than one physical network in the system. Currently, only HVAC and piping systems support dividing. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
...
| Public method | [NewWires](e4aeb633-5e67-955f-dde6-6c5f36cd0edc.htm) | Create a bunch of wires for the electrical system. |
...
| Public method | [Remove(ConnectorSet)](59f27f95-ca35-d3e1-ccf4-5103133be3b1.htm) | Removes connectors from system. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public method | [Remove(ICollection ElementId )](712cb969-3aaf-d7f8-eece-ad121093784e.htm) | Remove elements from system. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public method | [RemoveFromCircuit](46a00712-3b2f-f84d-e061-d31a38ce8b78.htm) | remove a set of exist components from the Electrical System. |
| Public method | [SelectPanel](008dafa1-ca02-d3fb-6bb8-0b0ac7fadcbc.htm) | Set the panel for the Electrical System. |
| Public method | [SetCircuitPath](20a517d0-f464-42c7-aa7f-02ed6135ca93.htm) | Sets the electrical system circuit path by the list of node position. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [ApparentCurrent](76a31fda-45cb-2f7b-4296-6e174d0990d3.htm) | The ApparentCurrent value of the Electrical System. |
| Public property | [ApparentCurrentPhaseA](8fb622de-8c08-ed41-8e2f-1ac3edb1edb1.htm) | The ApparentCurrentPhaseA value of the Electrical System. |
| Public property | [ApparentCurrentPhaseB](861816a3-6960-1f88-0b27-629f621efd31.htm) | The ApparentCurrentPhaseB value of the Electrical System. |
| Public property | [ApparentCurrentPhaseC](f5054a72-4c1f-1a49-1bb4-2b0b739c99f4.htm) | The ApparentCurrentPhaseC value of the Electrical System. |
| Public property | [ApparentLoad](3b1056bf-44ce-9d34-0f48-aaa3a761772d.htm) | The ApparentLoad value of the Electrical System. |
| Public property | [ApparentLoadPhaseA](35b66d8e-eafe-f6ba-1d11-4bcac26c2ea8.htm) | The ApparentLoadPhaseA value of the Electrical System. |
| Public property | [ApparentLoadPhaseB](71151c73-36e8-70c8-c753-9502c5143e23.htm) | The ApparentLoadPhaseB value of the Electrical System. |
| Public property | [ApparentLoadPhaseC](6ad23c15-d9f4-f663-21ea-d9a2e6be6385.htm) | The ApparentLoadPhaseC value of the Electrical System. |
...
| Public property | [BalancedLoad](c4b32c2d-e025-d300-1776-6d98ed07c703.htm) | Reports whether the BalancedLoad is on or off. |
| Public property | [BaseEquipment](00d90c4f-1946-1069-7887-f12899846481.htm) | The base panel or equipment of the system. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public property | [BaseEquipmentConnector](ba498d21-cdd8-ef07-e906-410443befc47.htm) | The connector within base equipment which is used to connect with system. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
...
| Public property | [CircuitConnectionType](bb0dbea9-3739-23e5-70ca-150b6a44a029.htm) | The circuit connection type of the electrical system. |
| Public property | [CircuitNamingIndex](f7f947d4-1e02-1afa-5b69-74c9511ccf41.htm) | The Circuit Naming Index where the Electrical System is located in its panel. The Circuit Naming Index is used to retrieve the Circuit Naming Index of the Electrical System. |
| Public property | [CircuitNumber](6897007d-92e0-c187-7fcb-bf83ebec4d93.htm) | The CircuitNumber of the Electrical System. |
| Public property | [CircuitPathMode](78b13087-63d8-090e-92ab-024d06717903.htm) | The circuit path mode of the electrical system. |
| Public property | [CircuitType](370eb108-c9fd-be44-30ef-e0813854037f.htm) | The circuit type of the Electrical System. |
| Public property | [ConnectorManager](891c572c-e7de-8593-330d-5afc8aed9e63.htm) | Connector manager of the system. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
...
| Public property | [Elements](c1cb0808-3b81-87a5-b804-84a733686f2d.htm) | Terminal elements in the system. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public property | [Frame](162d8eee-6d8c-593f-ad56-1a93aea30540.htm) | The Frame value of the Electrical System. |
...
| Public property | [GroundConductorsNumber](eba2bd38-32b6-0554-92c7-20d1eff44fa3.htm) | The GroundConductors Number of the Electrical System. |
...
| Public property | [HasCustomCircuitPath](1c6a0476-2aa6-a3dc-b65a-0cdf27456e97.htm) | Checks whether the electrical system circuit path has been customized. If not, the property CircuitPathMode cannot be set as Custom explicitly. |
| Public property | [HasDesignParts](2eeb83d4-64d1-a6b7-9116-9b687037406a.htm) | Indicates if the system has one or more design parts. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public property | [HasFabricationParts](1d649db3-79da-5cf7-5224-1dd689240afa.htm) | Indicates if the system has one or more fabrication parts. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public property | [HasPathOffset](7359d833-b9e9-babd-3956-cdd772248303.htm) | Whether the circuit path has a valid offset. |
| Public property | [HasPlaceholders](e89c9b10-e8d5-5cda-5190-94ac03b704fe.htm) | Indicates if the system has one or more placeholders. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public property | [HotConductorsNumber](72dff106-1130-55db-bb3e-bd86143798e1.htm) | The HotConductors Number of the Electrical System. |
...
| Public property | [IsBasePanelFeedThroughLugsOccupied](445839cd-f54a-ddb7-438e-23e55f48ec5c.htm) | Checks if the feed through lugs of the base panel is already occupied. |
| Public property | [IsEmpty](3c5bb767-5e7a-0080-45e9-c16b161a0e10.htm) | Indicates if the system is empty or not. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
...
| Public property | [IsMultipleNetwork](dce222a6-f12a-5db6-8ebb-84ac1ecf57f0.htm) | Indicates if the system is well connected or not. The flag will enable the "Divide System" button. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
...
| Public property | [IsValid](700f2642-f813-1955-d3c3-8bb99ac1b125.htm) | Indicates if the system is valid or not. atom AtomValidateSystem default false (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
...
| Public property | [Length](02858191-a544-82e6-faeb-0b59fd5c7ee8.htm) | The Length value of the Electrical System. |
...
| Public property | [LoadClassificationAbbreviations](640fbb2d-d8bb-f94c-4bea-a586100e0e5f.htm) | The LoadClassification Abbreviations used in the Electrical System. |
| Public property | [LoadClassifications](0d16bad4-8d87-b3eb-761f-00851bd8c4ec.htm) | The LoadClassifications used in the Electrical System. |
| Public property | [LoadName](d61fc8cf-ba05-82b4-3b1a-f7879eed4844.htm) | The LoadName of the Electrical System. |
...
| Public property | [NeutralConductorsNumber](9f62c1f5-a9c9-16ee-e891-81171f131fc7.htm) | The NeutralConductors Number of the Electrical System. |
...
| Public property | [PanelName](e531a631-da7b-4ed6-cf28-7f1462800d0b.htm) | The Panel name of the Electrical System. |
...
| Public property | [PathOffset](33c33ae6-8d62-e419-d8f5-f9b6f670c7f7.htm) | The offset of the horizontal segments of the circuit path. |
| Public property | [PhaseLabel](2466b142-6fa4-5e68-65b3-b2e90ff92a9e.htm) | The circuit phase label used in the Electrical System. |
...
| Public property | [PolesNumber](14cb243d-47cf-dc12-d15d-78234f42e66a.htm) | The Poles Number of the Electrical System. |
| Public property | [PowerFactor](7405e1a0-4546-1c1c-0584-a34b4a65d162.htm) | The PowerFactor value of the Electrical System. |
| Public property | [PowerFactorState](7530c368-0ffd-c88d-0c05-ea0539800f0b.htm) | The PowerFactorState type of the Electrical System. |
| Public property | [PressureLossOfCriticalPath](d44592e9-ab39-2d59-5872-0c58885839dd.htm) | The total pressure loss of the sections in critical path. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public property | [Rating](d72e9aee-81c5-bebc-555d-fe126ea3ab04.htm) | The Rating value of the Electrical System. |
| Public property | [RunsNumber](617b93a9-f92f-017d-ffe8-bc21516c3330.htm) | The Runs Number of the Electrical System. |
| Public property | [SectionsCount](530f3786-cac3-01c6-8ba8-7bccab7d3d49.htm) | The number of sections. (Inherited from  [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.htm)  .) |
| Public property | [SlotIndex](9de0301f-805c-1f35-b47e-81139db608ce.htm) | The Slots where the Electrical System is located in its panel. |
| Public property | [StartSlot](d79c6b0c-b933-c376-4301-a720c1436528.htm) | The Start Slot where the Electrical System is located in its panel. |
| Public property | [SystemType](79b1cf49-81c6-43b5-391c-a3c29f84edd8.htm) | The Electrical System Type of the Electrical System. |
| Public property | [TrueCurrent](b2db22ea-1058-3288-2268-3063f6b5fe5e.htm) | The TrueCurrent value of the Electrical System. |
| Public property | [TrueCurrentPhaseA](ace20df8-ef31-4ff6-0909-0a2ac3210f5a.htm) | The TrueCurrentPhaseA value of the Electrical System. |
| Public property | [TrueCurrentPhaseB](ef56edb7-2545-4510-dfb9-732228292f49.htm) | The TrueCurrentPhaseB value of the Electrical System. |
| Public property | [TrueCurrentPhaseC](55a84d00-8cdf-803d-343c-25d327fd37d0.htm) | The TrueCurrentPhaseC value of the Electrical System. |
| Public property | [TrueLoad](60271c8b-4d64-f629-45cf-7d601651025f.htm) | The TrueLoad value of the Electrical System. |
| Public property | [TrueLoadPhaseA](546d8fdc-3b72-3299-504e-510b532ce0e9.htm) | The TrueLoadPhaseA value of the Electrical System. |
| Public property | [TrueLoadPhaseB](c5ea30df-4b4e-e9bf-aef4-524b8e95b383.htm) | The TrueLoadPhaseB value of the Electrical System. |
| Public property | [TrueLoadPhaseC](4ce9af8d-7da1-cc2d-b56c-526fb60c8e4c.htm) | The TrueLoadPhaseC value of the Electrical System. |
...
| Public property | [Voltage](f0c134b8-7a0f-ebf0-48d1-e6d1ca03aad4.htm) | The Voltage value of the Electrical System. |
| Public property | [VoltageDrop](2f7d179a-a6c3-375b-d184-cc796e918f5d.htm) | The VoltageDrop value of the Electrical System. |
| Public property | [Ways](d19637f9-60cf-e684-c968-3eb25f635bb9.htm) | The circuit ways used in the Electrical System. |
| Public property | [WireSizeString](51fad9c3-b6a4-a8b3-95b2-beafff72f994.htm) | The WireSize as a String of the Electrical System |
| Public property | [WireType](d605965d-bbed-c3c9-14fa-2d040ec76dca.htm) | The wire type of the Electrical System. |
