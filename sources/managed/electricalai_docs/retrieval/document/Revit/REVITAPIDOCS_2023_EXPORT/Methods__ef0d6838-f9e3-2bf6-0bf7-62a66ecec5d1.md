...
|  |
| --- |
| [KeyBasedTreeEntryTable Class](c5d3e9d9-0221-520b-6163-9843db20d5ea.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [KeyBasedTreeEntryTable](c5d3e9d9-0221-520b-6163-9843db20d5ea.htm)  type exposes the following members.
...
| Public method | [GetKeyBasedTreeEntries](f485fa08-b03d-f113-0140-077c78408884.htm) | Gets the KeyBasedTreeEntries for this table. |
...
| Public method | [LoadFrom](51da265d-a879-61dd-3b59-b919bf2645f4.htm) | Loads KeyBasedTreeEntries from the specified external resource into this KeyBasedTreeEntryTable. |
...
| Public method | [Reload](a91169d7-4f71-c027-3a24-1d90473e7071.htm) | Reloads KeyBasedTreeEntries from their currently-stored location into this KeyBasedTreeEntryTable. |
| Public method | [ServerSupports](e9a1009d-a56e-d3f6-7987-5b2de9104c93.htm) | Checks if the server referenced by the given ExternalResourceReference supports the ExternalResourceReferenceType of this KeyBasedTreeEntryTable. |
