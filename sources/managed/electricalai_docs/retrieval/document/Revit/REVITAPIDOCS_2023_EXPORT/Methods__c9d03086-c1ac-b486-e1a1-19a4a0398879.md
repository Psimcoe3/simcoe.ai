...
|  |
| --- |
| [RebarHookType Class](3c7a78d5-f92b-e58b-e7c9-7927537498fd.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [RebarHookType](3c7a78d5-f92b-e58b-e7c9-7927537498fd.htm)  type exposes the following members.
...
| Public method Static member | [Create](e113d22a-0e59-6642-e45d-2538a0d24bff.htm) | Creates a new RebarHookType in a document. |
| Public method Static member | [CreateDefaultRebarHookType](83699313-9138-9a03-2a9a-8f7373fcd535.htm) | Creates a new RebarHookType object with a default name. |
...
| Public method | [GetDefaultHookExtension](de092ae2-aed1-186b-a987-cf8e5a84cba6.htm) | Computes the default hook length, which is equal to barDiameter \* multiplier. |
...
| Public method | [GetHookExtensionLength](dac6ad67-c23a-c5f0-26ed-4590cbfbc275.htm) | Computes the hook extension length based on current hook length |
...
| Public method | [IsOffsetLengthRequired](4a11667a-73c9-a7a7-83a7-799cc45df5c2.htm) | Check whether hook offset length is required. remarks: If hook angle is no more than 90 degree, hook offset length is not meaningful. returns: True if hook offset length is required, otherwise false. |
...
| Public property | [HookAngle](85af7224-b751-4c40-a5d5-5b4dc757f742.htm) | The hook angle, measured in radians. Must be greater than 0 and no more than pi. |
...
| Public property | [StraightLineMultiplier](28ab6bf6-6aef-39d7-c9b7-98e16cdc02d2.htm) | Multiplier of bar diameter. Used to compute a default hook length. The default hook length can be overridden by the RebarBarType class. |
| Public property | [Style](3a223d55-0f7e-aa63-7314-e8ad1cd525c9.htm) | The hook may only be applied to shapes of the specified style. |
