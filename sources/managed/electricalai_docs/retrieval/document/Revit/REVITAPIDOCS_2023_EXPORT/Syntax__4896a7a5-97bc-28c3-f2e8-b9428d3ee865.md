...
| C# |
| --- |
| ``` public static FlexDuct Create( 	Document document, 	ElementId systemTypeId, 	ElementId ductTypeId, 	ElementId levelId, 	IList<XYZ> points ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function Create ( _ 	document As Document, _ 	systemTypeId As ElementId, _ 	ductTypeId As ElementId, _ 	levelId As ElementId, _ 	points As IList(Of XYZ) _ ) As FlexDuct ``` |
