...
|  |
| --- |
| [StructuralConnectionHandlerType Class](e948a909-1b00-8789-6302-b46015c9cb47.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [StructuralConnectionHandlerType](e948a909-1b00-8789-6302-b46015c9cb47.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method Static member | [AddElementsToCustomConnection](4ce5c475-c74a-c5aa-0724-8df7c1a0cacb.htm) | Modifies StructuralConnectionHandlerType of input StructuralConnectionHandler by adding representors of input elements or subelements. |
...
| Public method Static member | [Create(Document, String, Guid, String)](f6140539-e2a6-8868-0ce0-07dd08b03dc1.htm) | Creates a new StructuralConnectionHandlerType object. |
| Public method Static member | [Create(Document, String, Guid, String, ElementId)](6b32c057-7e8b-7bf8-8bcc-ac1e918c8b60.htm) | Creates a new StructuralConnectionHandlerType object. |
| Public method Static member | [Create(Document, String, Guid, String, ElementId, IList ConnectionInputPointInfo )](9a38d743-cee5-bee1-edf8-234be595ec37.htm) | Creates a new StructuralConnectionHandlerType object. |
| Public method Static member | [CreateDefaultStructuralConnectionHandlerType](3334270c-e2eb-855c-b8d6-4a7f0388ebe8.htm) | Creates a new StructuralConnectionHandlerType object with a default name. |
...
| Public method Static member | [FindGenericConnectionType](83298a62-78c9-8182-f742-a4aeff747bec.htm) | Finds StructuralConnectionHandlerType which is Generic Connection type. |
| Public method Static member | [GetDefaultConnectionHandlerType](f9b606a4-2656-dca7-8f8e-469630bd151e.htm) | Gets a default type id for Structural Connection. |
...
| Public method | [IsCustom](ecd5d004-964f-eb6a-c4b2-0916fd8e0b93.htm) | Checks if StructuralConnectionHandlerType is custom. |
...
| Public method | [IsDetailed](0a36101d-7ce2-c7b5-7e94-ae2b824d10c4.htm) | Checks if StructuralConnectionHandlerType is detailed. |
...
| Public method | [IsGeneric](697a72c2-a01f-4203-db5c-c3c95d44261e.htm) | Checks if StructuralConnectionHandlerType is generic. |
...
| Public method Static member | [IsTypeNameValidForCustomConnection](1b1a9194-d048-7d41-eb53-94b9201e2a9b.htm) | Validates if the input name matches the criteria of StructuralConnectionHandlerType name. Name must be unique among other existing StructuralConnectionHandlerTypes and cannot contain any of the following characters: new line, {}[];`~\\/:\*?";<>| or any of the non-printable characters. |
...
| Public method Static member | [RemoveMainSubelementsFromCustomConnection](09882898-b699-9b91-742b-ea6bd75942a1.htm) | Removes one or more subelements from a StructuralConnectionHandlerType. The subelements will be erased. |
...
| Public property | [ConnectionGuid](625f6a3a-b0af-0d21-1f20-0af3609049bd.htm) | The GUID to use for identifying connection geometry generation algorithm. |
