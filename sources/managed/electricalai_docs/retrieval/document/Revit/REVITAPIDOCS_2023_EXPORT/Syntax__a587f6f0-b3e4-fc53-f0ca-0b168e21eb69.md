...
| Visual Basic |
| --- |
| ``` Public Property BuildingHVACSystem As gbXMLBuildingHVACSystem 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property gbXMLBuildingHVACSystem BuildingHVACSystem { 	gbXMLBuildingHVACSystem get (); 	void set (gbXMLBuildingHVACSystem value); } ``` |

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | When setting this property: The building HVAC system does not fall within an appropriate range. |
