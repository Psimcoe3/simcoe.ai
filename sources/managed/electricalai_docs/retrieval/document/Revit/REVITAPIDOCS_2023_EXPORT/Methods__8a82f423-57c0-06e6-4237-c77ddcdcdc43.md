...
|  |
| --- |
| [DividedSurface Class](782e1ac7-4e74-9a32-6b03-0a20f7d55217.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
|  | Name | Description |
| --- | --- | --- |
| Public method | [AddIntersectionElement](ac41d76c-ea3f-bb52-f9bb-c2cd064a25f8.htm) | Adds an intersection element to the divided surface. |
...
| Public method Static member | [CanBeDivided](14e87b16-51cf-52e8-87f0-06b47f80c1de.htm) | This returns true if the reference represents a face that can be used to create a divided surface. |
...
| Public method | [CanBeIntersectionElement](208f7d38-eea3-5676-1eb6-d5ccaee8eda7.htm) | Checks if the element can be an intersection reference. |
...
| Public method Static member | [Create](b90ea001-cbb4-0fdf-89a0-1635255bdfd2.htm) | Creates a new instance of a divided surface with a default layout. |
...
| Public method | [GetAllIntersectionElements](d2debd59-e78a-e355-a89f-eee8de6f874b.htm) | Gets all intersection elements which produce division lines. |
...
| Public method Static member | [GetDividedSurfaceForReference](718252c3-faac-2f25-ec76-ca2a027c663a.htm) | Get a divided surface for a given reference. Returns null if the reference does not host a divided surface. |
...
| Public method | [GetGridNodeLocation](688f7190-8b0f-e7f0-f9a6-2dc9298efc2a.htm) | Specify whether a particular grid node is interior to the surface, on the boundary, or outside the boundary. |
| Public method | [GetGridNodeReference](62738bc9-7201-894a-20bc-954e106b2061.htm) | Get a reference to the geometric point associated with a grid node. |
| Public method | [GetGridNodeUV](30c8cf73-bcc3-5241-b48f-ab5c7be834e8.htm) | Get the position of a grid node in UV coordinates in the surface. |
| Public method | [GetGridSegmentReference](ac22065a-c06b-a610-8274-b7e9f6e6dacd.htm) | Get a reference to a line segment connecting two adjacent grid nodes. |
...
| Public method Static member | [GetReferencesWithDividedSurfaces](4714c725-4863-5e56-e23f-49e207942e02.htm) | For a given host element get references to all the faces that host a divided surface |
...
| Public method | [GetTileFamilyInstance](173b76c6-254c-a9a3-83de-b7384e1ecae7.htm) | Get a reference to a tile element associated with a given seed node. |
| Public method | [GetTileReference](2ef73679-a240-0240-90c5-d08d2593de73.htm) | Get a reference to one of the tile surfaces associated with a given seed node. |
...
| Public method | [IsSeedNode](861a3148-b87c-315d-cde4-402428d5d470.htm) | Reports whether a grid node is a "seed node," a node that is associated with one or more tiles. |
...
| Public method | [RemoveAllIntersectionElements](90969247-211f-92f5-1973-5202e9b2287f.htm) | Removes all the intersection elements from a divided surface. |
| Public method | [RemoveIntersectionElement](c5098b67-9c5c-58f2-bfea-24174072e816.htm) | Removes an intersection element from a divided surface. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AllGridRotation](7e0b73cf-13dc-658f-e597-442c0efe6ae9.htm) | Angle of rotation applied to the U- and V- directions together. |
...
| Public property | [BorderTile](906ce695-322f-9ae6-ad7c-26586af86005.htm) | Determines the handling of tiles that overlap the surface's boundary. |
...
| Public property | [ComponentRotation](78cdcbbd-b322-c6e7-1465-29f7cc300fce.htm) | The rotation of the pattern by a multiple of 90 degrees. |
...
| Public property | [Host](cf5cae80-7977-ad86-0381-3a56ee3c2b6c.htm) | The element whose surface has been divided. |
| Public property | [HostReference](c90a0505-ae70-eac4-94a4-d72289a90e62.htm) | A reference to the divided face on the host. |
...
| Public property | [IsComponentFlipped](82f331a5-8933-d7f7-8be7-e8dbad1236c5.htm) | Whether the pattern is flipped. |
| Public property | [IsComponentMirrored](e4095192-0151-0abf-7ff3-522dc249d306.htm) | Whether the pattern is mirror-imaged. |
...
| Public property | [NumberOfUGridlines](3c74565b-6322-14ed-26b0-c6fc85f6d2e8.htm) | Get the number of U-gridlines used on the surface. |
| Public property | [NumberOfVGridlines](a5fff574-f64f-746e-8f1f-c1de57ff9699.htm) | Get the number of V-gridlines used on the surface. |
...
| Public property | [UPatternIndent](6ac8981f-2a39-db05-7cf8-0fb3ecd898f1.htm) | The offset applied to the pattern by an integral number of grid nodes in the U-direction. |
| Public property | [USpacingRule](bcb80bc9-33d9-2718-3080-500a9d8119de.htm) | Access to the rule for laying out the first series of equidistant parallel lines on the surface. |
...
| Public property | [VPatternIndent](2e1c2b7b-2a2f-c7f2-ad66-15d72739e8ac.htm) | The offset applied to the pattern by an integral number of grid nodes in the V-direction. |
| Public property | [VSpacingRule](b5dabf3b-96ff-26e5-0d91-314391ceddb2.htm) | Access to the rule for laying out the second series of equidistant parallel lines on the surface. |
