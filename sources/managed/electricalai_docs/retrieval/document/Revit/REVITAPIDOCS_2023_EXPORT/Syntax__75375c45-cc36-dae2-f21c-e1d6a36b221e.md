...
Inserts multiple  [IndexPoint](cd53f076-2011-ce3a-f92e-3b384f21b8ec.htm)  instances into the stream and associated buffer.
...
| C# |
| --- |
| ``` public void AddPoints( 	IList<IndexPoint> points ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub AddPoints ( _ 	points As IList(Of IndexPoint) _ ) ``` |
...
points
:   Type:  System.Collections.Generic IList   [IndexPoint](cd53f076-2011-ce3a-f92e-3b384f21b8ec.htm)    
