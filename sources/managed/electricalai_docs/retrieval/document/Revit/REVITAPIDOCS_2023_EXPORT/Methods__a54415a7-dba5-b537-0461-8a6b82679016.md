...
|  |
| --- |
| [PipingSystemType Class](b0fe0b71-3b6c-85f0-8279-e93505e82529.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method Static member | [Create](046cbcbc-bf76-4a77-672b-0da66b906963.htm) | Creates a new instance of a piping system type and adds it to the document. |
...
| Public method | [ValidateRiseDropSymbolType](43506db8-5f55-8f67-780e-44ce3dda5cb4.htm) | Confirms if the parameter is a valid piping rise/drop symbol type. |

# Properties

|  | Name | Description |
| --- | --- | --- |
| Public property | [Abbreviation](6f21688c-b2b7-ad78-70a1-3f1de36eab18.htm) | Identifies the abbreviation, the short name, for the system type (Inherited from  [MEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.htm)  .) |
...
| Public property | [CalculationLevel](76631989-d84f-3954-8743-f42b58ba4f43.htm) | Identifies the calculation level for the system type. (Inherited from  [MEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.htm)  .) |
...
| Public property | [FillColor](1b4309e7-bdf4-807a-a13a-6dcef6a94b50.htm) | Indicates the color that should override the fill color for all components in the system. (Inherited from  [MEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.htm)  .) |
| Public property | [FillPatternId](cc5413da-3984-5580-8303-70d790118cf3.htm) | Indicates the fill pattern id that should override the fill pattern id for all components in the system. (Inherited from  [MEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.htm)  .) |
| Public property | [FillVisible](a16ccaf8-461b-226f-c40a-4956c69b36f8.htm) | Indicates the visibility of the fill pattern for all components in the system. (Inherited from  [MEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.htm)  .) |
| Public property | [FlowConversionMethod](f2319058-ef8c-c50f-5093-1b1196536f09.htm) | The flow conversion method for the piping system type. |
| Public property | [FluidTemperature](e84eb32b-5a1e-acf3-e765-d484d2d6eee4.htm) | Fluid Temperature |
| Public property | [FluidType](c1c50fad-9320-831c-2675-4ab23f720837.htm) | Fluid Type |
...
| Public property | [LineColor](83e01a4d-d51e-42bf-fe18-7c5856fe5c6e.htm) | Indicates the color that should override the line color for all components in the system. (Inherited from  [MEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.htm)  .) |
| Public property | [LinePatternId](99830c67-ba7a-e28b-0d65-18b57c7f93af.htm) | Indicates the line pattern id that should override the line pattern id for all components in the system. (Inherited from  [MEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.htm)  .) |
| Public property | [LineWeight](605a0923-f8f1-7e76-d836-cd4cf427a5e2.htm) | Indicates the weight that should override the line weight for all components in the system. (Inherited from  [MEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.htm)  .) |
...
| Public property | [MaterialId](8da78a66-2b7d-2231-a112-64cf1cee6c19.htm) | Indicates the material id that should override the material for all components in the system. (Inherited from  [MEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.htm)  .) |
...
| Public property | [SingleLineBendDropType](e4f273a6-1f49-8091-43ba-50efda74edc3.htm) | Symbol for a 1 line drop |
| Public property | [SingleLineBendRiseType](778e51c2-f5a1-eb8b-02c3-8e3549913074.htm) | Symbol for a 1 line rise |
| Public property | [SingleLineJunctionDropType](2aba94f0-3f47-a7d5-b744-40e6dc1325af.htm) | Symbol for a 1 line junction drop |
| Public property | [SingleLineJunctionRiseType](df66c73c-b8f7-92ca-159a-f0debab34235.htm) | Symbol for a 1 line junction rise |
| Public property | [SystemClassification](be329290-0ca0-b6a6-85f8-d9e35be028f1.htm) | Identifies the classification for the system type (Inherited from  [MEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.htm)  .) |
| Public property | [TwoLineDropType](c0cba738-7ef5-d6fe-589a-7006d899b9f5.htm) | Symbol for a 2 line drop |
| Public property | [TwoLineRiseType](4e75bd97-69d1-a7a9-a18d-216d768c4635.htm) | Symbol for a 2 line rise |
