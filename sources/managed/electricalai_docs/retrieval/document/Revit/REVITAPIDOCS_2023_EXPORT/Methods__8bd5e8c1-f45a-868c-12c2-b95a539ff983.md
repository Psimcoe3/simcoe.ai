...
|  |
| --- |
| [LinearArray Class](58e47064-607e-d52b-5930-7e371851a678.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [LinearArray](58e47064-607e-d52b-5930-7e371851a678.htm)  type exposes the following members.
...
| Public method Static member | [ArrayElementsWithoutAssociation](5c97b79a-6d6b-5f74-fa3f-c35fbc96d01c.htm) | Creates a new linear array from a set of elements. |
| Public method Static member | [ArrayElementWithoutAssociation](260ee73e-2196-79a3-19ac-f942aafc44f4.htm) | Creates a new linear array from a single element. |
...
| Public method Static member | [Create(Document, View, ElementId, Int32, XYZ, ArrayAnchorMember)](33520964-cb76-56b5-a303-bd2bad01adfe.htm) | Creates a new linear array element from a single element. |
| Public method Static member | [Create(Document, View, ICollection ElementId , Int32, XYZ, ArrayAnchorMember)](77e8c92f-6b48-0f3d-923c-2737a6d6e4ab.htm) | Creates a new linear array element from a set of elements. |
...
| Public method | [GetCopiedMemberIds](1d424df0-983c-4ebd-b749-6bec157e30b5.htm) | Retrieves the copied member Ids of the Array. (Overrides  [BaseArray GetCopiedMemberIds](ce0d8197-a99f-0ef2-32a8-51d4cc2aa101.htm)  .) |
...
| Public method | [GetOriginalMemberIds](99315d93-cf2a-8619-49de-0864a5b742cc.htm) | Retrieves the original member Ids of the Array. (Overrides  [BaseArray GetOriginalMemberIds](8c15fb58-a534-abd4-0715-841ea1c1447f.htm)  .) |
...
| Public method Static member | [IsElementArrayable](c7a9d13d-f660-659d-732b-13718d298e8a.htm) | Indicates whether the input element is arrayable. |
...
| Public method Static member | [IsValidArraySize](ed3cd48f-714f-b183-40e9-904672a47aa6.htm) | This indicates whether the input count is valid. |
...
| Public property | [NumMembers](f2ed4299-f623-dc05-6e95-f3bfd234d9ae.htm) | Retrieves or changes the number of the arrayed members. (Overrides  [BaseArray NumMembers](66183f2d-7dee-631d-3dcb-0d484d134c91.htm)  .) |
