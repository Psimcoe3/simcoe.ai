...
| C# |
| --- |
| ``` public IList<FailureMessage> ExecuteRules( 	Document document, 	IList<int> rules ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function ExecuteRules ( _ 	document As Document, _ 	rules As IList(Of Integer) _ ) As IList(Of FailureMessage) ``` |
