...
| C# |
| --- |
| ``` public static Surface Create( 	Frame frameOfReference, 	Curve profileCurve, 	double startAngle, 	double endAngle ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function Create ( _ 	frameOfReference As Frame, _ 	profileCurve As Curve, _ 	startAngle As Double, _ 	endAngle As Double _ ) As Surface ``` |
