...
|  |
| --- |
| [FabricSheet Class](1f420619-ab30-942a-e5b6-028b7ff3889f.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [FabricSheet](1f420619-ab30-942a-e5b6-028b7ff3889f.htm)  type exposes the following members.
...
| Public method Static member | [Create(Document, Element, ElementId)](e04241db-159d-3b49-7c87-80aaa5b84afa.htm) | Creates a new instance of a single flat Fabric Sheet element within the project. |
| Public method Static member | [Create(Document, ElementId, ElementId, CurveLoop)](f666c551-91fd-12b8-1a1a-eb91acefb25c.htm) | Creates a new instance of a single bent Fabric Sheet element within the project. |
...
| Public method | [GetBendProfile](537ba6c2-26dd-3ce5-e359-5613eec5ef9b.htm) | Returns the profile (not including generated fillets) that defines the shape of the Fabric Sheet bending. |
| Public method | [GetBendProfileWithFillets](aaae8dee-8b2e-0c57-fa52-adbfb0390581.htm) | Returns the profile with generated fillets that defines the shape of the Fabric Sheet bending. |
...
| Public method | [GetReinforcementRoundingManager](6dc752d4-a675-2f4f-03fd-42a58620dae3.htm) | Returns an object for managing reinforcement rounding override settings. |
| Public method | [GetSegmentParameterIdsAndLengths](1542c812-735a-0483-e5b5-7f02bc16b2f9.htm) | Returns the array of pairs [parameter ID, length] that correspond to segments of a bent fabric sheet (like A, B, C, D etc.). |
| Public method | [GetSheetLocation](71a5aa6f-f57d-001d-bb8a-a5f8e7c27bfe.htm) | Gets the position and the orientation of the Fabric Sheet instance. |
...
| Public method | [IsCoverOffsetValid](55e266df-8cb2-0f2c-4fab-492089461196.htm) | Identifies if the specified value is valid for use as a cover offset. |
...
| Public method | [IsSingleFabricSheetWithinHost](d0e85e9c-31f1-6ee4-c98b-8c124cc33d9c.htm) | Identifies if the specified single Fabric Sheet position is within the host. |
| Public method | [IsSolidInView](65cce5b7-21db-94f0-f21b-cc7c41978576.htm) | **Obsolete.**   Checks if this fabric sheet is shown solidly in a 3D view. |
| Public method | [IsUnobscuredInView](20c69421-426e-2f52-d8e2-0a808c12a036.htm) | Checks if this fabric sheet is shown unobscured in a view. |
...
| Public method | [PlaceInHost](f1eb07fb-91a6-6ca9-f763-44f29e34014d.htm) | Inserts the single Fabric Sheet instance into the host element. |
...
| Public method | [SetBendProfile](086c6100-798a-6998-f8e0-fac6d856e6be.htm) | Sets new profile that defines the shape of the Fabric Sheet bending. |
...
| Public method | [SetSegmentLength](0c2d43a6-7e9f-115a-65a2-56e370747aa5.htm) | Sets the value of the bent fabric sheet segment(like A, B, C, D etc.) |
| Public method | [SetSolidInView](9c9c9f0f-a139-7623-26e2-23aca32eb04e.htm) | **Obsolete.**   Sets this fabric sheet to be shown solidly in a 3D view. |
| Public method | [SetUnobscuredInView](6df4a862-4a9b-1844-28d6-76076b8a8cdf.htm) | Sets this fabric sheet to be shown unobscured in a view. |
...
| Public property | [BendFinalLoopOrientationVector](d2c9263f-1d3d-fae8-6fe7-b4d419faf7e6.htm) | Direction of local Fabric Sheet Y axis in bending polyline LCS. |
| Public property | [BentFabricBendDirection](0a69fdd3-8c45-d097-19c2-fb07a6a8f5cf.htm) | Specifies which wire direction of the fabric sheet is bent. |
| Public property | [BentFabricLongitudinalCutLength](2cd7d6f0-b9ce-43cb-2183-1b15a2d95099.htm) | Specifies the cut length of the fabric sheet perpendicular to the bend edge. |
| Public property | [BentFabricStraightWiresLocation](beb33ed1-b28b-2e4c-2ea3-51ec4bc4f79a.htm) | Specifies the location of straight bars with respect to bent bars in the fabric sheet. |
...
| Public property | [CoverOffset](89e824ff-5721-78bf-ba75-9774852fa7e0.htm) | The additional cover offset of the Fabric Sheet. |
...
| Public property | [CutOverallLength](22fbceb2-729d-6f32-643c-68986ee4fe8d.htm) | The sheet length after cutting has taken place. |
| Public property | [CutOverallWidth](95dcc8d5-1715-15f2-d3b7-dc11a6ccac58.htm) | The sheet length after cutting has taken place. |
| Public property | [CutSheetMass](31122be4-75b6-ed8d-6067-dc17a47cbf77.htm) | The sheet mass after cutting has taken place. |
...
| Public property | [FabricAreaOwnerId](927f2625-193d-208a-9bb4-4cc3234a6bfe.htm) | The Fabric Area Id. |
| Public property | [FabricHostReference](e7b4d579-4362-b7b4-3aeb-4edd50c366e2.htm) | Controls if Single Fabric Sheet should be cut by the Host Cover |
| Public property | [FabricLocation](2d0de815-de85-6ca8-13f0-26dcecb5ac85.htm) | The Fabric Sheet location in the host. |
| Public property | [FabricNumber](df1c73ae-b662-98c4-5760-9ad74d60970e.htm) | Specifies the numerical parameter assigned to the fabric sheet and any sheet of the same type, dimension, material, shape, and partition. |
...
| Public property | [HostId](f1c5db9c-4dfa-6f9e-3248-056b1460442a.htm) | The structure element that contains the Fabric Sheet. |
...
| Public property | [IsBent](db25bd29-f58e-a58d-7acf-f0a2f9832832.htm) | The type of fabric sheet. True for bent fabric sheet, false for flat fabric sheet. |
...
| Public property | [SketchId](9ad2ae97-2292-14f2-4d66-085ca70ec371.htm) | The id of the Sketch element for this element. |
