...
|  |
| --- |
| [TextElement Class](013e58c3-f3d2-d976-89f0-ff4ff701951d.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method | [GetMinimumAllowedWidth](d074bc27-1e5a-7be1-359b-83592dad59dd.htm) | Returns the minimum width the text element can be assigned. |
| Public method Static member | [GetMinimumAllowedWidth(Document, ElementId)](25772d7a-57ad-7638-3b6f-3426d4c64237.htm) | Returns the minimum width a text element can be created with. |
...
| Public property | [BaseDirection](19eff725-f901-442d-4945-5b16002c9e07.htm) | Direction of the base line of the text element. |
...
| Public property | [Coord](c76a355a-5356-33f4-eeeb-ae73fc463189.htm) | Position of the text (in model coordinates.) |
...
| Public property | [Height](824eac10-294a-bc52-22ea-24fa7a90be31.htm) | Height of the area of the text content. |
| Public property | [HorizontalAlignment](13fde654-9ee9-8852-bbc0-708e19bc0fb5.htm) | Horizontal alignment of the text content within the text area of the element. |
...
| Public property | [KeepRotatedTextReadable](c139cc83-2903-74f5-ca1b-9f74bdb0cc45.htm) | A flag to control how text behaves inside a rotated text element. |
...
| Public property | [Symbol](6e9bdd6f-14ef-94c6-cd94-ad735d18885f.htm) | Get the type of the TextElement object. |
| Public property | [Text](1d4b2991-02ba-07d7-0c25-14f2f62f72a6.htm) | The content of the element as a plain string stripped of all formating. |
...
| Public property | [UpDirection](76e43206-5f28-5e64-e087-46c575327956.htm) | Direction along the vertical axis of letters of the text note. |
...
| Public property | [VerticalAlignment](9e494181-05e2-3565-5438-971936f08949.htm) | Vertical alignment of the text. |
...
| Public property | [Width](ce0e3089-231a-31ac-ee52-ad912b9ea331.htm) | Width of the area of the text content. |
