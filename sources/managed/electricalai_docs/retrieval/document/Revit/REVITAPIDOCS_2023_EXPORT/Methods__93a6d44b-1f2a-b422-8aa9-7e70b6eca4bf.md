...
|  |
| --- |
| [BeamSystem Class](6c5c1bd2-8456-5ec9-c53e-0bd3f604ad06.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [BeamSystem](6c5c1bd2-8456-5ec9-c53e-0bd3f604ad06.htm)  type exposes the following members.
...
| Public method Static member | [BeamBelongsTo](66187e95-4034-01aa-afc4-5488de3b5414.htm) | Find out the BeamSystem to which the beam belongs. |
...
| Public method Static member | [Create(Document, IList Curve , SketchPlane, Int32)](320f188f-5b0e-e34f-0dc1-c652029be9ae.htm) | Creates a 2D BeamSystem with specified profile curves. |
| Public method Static member | [Create(Document, IList Curve , Level, XYZ, Boolean)](03e84698-d122-594b-b436-4932f9ff49c6.htm) | Creates a new BeamSystem with specified profile curves. |
| Public method Static member | [Create(Document, IList Curve , Level, Int32, Boolean)](633b2057-876e-80d6-bac3-42a036dad2a4.htm) | Creates a new BeamSystem with specified profile curves. |
| Public method Static member | [Create(Document, IList Curve , SketchPlane, XYZ, Boolean)](e422e969-e6df-d62e-6f48-288bbac997cf.htm) | Creates a new BeamSystem with specified profile curves. |
...
| Public method Static member | [DropBeamSystem](c1c29f1c-bcc2-947c-8cf6-380e0b5d64be.htm) | Drop beam system, it will disassociate all members from the beam system and delete the beam system. |
| Public method | Equals | Determines whether the specified  Object  is equal to the current  Object  . (Inherited from  Object  .) |
| Public method | [GetBeamIds](0f489cca-4830-9016-fe8d-d17ba4b9f4d0.htm) | Gets all the beams of the BeamSystem. |
...
| Public property | [BeamSystemType](f738ec01-4d36-884c-cc40-3a78c8b1b2bd.htm) | Retrieves or changes the type of the BeamSystem. |
| Public property | [BeamType](c1f1e42c-b564-b968-6632-a014104b4877.htm) | Retrieves or changes the Beam Type of the BeamSystem. |
...
| Public property | [Direction](8eccbd73-eb9b-7eaa-2449-d1bcfc0a8e84.htm) | The Direction of the BeamSystem. |
...
| Public property | [Elevation](9ca4a8bf-9749-3a00-042b-5cfa9c345c68.htm) | Retrieves or changes the Elevation of the BeamSystem. |
...
| Public property | [LayoutRule](2db288d4-8e26-b710-6371-72c8054a3d8b.htm) | Retrieves or changes the LayoutRule of the BeamSystem. |
| Public property | [Level](ee3933b3-51ff-1476-cfe0-76042df715b0.htm) | Get or change the level of the BeamSystem. When the level is changed, the elevation is changed to make the the BeamSystem remain the location. |
...
| Public property | [Profile](fb63b4c6-1702-538c-01b8-ee622e3e9993.htm) | Retrieve or set the profile of the BeamSystem. |
