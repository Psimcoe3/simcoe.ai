...
| Visual Basic |
| --- |
| ``` Public Property BuildingType As gbXMLBuildingType 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property gbXMLBuildingType BuildingType { 	gbXMLBuildingType get (); 	void set (gbXMLBuildingType value); } ``` |

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | When setting this property: The building type does not fall within an appropriate range. |
