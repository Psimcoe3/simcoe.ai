...
|  |
| --- |
| [AngularDimension Class](6f3b8d2e-904b-41cb-e57f-34fc8c1a0f4a.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [AngularDimension](6f3b8d2e-904b-41cb-e57f-34fc8c1a0f4a.htm)  type exposes the following members.
...
| Public method Static member | [Create](2e3b9201-d5fa-3cdb-53e4-8e204bda1fe5.htm) | Creates a new instance of an Angular Dimension element within the project. |
...
| Public method | [HasOneSegment](7fc64c23-c5fc-9180-26bd-f52749178056.htm) | Determines whether a dimension has one segment. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public method | [IsTextPositionAdjustable](e3d0717c-713d-64b0-64a9-336cbb95519a.htm) | Indicates if this dimension is supported to set/get TextPosition/LeaderEndPosition. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public method | [ResetTextPosition](2e4a13c9-1fc0-c1a4-6d85-1dcbc65b3e22.htm) | Resets the text position of the dimension to the initial position determined by its type and parameters. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public method | [SetAngularRadius](11de7cec-ac9b-72d5-054a-9c24ca88e84b.htm) | Set radius of an Angular Dimension arc. The new radius of the arc. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [Above](a515077d-e21e-9f6d-58c2-f1f19577373d.htm) | The text shown above the segment's value. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public property | [AreReferencesAvailable](cdfc60a1-dd37-9428-6b47-d94870801559.htm) | Indicates if this dimension's references can be resolved. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public property | [AreSegmentsEqual](0d28a47a-b40e-c0fc-bfe0-d1b391f2c176.htm) | Indicates if all segments are forced to be equal. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [Below](2d8fb2e2-b504-66da-30d5-a9b1a4099629.htm) | The text shown below the segment's value. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [Curve](83e340d0-8c2c-d845-d8d5-2fb6aa64f085.htm) | A curve that represents the dimension line. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [DimensionShape](7141f360-1215-f1d8-571f-4004452c79de.htm) | The shape of this dimension. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public property | [DimensionType](5f982cf1-cc62-8bb5-5a31-5061b97b6ddc.htm) | The dimension style of this dimension. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [FamilyLabel](cd34752d-ff4f-e6f7-05e5-82405af00e52.htm) | The family parameter label of the dimension. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [HasLeader](f37b29fc-4ea1-604f-25f4-182a66764251.htm) | True if dimension has leader, false otherwise. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [IsLocked](496d64c6-3642-577d-7631-96956baed820.htm) | Indicates if this dimension is locked. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [IsValid](a4382d5b-23af-acd0-1e58-0d964d483482.htm) | Indicates if this dimension is valid. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [LeaderEndPosition](cf75655f-f779-5c31-5ea5-dc27839c46d5.htm) | The position of the dimension's leader end point. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [Name](4c4c2704-48d2-8add-8309-427ff77a8955.htm) | Retrieves or changes the name associated with the Dimension. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public property | [NumberOfSegments](3e01937d-a001-8fd4-9cc8-270ad4b4ba10.htm) | The number of segments for the dimension. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public property | [Origin](df8b9dc6-9d36-ac2b-04cf-816d88f039b8.htm) | The dimension origin. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [Prefix](36e450c8-09af-54af-a25d-9fede511522f.htm) | The text shown before the segment's value. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public property | [References](fc3bc889-b274-3262-a126-849df2af9019.htm) | Returns an array of geometric references to which the dimension is attached. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public property | [Segments](d7fcdab2-ca81-0ed1-4813-f7aa092430d7.htm) | The segments in the dimension. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public property | [Suffix](e8817946-d9c0-9f75-ca44-c7d379caa388.htm) | The text shown after the segment's value. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public property | [TextPosition](2a3b8401-48c9-8425-1f98-b142babdf0a2.htm) | The position of the dimension text's drag point. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [Value](883a5cec-31db-39c1-2745-210a45d67374.htm) | The value of the dimension. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public property | [ValueOverride](4560ec6c-5aab-fcae-a64c-6f939ae06d94.htm) | The text that replaces the segment's value. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
| Public property | [ValueString](8608426e-2490-158c-f52b-f79d88f793f6.htm) | The dimension value as a user visible string. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
...
| Public property | [View](8520fd39-b766-2f43-7937-1ffb4e0bc59a.htm) | Supplies the view that contains the dimension if the dimension is view specific. (Inherited from  [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.htm)  .) |
