...
| C# |
| --- |
| ``` public ElementId Link( 	string file, 	OBJImportOptions options, 	View pDBView ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function Link ( _ 	file As String, _ 	options As OBJImportOptions, _ 	pDBView As View _ ) As ElementId ``` |
