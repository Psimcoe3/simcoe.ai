...
|  |
| --- |
| [ImageInstance Class](ff77d6c8-a94a-067a-cd95-4f2cd3ec8dcc.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [ImageInstance](ff77d6c8-a94a-067a-cd95-4f2cd3ec8dcc.htm)  type exposes the following members.
...
| Public method Static member | [Create](0f4cd250-7925-6714-3e08-2bd7c0266252.htm) | Creates a new ImageInstance element placed in a view. |
...
| Public method | [GetLocation](c275e3bf-00ab-2d2f-8c41-7d4cd7ff79fe.htm) | Returns the location of one of the points of the ImageInstance |
...
| Public method Static member | [IsValidView](ee7cd29b-d142-27e8-4fc0-4eff2109b1c1.htm) | Check that the view is a valid view for ImageInstance elements |
...
| Public method | [SetLocation](2ca53d23-6e03-838c-b755-2478f778357d.htm) | Moves the ImageInstance to the specified location |
...
| Public property | [CanHaveSnaps](ac6a3521-50ad-3573-11b1-d29038730dae.htm) | When true the ImageInstance has snaps that can be enabled with the  [EnableSnaps](73df0a9a-d0d6-33fe-0fd9-ce2c1f77255e.htm)  property |
...
| Public property | [DrawLayer](81510a8d-d74e-bf19-dd79-f8909b178d20.htm) | The layer the ImageInstance will be drawn in. |
| Public property | [EnableSnaps](73df0a9a-d0d6-33fe-0fd9-ce2c1f77255e.htm) | When true the ImageInstance will have its snaps enabled, but only if  [CanHaveSnaps](ac6a3521-50ad-3573-11b1-d29038730dae.htm)  is true |
...
| Public property | [Height](ba996fed-0624-689f-08a8-1488cdb1292a.htm) | The height of the ImageInstance. |
| Public property | [HeightScale](c0c41a38-7554-4472-479a-794b561a6534.htm) | The factor applied to the  [ImageType](c6213f81-8dc8-158e-0522-70f87e9bdbb9.htm)  to calculate the  [Height](ba996fed-0624-689f-08a8-1488cdb1292a.htm)  of the ImageInstance. |
...
| Public property | [LockProportions](2eda8038-9240-00f5-ffa3-a65d8b4df5f2.htm) | When true the proportion of  [Width](c135b323-bdcf-4945-6f7b-f2da08bb41fe.htm)  to  [Height](ba996fed-0624-689f-08a8-1488cdb1292a.htm)  will be maintained |
...
| Public property | [Width](c135b323-bdcf-4945-6f7b-f2da08bb41fe.htm) | The width of the ImageInstance. |
| Public property | [WidthScale](c938de3b-849b-11a0-c80b-cb852b65c64b.htm) | The factor applied to the width of the  [ImageType](c6213f81-8dc8-158e-0522-70f87e9bdbb9.htm)  to calculate the  [Width](c135b323-bdcf-4945-6f7b-f2da08bb41fe.htm)  of the ImageInstance. |
