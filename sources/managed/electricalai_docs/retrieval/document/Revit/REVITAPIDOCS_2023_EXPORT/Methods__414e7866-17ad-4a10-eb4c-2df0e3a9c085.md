...
|  |
| --- |
| [DimensionType Class](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.htm)  type exposes the following members.
...
| Public method | [CanHaveEqualityFormula](eda97893-d225-4564-471d-dd2f1a4277e5.htm) | Checks whether this DimensionType can have an equality formula. |
| Public method | [CanHaveOrdinateDimensionSetting](aaab2cfd-af6c-9ef4-2754-91f2be6ee5bd.htm) | Checks whether this DimensionType can have an ordinate dimension settings. |
...
| Public method | [GetAlternateUnitsFormatOptions](81fca2c9-ca3c-0f70-366e-8841944bdac7.htm) | Gets the FormatOptions to optionally override the default settings in the Units class for the alternate units value. |
...
| Public method | [GetEqualityFormula](086fb666-7be0-f093-516e-670b149be97d.htm) | Gets an ordered list of the entries in the equality formula definition. |
...
| Public method | [GetOrdinateDimensionSetting](97c6109a-f5af-eccf-5db7-2a72f608b685.htm) | Gets the ordinate dimension settings for this DimensionType. |
...
| Public method | [GetSpecTypeId](bcdcd878-9956-0531-deac-e68dd6f7149a.htm) | Gets the spec of this dimension style. |
...
| Public method | [GetUnitsFormatOptions](ca121374-9437-d76c-06e8-7a98d16829fd.htm) | Gets the FormatOptions to optionally override the default settings in the Units class for the units value. |
...
| Public method | [SetAlternateUnitsFormatOptions](a8203fee-0893-99fe-a279-950b80cd22ee.htm) | Sets the FormatOptions to optionally override the default settings in the Units class for the alternate units value. |
...
| Public method | [SetEqualityFormula](1fbbcd04-ce47-e054-6ed7-706171f97ec0.htm) | Sets an ordered list of the entries to use in the equality formula definition. |
| Public method | [SetOrdinateDimensionSetting](b6201e90-b02d-a2a0-a239-9230f79e8a20.htm) | Sets the ordinate dimension settings for this DimensionType. |
| Public method | [SetUnitsFormatOptions](3589c9ad-24df-58ca-07a1-2b0c3e2ac157.htm) | Sets the FormatOptions to optionally override the default settings in the Units class for the units value. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AlternateUnits](c6e3383f-be38-6738-5d7e-18487fa01de5.htm) | The alternate units display mode for this DimensionType. |
| Public property | [AlternateUnitsPrefix](c2e2e6e4-4042-ca9d-e537-8d7430e621c9.htm) | The prefix text for the alternate units value. |
| Public property | [AlternateUnitsSuffix](fc89169d-afb1-55e4-c8c0-98fab0f097ef.htm) | The suffix text for the alternate units value. |
...
| Public property | [Prefix](8bc987fd-a5f3-9c11-e9be-860947445f81.htm) | The prefix text for the dimension value. |
| Public property | [StyleType](2c31c41a-cd12-4fef-2b2e-439012efc810.htm) | The dimension style type of this DimensionType. |
| Public property | [Suffix](1caee7d4-8990-7790-f41b-fb03166d7c58.htm) | The suffix text for the dimension value. |
