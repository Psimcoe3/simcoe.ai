...
| C# |
| --- |
| ``` public bool CanGroupHeaders( 	int top, 	int left, 	int bottom, 	int right ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function CanGroupHeaders ( _ 	top As Integer, _ 	left As Integer, _ 	bottom As Integer, _ 	right As Integer _ ) As Boolean ``` |
