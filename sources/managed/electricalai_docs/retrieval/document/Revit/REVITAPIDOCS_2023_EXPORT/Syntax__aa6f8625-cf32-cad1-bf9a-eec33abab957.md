...
| C# |
| --- |
| ``` public static void RenameWorkset( 	Document aDoc, 	WorksetId worksetId, 	string name ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Sub RenameWorkset ( _ 	aDoc As Document, _ 	worksetId As WorksetId, _ 	name As String _ ) ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | aDoc is not a workshared document. -or- name is an empty string or contains only whitespace. -or- name cannot include prohibited characters, such as "{, }, [, ], |, ;, less-than sign, greater-than sign, ?, `, ~". -or- The given workset name is already in use. -or- There is no workset in the document with this id. |
