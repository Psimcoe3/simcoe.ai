...
| C# |
| --- |
| ``` public static void BringForward( 	Document pDocument, 	View pDBView, 	ElementId detailElementId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Sub BringForward ( _ 	pDocument As Document, _ 	pDBView As View, _ 	detailElementId As ElementId _ ) ``` |
...
:   Type:  [Autodesk.Revit.DB ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.htm)    
     The detail elementId to bring forward.
