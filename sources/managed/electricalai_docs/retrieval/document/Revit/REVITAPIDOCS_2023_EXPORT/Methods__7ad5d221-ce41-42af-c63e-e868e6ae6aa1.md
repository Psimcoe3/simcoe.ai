...
|  |
| --- |
| [MassLevelData Class](c1e62aaf-b7af-ad0c-60d5-4a1a9c1bed79.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method | [IsEmpty](c9e0abfe-b8fa-e48b-edab-b83185b158fb.htm) | Indicates if the MassLevelData (Mass Floor) has a geometrical representation. May not if the level does not intersect the mass geometry. |
...
| Public method Static member | [IsMassFamilyInstance](a2bc9949-9c4f-afc4-6c79-38050507e784.htm) | Checks if the ElementId is a mass family instance. |
...
| Public method | [IsValidConceptualConstructionTypeElement](453bc7cc-a667-fdb6-72d9-efb2db40badd.htm) | Checks if the ElementId is an acceptable conceptual construction type ElementId for the MassLevelData (Mass Floor). |
...
| Public property | [ConceptualConstructionId](88677e76-8bd6-0759-bcca-2564315f2f5b.htm) | The ElementId of the conceptual construction associated with the MassLevelData (Mass Floor). |
| Public property | [ConceptualConstructionIsByEnergyData](ddb2ff65-36ac-7e6d-68f2-8e96360d6e8c.htm) | Indicates if the ConceptualConstructionType of the MassLevelData (Mass Floor) is synchronized with the EnergyDataSettings or if it overrides those settings. |
...
| Public property | [MaterialId](9caa0161-3bd5-3c63-699a-1b79afea3fb6.htm) | The ElementId of the visualization material used for the MassLevelData (Mass Floor) |
| Public property | [MaterialType](c3164139-a696-7153-ed7e-eebc42f0186f.htm) | Indicates if the material used for the graphical appearance is by category or a specific material, or if the material to be used should be taken from the ConceptualConstructionType of the MassLevelData. |
...
| Public property | [NExteriorSurfaceArea](f8179e61-5d07-3a53-5146-0e679710311f.htm) | The exterior surface area of the volume of the mass between the level of this MassLevelData (Mass Floor) to the next in the mass. |
| Public property | [NLevelFafArea](467e6479-bdbb-8905-bf5e-f2c118c6168b.htm) | The surface area of the intersection of the MassLevelData's level with the mass geometry. |
| Public property | [NLevelPerimeter](49ba6c5f-84ac-645e-76bf-c0dcc13aa04c.htm) | The perimeter of the intersection of the MassLevelData's level with the mass geometry. |
| Public property | [NVolume](d0324ae1-ed34-6a20-e1e0-11047324ac76.htm) | The volume of from the level of this MassLevelData (Mass Floor) to the next in the mass. |
...
| Public property | [OwningMassId](6a8ef77b-fb82-adfa-74df-b37182ec679c.htm) | The ElementId of the mass that the MassLevelData (Mass Floor) is associated with. |
...
| Public property | [StrUsage](1d863832-bf9b-a3b8-7444-92c32d25fee6.htm) | A String which describes the usage or occupancy type of the level of the MassLevelData. |
