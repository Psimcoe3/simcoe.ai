...
|  |
| --- |
| [Wall Class](b5891733-c602-12df-beab-da414b58d608.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [Wall](b5891733-c602-12df-beab-da414b58d608.htm)  type exposes the following members.
...
| Public method | [CanHaveProfileSketch](63ddfb69-5168-af0a-224c-4608ddd2352c.htm) | Checks whether this wall has or can have a profile sketch. |
...
| Public method | [CreateProfileSketch](d582a742-d89d-6edb-90e2-dd16633bd8b8.htm) | Creates a new Wall profile Sketch. |
...
| Public method | [Flip](4fa072e8-7840-66bc-78a4-e13ef24f0d41.htm) | The wall orientation will be flipped. |
...
| Public method | [GetStackedWallMemberIds](66ec8d4e-25cd-1e14-3b25-d9d3a0f5cce9.htm) | Get the sub walls which belongs to the wall. |
...
| Public method | [IsWallCrossSectionValid](3da9a916-d6ca-2f56-b818-4cc60d7252a7.htm) | Checks whether the desired cross section is valid for the current wall. |
...
| Public method | [RemoveProfileSketch](7bd6782b-b088-9a3e-c5b6-3609c83f0070.htm) | Reverts an edited wall to its original shape. |
...
| Public property | [CrossSection](78d7a145-5b3c-c82f-6bec-85bb14b00cf5.htm) | Obtain the Wall Cross-section for this wall. |
| Public property | [CurtainGrid](7d46f445-4739-1877-c9de-e04787d7257b.htm) | Get the grid object of a curtain wall |
...
| Public property | [Flipped](84e3e931-b085-01b3-3dc2-954234356b8f.htm) | Property to test whether the wall orientation is flipped. |
...
| Public property | [IsStackedWall](d2319202-9cfa-4bd7-ae89-b4d0579dce40.htm) | Identifies if the wall is a stacked wall. |
| Public property | [IsStackedWallMember](3b3b58bd-187a-47b8-840f-fa5e858f731b.htm) | Identifies if the wall is a member of a stacked wall. |
...
| Public property | [Orientation](0aa38eaf-be9c-3dd9-f0e4-621847cfcb63.htm) | The normal vector projected from the exterior side of the wall. |
...
| Public property | [SketchId](cbe78025-7b87-340c-3fe9-d0019a6e7382.htm) | Returns id of the profile sketch, or invalidElementId if sketch does not exist. |
| Public property | [StackedWallOwnerId](b140a527-a790-9397-51c8-1dae171fda6b.htm) | Gets the stacked wall which contains this stacked wall member. |
| Public property | [StructuralUsage](3957dfb0-fa41-0f9f-d3c8-ecfbd210e91d.htm) | Retrieves or changes the wall's designated structural usage. |
...
| Public property | [WallType](0c0d155f-5b2c-c09f-d7d4-41a8600560eb.htm) | Retrieves or changes the type of the wall. |
| Public property | [Width](b8ebbd5d-b4ec-e98d-f16c-edcca14f921d.htm) | Get the overall thickness of the wall. |
