...
| Visual Basic |
| --- |
| ``` Public Shared Function ConnectPipePlaceholdersAtTee ( _ 	document As Document, _ 	connector1 As Connector, _ 	connector2 As Connector, _ 	connector3 As Connector _ ) As Boolean ``` |
