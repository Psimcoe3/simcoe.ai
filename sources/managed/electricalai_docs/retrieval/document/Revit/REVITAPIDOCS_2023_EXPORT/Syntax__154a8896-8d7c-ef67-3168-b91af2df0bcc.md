...
| C# |
| --- |
| ``` public static bool ServerSupportsRevitLinks( 	ExternalResourceReference extRef ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function ServerSupportsRevitLinks ( _ 	extRef As ExternalResourceReference _ ) As Boolean ``` |
