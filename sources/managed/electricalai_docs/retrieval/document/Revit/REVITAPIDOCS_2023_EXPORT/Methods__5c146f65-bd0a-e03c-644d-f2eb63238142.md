...
|  |
| --- |
| [ExportDWGSettings Class](a17fc52f-f67a-9763-e52f-29f867106908.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [ExportDWGSettings](a17fc52f-f67a-9763-e52f-29f867106908.htm)  type exposes the following members.
...
| Public method Static member | [Create(Document, String)](e54ac7dc-0b2c-a1ae-a5d8-5bd794d2cb8d.htm) | Create a DWG export settings with default values. |
| Public method Static member | [Create(Document, String, DWGExportOptions)](b693114f-746b-fb8e-e557-2ddedd6e5684.htm) | Create a DWG export settings with default values. |
| Public method Static member | [Create(Document, String, DXFExportOptions)](b9476032-59cf-f4a1-16ed-8c6bb7ed1ea3.htm) | Create a DWG export settings with default values. |
...
| Public method Static member | [FindByName](8c4fd57e-67b9-92d5-6bbe-88be485f25dd.htm) | Returns the pre-defined non-in-session exporting settings for DWG in the given document with the specified name. |
| Public method Static member | [GetActivePredefinedSettings](94addb49-9531-141c-bfca-20377e135fa9.htm) | Returns the active pre-defined non-in-session exporting settings for DWG in the given document. |
...
| Public method | [GetDWGExportOptions](d5372a5c-b19a-03a8-4a2b-5f3617acec61.htm) | Gets the options stored in the these settings. |
| Public method | [GetDXFExportOptions](c678af47-2536-4301-8167-85d1aacf604e.htm) | Gets the options stored in the these settings. |
...
| Public method Static member | [ListNames](03a2609a-7777-f049-5013-c90eaa7054a2.htm) | Returns a list of names of dwg/dxf export settings. |
...
| Public method | [SetDWGExportOptions](f518e57c-4b51-f1ba-114e-51a7d9d3dd92.htm) | Sets the options stored in these settings. |
| Public method | [SetDXFExportOptions](0936653b-e358-404e-17cc-70cc6341dcb0.htm) | Sets the options stored in these settings. |
