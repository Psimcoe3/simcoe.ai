...
| C# |
| --- |
| ``` public static CurveElement CreateAreaBasedLoadBoundaryLine( 	Document document, 	Curve curve, 	ElementId levelId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateAreaBasedLoadBoundaryLine ( _ 	document As Document, _ 	curve As Curve, _ 	levelId As ElementId _ ) As CurveElement ``` |
