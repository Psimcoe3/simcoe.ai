...
|  |
| --- |
| [FlexDuct Class](39e3bd3a-8304-7785-dd10-4043aa0d7da4.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [FlexDuct](39e3bd3a-8304-7785-dd10-4043aa0d7da4.htm)  type exposes the following members.
...
| Public method Static member | [Create(Document, ElementId, ElementId, ElementId, IList XYZ )](4896a7a5-97bc-28c3-f2e8-b9428d3ee865.htm) | Creates a new flexible duct into the document, using a point array and flexible duct type. |
| Public method Static member | [Create(Document, ElementId, ElementId, ElementId, XYZ, XYZ, IList XYZ )](db73e2d8-2fd7-1088-997f-4ac8c4c9bccb.htm) | Creates a new flexible duct into the document, using a point array and flexible duct type. |
...
| Public method Static member | [IsFlexDuctTypeId](a598ecef-7854-5b6f-1ffc-b8c09692c202.htm) | Checks if given type is valid flexible duct type. |
...
| Public method Static member | [IsHVACSystemTypeId](2fae60e5-94e0-4fb5-60d3-3b7ce4dd3e51.htm) | Checks if given type is valid HVAC system type. |
...
| Public property | [EndTangent](bddac743-5c15-8854-3b05-f9a722f27fa6.htm) | Gets or sets the tangent vector at the end of the curve. The invalid or zero vector is ignored when setting the tangent. |
| Public property | [FlexDuctType](67ccc28b-dcf5-aa69-44c1-5a4da62e260a.htm) | The flex duct type of this flex duct. |
...
| Public property | [Points](7273b1b6-337b-e65c-95bb-5639467d98c8.htm) | The points of the flex duct. |
...
| Public property | [StartTangent](65e6bd3b-9a51-26b4-cda9-c7abeafe7e14.htm) | Gets or sets the tangent vector at the start of the curve. The invalid or zero vector is ignored when setting the tangent. |
