...
|  |
| --- |
| [SlabEdge Class](8c1ba09e-d1d0-b1e4-bc2f-26ec4b6c5afa.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [SlabEdge](8c1ba09e-d1d0-b1e4-bc2f-26ec4b6c5afa.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AddSegment](3da4c84c-9a77-2996-99cf-040e057abbcd.htm) | Add segments to the slab edge. (Overrides  [HostedSweep AddSegment(Reference)](c26f908b-140a-6f06-918d-263efe814df9.htm)  .) |
...
| Public method | [GetEndPointParameter](9d932372-7418-6e37-6764-0cc0994959df.htm) | Retrieve segment's start point or end point parameter. (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |
...
| Public method | [HorizontalFlip](c64cb45b-74b9-acef-db86-62931b11b1ee.htm) | Flip the hosted sweep object along horizontal line. (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |
...
| Public method | [RemoveSegment](14ff1a00-0fd1-cc28-a20f-9e3b00083488.htm) | Remove segments from the hosted sweep object. (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |
| Public method | [SetEndPointParameter](de365ff6-a402-a803-43de-c9efc847fccd.htm) | Set segment's start point or end point parameter. (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |
...
| Public method | [VerticalFlip](481bf9a1-1437-9da7-0589-35d7bb9d7428.htm) | Flip the hosted sweep object along vertical line. (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |

# Properties

|  | Name | Description |
| --- | --- | --- |
| Public property | [Angle](beb95fa6-6296-2631-f30c-1fc71b3b03c5.htm) | Retrieve/set the angle of the hosted sweep object relative its references (Unit : Radian). (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |
...
| Public property | [HorizontalFlipped](bf5a61c7-e8d5-631d-749a-659084be1723.htm) | Retrieve the horizontal flip status of the hosted sweep object. (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |
| Public property | [HorizontalOffset](a7da1c98-55e0-b0eb-fbf4-165d7d424924.htm) | Retrieve/set the horizontal offset of the hosted sweep object. (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |
...
| Public property | [Length](5f5119d2-7b2f-1a17-0ba3-ef74cbe984e9.htm) | Retrieve the length of the hosted sweep object. (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |
...
| Public property | [ReferenceCurve](76c8b986-670c-1d4a-3ae4-776b3eb29ad9.htm) | The curve on which the hosted sweep segment is created. (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |
| Public property | [SlabEdgeType](fd61ed95-0d48-9e46-2dd7-4c8486a4ccce.htm) | Retrieves/set an object that represents the type of the SlabEdge. |
...
| Public property | [VerticalFlipped](3919a432-3aed-5230-b89a-2346d2f769ca.htm) | Retrieve the vertical flip status of the hosted sweep object. (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |
| Public property | [VerticalOffset](8b3de2d4-3005-afc9-cbc5-1862fd60341e.htm) | Retrieve/set the vertical offset of the hosted sweep object. (Inherited from  [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.htm)  .) |
