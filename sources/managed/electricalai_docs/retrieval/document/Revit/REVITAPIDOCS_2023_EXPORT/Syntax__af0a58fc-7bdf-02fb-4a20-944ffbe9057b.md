...
| C# |
| --- |
| ``` public OverrideGraphicSettings GetElementOverrides( 	ElementId elementId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function GetElementOverrides ( _ 	elementId As ElementId _ ) As OverrideGraphicSettings ``` |
