...
| C# |
| --- |
| ``` public ConnectorDomainType GetFabricationConnectorDomain( 	int fabricationConnectorId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function GetFabricationConnectorDomain ( _ 	fabricationConnectorId As Integer _ ) As ConnectorDomainType ``` |
