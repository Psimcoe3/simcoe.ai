...
| C# |
| --- |
| ``` public ElementId Link( 	string file, 	SKPImportOptions options, 	View pDBView ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function Link ( _ 	file As String, _ 	options As SKPImportOptions, _ 	pDBView As View _ ) As ElementId ``` |
