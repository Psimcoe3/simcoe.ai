...
| Visual Basic |
| --- |
| ``` Public Function NewSpace ( _ 	level As Level, _ 	point As UV _ ) As Space ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentNullException](631e1424-60f4-929b-4e52-dda9dcd26316.htm) | Thrown when level or point is    a null reference (  Nothing  in Visual Basic)  . |
