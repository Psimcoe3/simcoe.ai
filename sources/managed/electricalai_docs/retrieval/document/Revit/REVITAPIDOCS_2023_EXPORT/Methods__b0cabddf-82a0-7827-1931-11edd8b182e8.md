...
|  |
| --- |
| [AnalyticalElement Class](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)  type exposes the following members.
...
| Public method | [GetCurve](1eebc63e-4b20-a2a1-3537-283e2d284ee4.htm) | Returns the curve of the Analytical Element. |
...
| Public method | [GetReference](9804934b-e6dd-3a0f-5994-30307fecca2d.htm) | Returns a reference to a given curve within the Analytical Element. |
...
| Public method | [GetTransform](23e0c0f8-3f72-235e-0b1f-b977bbe5d697.htm) | Returns the transform which reflects Analytical Element orientation. |
...
| Public method | [IsSingleCurve](b9d6eb46-2e7d-4501-004e-704b69600d1f.htm) | Indicates if the Analytical Element can be expressed as a single curve. |
| Public method | [IsValidAnalyzeAs](98f5eb53-b973-3cdc-ebce-7f0ee16d1378.htm) | Checks whether the value set for Analyze As is valid for an Analytical Element. |
| Public method | [IsValidSelector](9b076f25-113f-2c09-d63b-2d2a68082c9b.htm) | Indicates if the input selector is valid for the Analytical Element. |
| Public method | [IsValidStructuralRole](c53f8bf2-a819-c1c8-890b-f2571c087549.htm) | Checks whether the value set for Analytical Structural Role is valid for an Analytical Element. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AnalyzeAs](571db5af-db0b-c5a0-afc0-746c80cf9721.htm) | This represents the Analyze As parameter assigned to Analytical Element. |
...
| Public property | [MaterialId](919f020c-953a-3d08-0743-57dc1d3dc398.htm) | Defines the Material Id for the Analytical Element. |
...
| Public property | [StructuralRole](e7dfb391-f0d6-9aef-8ba9-b8f05e269329.htm) | The enum value depicting structural role asigned to the Analytical Element. |
