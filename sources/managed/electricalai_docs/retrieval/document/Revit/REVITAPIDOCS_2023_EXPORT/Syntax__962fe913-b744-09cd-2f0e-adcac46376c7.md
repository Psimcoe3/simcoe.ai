...
| C# |
| --- |
| ``` public void AddConstraintCircumference( 	ElementId paramId, 	RebarShapeArcReferenceType arcRefType ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub AddConstraintCircumference ( _ 	paramId As ElementId, _ 	arcRefType As RebarShapeArcReferenceType _ ) ``` |
