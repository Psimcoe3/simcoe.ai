...
|  |
| --- |
| [RebarShape Class](0a370e32-eaba-785e-7e1f-9330929525fc.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [RebarShape](0a370e32-eaba-785e-7e1f-9330929525fc.htm)  type exposes the following members.
...
| Public method Static member | [Create(Document, RebarShapeDefinition, RebarShapeMultiplanarDefinition, RebarStyle, StirrupTieAttachmentType, Int32, RebarHookOrientation, Int32, RebarHookOrientation, Int32)](2dd89e4d-0953-8cf2-9441-10d07e6155fa.htm) | Create a new instance of a Rebar Shape, which defines the shape of a rebar. |
| Public method Static member | [Create(Document, RebarShapeDefinition, RebarShapeMultiplanarDefinition, RebarStyle, StirrupTieAttachmentType, Int32, RebarHookOrientation, Int32, RebarHookOrientation, Int32, Double, Double, ElementId, ElementId)](4ec14822-777d-be9a-580c-fd90a4ce28c2.htm) | Create a new instance of a Rebar Shape, which defines the shape of a rebar. |
...
| Public method | [GetAllowed](20f58bef-6bf7-63c6-d50d-61eb1d74ee4d.htm) | Check whether a bar type can be used with this RebarShape. Bar types are allowed by default. |
| Public method | [GetCurvesForBrowser](d07fdab5-5af9-a9e6-3840-d3a4b52d6979.htm) | Generate curves for the shape, as used in the shape browser. |
| Public method | [GetDefaultHookAngle](89fe9654-9f1c-6ba8-d87c-1b38b63feb31.htm) | Get the hook angle, expressed as an integral number of degrees (common values are 0, 90, 135, and 180). |
| Public method | [GetDefaultHookOrientation](2a97de53-42d6-cf64-f998-73ad9b79fcf0.htm) | Get the hook orientation. |
...
| Public method | [GetEndTreatmentTypeId](d78defed-af7e-8feb-6e71-2c067fcc3397.htm) | Gets the id of the EndTreatmentType at the specified rebar shape end. |
...
| Public method | [GetHookRotationAngle](76a3c46d-031e-37c6-d8c2-3342a60d8bc5.htm) | Gets the out of plane hook rotation angle at the specified end. |
...
| Public method | [GetMultiplanarDefinition](9366f4cf-b2aa-3fd1-bdc0-984caeda0aaa.htm) | The optional 3D structure of the shape. |
...
| Public method | [GetRebarShapeDefinition](80019bb8-76a4-f6e1-476d-2f9992286adb.htm) | Return the definition of the RebarShape. |
...
| Public method | [HasEndTreatment](488b6145-c8b9-a18a-93d0-0b6449df7f52.htm) | Identifies if the rebar shape has end treatment at at least one end. |
...
| Public method | [IsSameShapeIgnoringHooks](5815937c-ac80-2f85-ff5a-4e728336251e.htm) | Test whether two shapes have equivalent definitions by comparing the RebarShapeDefinition and MultiplanarDefinition properties. |
...
| Public method | [SetAllowed](5779735a-5105-127d-eaae-31fb0f2b81e4.htm) | Specify which bar types can be used with this RebarShape. Bar types are allowed by default. |
| Public method | [SetEndTreatmentTypeId](f7c875ee-c66f-e08b-78e2-ad40b0d83ea4.htm) | Sets the EndTreatmentType id at the specified rebar shape end. |
...
| Public method | [SetHookRotationAngle](b30a6f55-b672-e942-7c1f-ab3d9b27dd4e.htm) | Sets the out of plane hook rotation angle at the specified end. |
...
| Public property | [HigherEnd](e3c2b8f8-5d6b-3bf8-0e9d-68848f2a78fd.htm) | Defines the higher end of rebar shape. |
...
| Public property | [RebarStyle](ec72e836-ea5a-8d74-40f0-55344ae095bd.htm) | Whether the shape represents a standard bar or a stirrup. |
| Public property | [ShapeFamilyId](60b519a8-b0cd-f078-559b-d35b7ab88b1c.htm) | Get and return the rebar shape family id. |
| Public property | [SimpleArc](7c63c3f5-bac9-9d24-90fd-8dbc03a6df4f.htm) | Check whether this shape consists of a single arc, possibly with hooks. |
| Public property | [SimpleLine](462b2fbb-597c-c17b-dc80-0ff74c690b83.htm) | Check whether this shape consists of a single straight segment, possibly with hooks. |
| Public property | [StirrupTieAttachment](5e8deedb-9319-b087-a573-03c9ad996f2c.htm) | The attachment type of stirrup ties and rebars. |
