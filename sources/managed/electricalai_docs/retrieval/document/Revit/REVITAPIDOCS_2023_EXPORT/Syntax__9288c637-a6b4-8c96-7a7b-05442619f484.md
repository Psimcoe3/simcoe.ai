...
| Visual Basic |
| --- |
| ``` Public Property SpaceType As gbXMLSpaceType 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property gbXMLSpaceType SpaceType { 	gbXMLSpaceType get (); 	void set (gbXMLSpaceType value); } ``` |

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | When setting this property: The space type does not fall within an appropriate range. |
