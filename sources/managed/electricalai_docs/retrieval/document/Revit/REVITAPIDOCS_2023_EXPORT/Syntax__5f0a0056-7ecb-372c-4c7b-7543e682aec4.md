...
| C# |
| --- |
| ``` public ElementPhaseStatusFilter( 	ElementId phaseId, 	ElementOnPhaseStatus phaseStatus, 	bool inverted ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub New ( _ 	phaseId As ElementId, _ 	phaseStatus As ElementOnPhaseStatus, _ 	inverted As Boolean _ ) ``` |
