...
|  |
| --- |
| [AnalyticalMember Class](57c87ac5-a82e-5c7e-2f06-6dbf1f697566.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [AnalyticalMember](57c87ac5-a82e-5c7e-2f06-6dbf1f697566.htm)  type exposes the following members.
...
| Public method Static member | [Create](97853ed7-4457-02cd-5ac3-f03d7d0dbc12.htm) | Creates a new instance of an Analytical Member within the project. |
...
| Public method | [FlipCurve](b59e2918-471d-1e72-68fb-22fdc4ce7124.htm) | Flip the Analytical Member |
| Public method | [GetCurve](1eebc63e-4b20-a2a1-3537-283e2d284ee4.htm) | Returns the curve of the Analytical Element. (Inherited from  [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)  .) |
...
| Public method | [GetMemberForces](5769b806-a243-f49d-b0d9-c0f793363cbf.htm) | Gets the member forces associated with this Analytical Member. |
...
| Public method | [GetReference](9804934b-e6dd-3a0f-5994-30307fecca2d.htm) | Returns a reference to a given curve within the Analytical Element. (Inherited from  [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)  .) |
| Public method | [GetReleaseConditions](95da8025-e532-bbfa-3e5a-564c2710e8d3.htm) | Gets the release conditions associated with this Analytical Member. |
| Public method | [GetReleaseType](3cd5237d-bef2-7a12-f0e3-43318820f75a.htm) | Gets the release type. |
...
| Public method | [GetTransform](23e0c0f8-3f72-235e-0b1f-b977bbe5d697.htm) | Returns the transform which reflects Analytical Element orientation. (Inherited from  [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)  .) |
...
| Public method | [IsSingleCurve](b9d6eb46-2e7d-4501-004e-704b69600d1f.htm) | Indicates if the Analytical Element can be expressed as a single curve. (Inherited from  [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)  .) |
| Public method | [IsValidAnalyzeAs](98f5eb53-b973-3cdc-ebce-7f0ee16d1378.htm) | Checks whether the value set for Analyze As is valid for an Analytical Element. (Inherited from  [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)  .) |
| Public method Static member | [IsValidCurve](a3087787-403a-556a-ca27-05ee9caf465d.htm) | Verifies if the curve is valid for an Analytical Member. |
| Public method | [IsValidSectionTypeId](21bdce0b-2f56-3b30-6ce3-3702c9b0387e.htm) | Checks whether the family symbol id is allowed for Analytical Member as Section Type property. |
| Public method | [IsValidSelector](9b076f25-113f-2c09-d63b-2d2a68082c9b.htm) | Indicates if the input selector is valid for the Analytical Element. (Inherited from  [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)  .) |
| Public method | [IsValidStructuralRole](c53f8bf2-a819-c1c8-890b-f2571c087549.htm) | Checks whether the value set for Analytical Structural Role is valid for an Analytical Element. (Inherited from  [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)  .) |
...
| Public method | [SetCurve](a1808afa-ba67-381b-ea28-4e8b2d9e5516.htm) | Sets the curve for the Analytical Member. |
...
| Public method | [SetMemberForces(MemberForces)](53ccade9-6946-8c77-0e94-64b14e19104a.htm) | Sets Member Forces to Analytical Member. |
| Public method | [SetMemberForces(Boolean, XYZ, XYZ)](d72e983a-bb75-30e2-5dac-373a9c28d7cc.htm) | Sets Member Forces to Analytical Member. |
| Public method | [SetReleaseConditions](79296d6b-51bd-d92c-ddb4-26689c76cc76.htm) | Sets Release Conditions to Analytical Member. |
| Public method | [SetReleaseType](41b94d8b-c36b-d3bf-f76e-56e66ea3b19a.htm) | Sets the release type. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AnalyzeAs](571db5af-db0b-c5a0-afc0-746c80cf9721.htm) | This represents the Analyze As parameter assigned to Analytical Element. (Inherited from  [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)  .) |
...
| Public property | [CrossSectionRotation](aaa42138-0ce6-4adc-992f-eb658d99aab9.htm) | This represents the cross-section rotation, in radians. |
...
| Public property | [MaterialId](919f020c-953a-3d08-0743-57dc1d3dc398.htm) | Defines the Material Id for the Analytical Element. (Inherited from  [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)  .) |
...
| Public property | [SectionTypeId](5e8a8f22-82e6-1a60-2ca1-bea0ea6a86a1.htm) | The id of the type from the structural Family assigned to the Analytical Member. |
| Public property | [StructuralRole](e7dfb391-f0d6-9aef-8ba9-b8f05e269329.htm) | The enum value depicting structural role asigned to the Analytical Element. (Inherited from  [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.htm)  .) |
| Public property | [StructuralSectionShape](74d01c4a-9032-e740-2338-e9a8ec6711d5.htm) | The structural section shape of the Analytical Member. |
