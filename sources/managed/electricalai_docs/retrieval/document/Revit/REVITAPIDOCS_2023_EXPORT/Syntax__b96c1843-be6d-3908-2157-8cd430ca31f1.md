...
| C# |
| --- |
| ``` public Dimension NewAngularDimension( 	View view, 	Arc arc, 	Reference firstRef, 	Reference secondRef, 	DimensionType dimensionType ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function NewAngularDimension ( _ 	view As View, _ 	arc As Arc, _ 	firstRef As Reference, _ 	secondRef As Reference, _ 	dimensionType As DimensionType _ ) As Dimension ``` |
...
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | Thrown when the argument firstRef/secondRef/dimensionType is invalid. |
