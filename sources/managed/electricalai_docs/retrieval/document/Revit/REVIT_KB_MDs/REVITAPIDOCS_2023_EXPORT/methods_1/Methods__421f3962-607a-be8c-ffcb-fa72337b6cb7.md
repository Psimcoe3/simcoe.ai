...
|  |
| --- |
| [MultiSegmentGrid Class](8488ef7c-7669-26a7-8088-dd78e96850de.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [MultiSegmentGrid](8488ef7c-7669-26a7-8088-dd78e96850de.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method Static member | [AreGridsInSameMultiSegmentGrid](742243de-2773-a7c5-7b6d-ee4ce3b4b7d1.htm) | Determine whether two Grids are members of the same GridChain. |
...
| Public method Static member | [Create](706e504e-20dd-e017-6bdf-e5265848d150.htm) | Create a MultiSegmentGrid element from the specified curve loop. |
...
| Public method | [GetGridIds](203790e1-56b4-52d3-83f5-14ccd3409466.htm) | Get the element ids of the Grids that make up this MultiSegmentGrid. |
...
| Public method Static member | [GetMultiSegementGridId](141c947b-7be3-4eee-9a92-627865023bf8.htm) | Retrieve the element id of the MultiSegmentGrid of which the specified Grid is a member. |
...
| Public method Static member | [IsValidCurveLoop](cc8ce9f7-9dc9-a807-76c1-f4bfb12232b9.htm) | Identifies whether the specified curve loop is valid for creation of a MultiSegmentGrid. |
| Public method Static member | [IsValidSketchPlaneId](aa463929-733e-8831-3075-a34e3fe12bcf.htm) | Identifies whether provided element id corresponds to a SketchPlane that is valid for GridChain creation. |
...
| Public property | [Text](8ec5e47a-8821-5d3c-0951-33d051a58b96.htm) | name shared by grids in this MultiSegmentGrid |
