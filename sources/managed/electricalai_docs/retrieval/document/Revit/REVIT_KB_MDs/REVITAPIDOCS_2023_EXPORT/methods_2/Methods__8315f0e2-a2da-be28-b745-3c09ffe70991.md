...
|  |
| --- |
| [MassZone Class](da242463-3097-290a-9c10-afdf54d96649.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [MassZone](da242463-3097-290a-9c10-afdf54d96649.htm)  type exposes the following members.
...
| Public method | [GetCoincidentReferenceFromAdjacentZone](18700789-5e98-b093-00f3-634577950d4c.htm) | This method is used to get a Reference from an adjacent MassZone that is coincident to a Reference of this MassZone. |
...
| Public method | [GetEquivalentReferenceFromMassOrLevel](a175483c-2272-2f91-c908-f1eeddec8c4f.htm) | Returns a Reference to a face of a MassEnergyAnalyticalModel element or an element Reference to a MassLevelData element. This Reference represents what the MassZone face was "cut from" when making the MassZone for the level. |
...
| Public method | [GetMassDataElementIdForZoneFaceReference](01c7235f-cf9a-5d38-ed5f-c60b975643d8.htm) | MassZone faces come from faces of MassEnergyAnalyticalModel, and those faces have MassSurfaceData or MassLevelData elements associated with them. |
...
| Public method | [GetReferencesToEnergyAnalysisFaces](cce8a199-4c83-9dbb-7457-4d51f16371c8.htm) | Used to get References to all the faces of the MassZone that are used for Energy Analysis. |
...
| Public method | [IsEmpty](53d94788-4697-05b0-c1d0-7342821ae779.htm) | Indicates if MassZone has no geometry. Such zones should not be shown to the user. |
...
| Public property | [ConditionType](a4c9390a-cc38-854e-c774-84442086afdd.htm) | The gbXMLConditionType of the MassZone. |
...
| Public property | [CutByLowerLevel](b39a0537-0834-d3f4-b0ff-800ae55f2961.htm) | Indicates the relationship between the MassZone and its lower level. |
| Public property | [CutByUpperLevel](3025df57-f111-8d0b-6197-a6ed0e5d8afc.htm) | Indicates the relationship between the MassZone and its upper level. |
...
| Public property | [FloorArea](9e818478-5c92-1bd9-ef22-eb78e077ed8a.htm) | The floor area of the MassZone. |
...
| Public property | [IsZoneOccupiable](9ecaa2eb-b754-457e-3fc1-26f7cc247fd9.htm) | A MassZone must have a level as its bottom to be occupiable; If it does not, it is still a MassZone, but it is not occupiable |
...
| Public property | [LowerLevelId](0ed7255b-d0f9-4862-24dc-c7f5e32b1e44.htm) | The bottom level defining the MassZone. |
| Public property | [MassEnergyAnalyticalModelId](319e8e94-5406-3ef6-22d8-ba55ae3a2801.htm) | The ElementId of the MassEnergyAnalyticalModel that the MassZone is derived from. |
| Public property | [MaterialId](b2625093-4fe2-8082-b303-0c81031f3580.htm) | The visualization material for the MassZone. Will be InvalidElementId if material is by category or the material type is by MassZoneMaterialTypeMaterialBySurfaceType. |
| Public property | [MaterialType](c8e203cc-be2b-a4d7-e317-ba21e192ba6f.htm) | Indicates how the material of MassZone faces is determined. |
...
| Public property | [SpaceType](9288c637-a6b4-8c96-7a7b-05442619f484.htm) | The gbXMLSpaceType of the MassZone. |
| Public property | [SpaceTypeId](d48b3fca-91e5-11f8-4c73-8d86a5351a17.htm) | The space type element of the MassZone. |
...
| Public property | [UpperLevelId](d7344df6-9710-5c5c-b4dc-85c7f5647bb4.htm) | The upper level defining the MassZone. |
...
| Public property | [Volume](1c09505f-7364-85ee-b9f8-f1cd4cea1600.htm) | The volume of the MassZone. |
