...
|  |
| --- |
| [MultistoryStairs Class](8b07cbff-013c-889f-8807-703e63a91923.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method | [CanConnectLevel](01069be7-0661-3d91-48d3-9a6dea6c9711.htm) | Checks if the given level can be connected into multistory stairs. You cannot connect levels between standard stairs top and bottom or already connected. |
...
| Public method | [CanDisconnectLevel](471db1d0-7f14-6a45-a31e-b31a85f1f124.htm) | Checks if the given level can be disconnected from multistory stairs. You cannot disconnect the levels of standard stair (the stair associated with the Reference Level for the multistory stairs) or already disconnected. |
...
| Public method | [ConnectLevels](e6734f94-80de-fedd-e972-488899569085.htm) | Extends the multistory stairs by connecting input levels. |
| Public method Static member | [Create](97782290-9eb0-9559-1012-6d46212b5476.htm) | Creates a multistory stairs from an existing component-based stairs. |
...
| Public method | [DisconnectLevels](482be079-8bd4-e275-8231-7d3ae487e73c.htm) | Shrinks the multistory stairs by disconnecting input levels. |
...
| Public method | [GetAllConnectedLevels](c6c09472-e44a-9bf5-6847-e4a0c2212d00.htm) | Gets all connected level ids of this multistory stairs. |
| Public method | [GetAllStairsIds](a66792ff-4d73-afc7-8df6-ae8733cf69de.htm) | Gets the ids of all the stairs in this multistory stairs. |
...
| Public method | [GetStairsOnLevel](7a591c9d-6dd9-398e-9eb5-280eca78d396.htm) | Gets the individual stairs or stairs group on the given base level. |
| Public method | [GetStairsPlacementLevels](1d81b0f3-4065-8ec7-e7f8-0fbb1d120617.htm) | Gets all the levels the given stairs group placed on. |
...
| Public method Static member | [IsAcceptableForMultistoryStairs](bd5ebf3c-cccc-7b4e-518d-25655532b981.htm) | Checks if the given stairs can be used to create a multistory stairs. |
...
| Public method | [IsPinned](c9dea1f0-00e3-e5ab-d66d-84e6250accab.htm) | Checks if a stair is pinned. |
...
| Public method | [Pin](41a11436-7ef4-f8c8-f247-04d529f8c466.htm) | Restores an unpinned stairs element back into the group of stairs governed by level height. |
...
| Public method | [Unpin](f1eb4c84-2b7e-1b6a-dc8b-dfc6c0c994c9.htm) | Removes a particular story of the stairs (identified by its base level id) from a stairs group. |

# Properties

|  | Name | Description |
| --- | --- | --- |
| Public property | [ActualTreadDepth](736ed3f5-be03-a819-96b8-1cd302f3ae22.htm) | The actual depth of the stairs treads in the stairs, actual tread depth is equal to minimum tread depth by default. |
...
| Public property | [StandardStairsId](2430a0ec-b9b4-28ad-de89-3d7a1340d239.htm) | Id of the stair associated with the Reference Level for the multistory stairs. The standard stair is regarded as a definition to generate new stairs when extending multistory stairs to a different level height. |
