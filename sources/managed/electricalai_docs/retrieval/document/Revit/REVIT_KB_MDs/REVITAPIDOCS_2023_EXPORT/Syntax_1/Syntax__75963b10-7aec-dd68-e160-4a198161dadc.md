...
| C# |
| --- |
| ``` public BRepBuilderGeometryId AddEdge( 	BRepBuilderEdgeGeometry edgeGeom ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function AddEdge ( _ 	edgeGeom As BRepBuilderEdgeGeometry _ ) As BRepBuilderGeometryId ``` |
...
edgeGeom
:   Type:  [Autodesk.Revit.DB BRepBuilderEdgeGeometry](b0051e1b-8b8b-f819-78c2-67053dd7a241.htm)    
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | The input edge geometry was invalid. |
