...
| C# |
| --- |
| ``` public FieldType Get<FieldType>( 	string fieldName, 	ForgeTypeId unitTypeId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function Get(Of FieldType) ( _ 	fieldName As String, _ 	unitTypeId As ForgeTypeId _ ) As FieldType ``` |

 

| Visual C++ |
| --- |
| ``` public: generic<typename FieldType> FieldType Get( 	String^ fieldName,  	ForgeTypeId^ unitTypeId ) ``` |
