...
| Visual Basic |
| --- |
| ``` Public Property LoadSummaryDemandFactorLabel As String 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property String^ LoadSummaryDemandFactorLabel { 	String^ get (); 	void set (String^ value); } ``` |

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | When setting this property: loadSummaryDemandFactorLabel is not a valid globalization format string. |
