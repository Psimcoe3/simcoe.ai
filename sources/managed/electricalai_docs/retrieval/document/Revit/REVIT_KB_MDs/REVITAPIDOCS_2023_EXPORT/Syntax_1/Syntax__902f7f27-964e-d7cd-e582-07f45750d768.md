...
| C# |
| --- |
| ``` public void RemoveReferences( 	IList<Reference> referencesToRemove ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub RemoveReferences ( _ 	referencesToRemove As IList(Of Reference) _ ) ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | The operation failed. Please verify that the references are all tagged before removing them. |
