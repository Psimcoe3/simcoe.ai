...
|  |
| --- |
| [PipeSettings Class](2de0109b-0d0d-a0fe-2adf-6edec8bc1a06.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
|  | Name | Description |
| --- | --- | --- |
| Public method | [AddPipeSlope](8ae86cd1-edbe-be80-e8bc-eb7cbbb573d5.htm) | Add a pipe slope value. |
...
| Public method | [GetFlowConvertionServerInfo](9ab99425-32ed-3b7b-2353-2d76cc364468.htm) | Get the MEPServerInfo of the current plumbing flow convertion server. |
...
| Public method Static member | [GetPipeSettings](58e77947-e8ba-935c-d732-95c585dcc6cd.htm) | Get the pipe settings of the project. |
| Public method | [GetPipeSlopes](fc405942-f9f1-36b7-b29f-eda46e433e1d.htm) | Get pipe slopes. |
| Public method | [GetSpecificFittingAngles](be4b50bb-22ce-550e-babf-573de87a344e.htm) | Gets the list of specific fitting angles. |
| Public method | [GetSpecificFittingAngleStatus](251d69ee-91fa-38fe-3868-35b82f1866de.htm) | Gets the status of given specific angle. |
...
| Public method Static member | [IsAnalysisForClosedLoopHydronicPipingNetworksEnabled](13190276-346c-eeac-fcba-3c749092cf7f.htm) | Indicates whether analysis for closed loop hydronic piping networks is enabled in the specified document. |
...
| Public method | [IsValidSpecificFittingAngle](ca0d771a-33e9-f073-083b-098d4d74e924.htm) | Checks that the given value is a valid specific fitting angle. The specific fitting angles are angles of 90, 60, 45, 30, 22.5 or 11.25 degrees. |
...
| Public method | [SetFlowConvertionServerInfo](4abe0a72-4d41-3d95-3e5e-aeb7a3d8f639.htm) | Set the MEPServerInfo of the current plumbing flow convertion server. |
| Public method | [SetPipeSlopes](7d44bf12-8f5d-731c-9e72-8ae76cae8be3.htm) | Set pipe slope values. |
| Public method | [SetSpecificFittingAngleStatus](fe684616-5a84-6984-d731-b9efe21367ed.htm) | Sets the status of given specific angle. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AnalysisForClosedLoopHydronicPipingNetworks](c8df4a55-893f-aeed-d388-51c923ff0c07.htm) | Indicates whether to enable analysis for closed loop hydronic piping networks. |
...
| Public property | [Centerline](c1bb6ed5-c673-eb76-df28-c0d430272cb2.htm) | The abbreviation of the Centerline (=) string. |
| Public property | [ConnectorSeparator](360f9362-1069-16bd-2587-86ad8a3bbf24.htm) | The connector separator string. |
| Public property | [ConnectorTolerance](d0cf1441-bb4e-dcdd-304d-e8a1c0d0d0c9.htm) | The connector tolerance value. |
...
| Public property | [FittingAngleUsage](846e530e-49de-308b-fd72-c3414b3e5257.htm) | Determine how to use fitting angle during pipe layout or modifying layout. |
| Public property | [FittingAnnotationSize](6b0c6492-4c82-ce34-4f0f-544a0b3f65f1.htm) | The value of fitting annotation size. |
| Public property | [FlatOnBottom](8ec7fb54-c9bf-542b-3335-ce20bc11caf7.htm) | The abbreviation of the Flat On Bottom (FOB) string. |
| Public property | [FlatOnTop](8d175d9d-119e-410b-065b-94202c25ecb3.htm) | The abbreviation of the Flat On Top (FOT) string. |
...
| Public property | [SetDown](ae3bff2f-151e-9924-cd83-0ef3f3411e54.htm) | The abbreviation of the Set Down (SD) string. |
| Public property | [SetDownFromBottom](453be523-ae50-a6e2-cc66-5303d87a211f.htm) | The abbreviation of the Set Down from bottom of fitting (SDB) string. |
| Public property | [SetUp](5406391e-2f9e-dcf3-76f2-47c99ffb1701.htm) | The abbreviation of the Set Up (SU) string. |
| Public property | [SetUpFromBottom](29ddd25b-8e8e-9c3e-6828-417dec598e58.htm) | The abbreviation of the Set Up from bottom of fitting(SUB) string. |
| Public property | [SizePrefix](24468d2e-1e90-8be7-07ca-b055788a19ea.htm) | The size prefix string. |
| Public property | [SizeSuffix](49eb536d-ce5e-5484-8311-7d8c13947b2d.htm) | The size suffix string. |
...
| Public property | [UseAnnotationScaleForSingleLineFittings](803e4b6a-85a0-fee5-830a-231cb89826b6.htm) | Indicates whether use annotation scale for single line fittings or not. |
