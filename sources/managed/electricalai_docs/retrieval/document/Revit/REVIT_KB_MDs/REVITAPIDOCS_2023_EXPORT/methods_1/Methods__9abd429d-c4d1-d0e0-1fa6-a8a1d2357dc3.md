...
|  |
| --- |
| [CurtainGridLine Class](42c94f55-1972-5f12-1dd4-db15ad1af3d3.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [CurtainGridLine](42c94f55-1972-5f12-1dd4-db15ad1af3d3.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AddAllSegments](5c4a3c78-b527-31c8-aeb8-b9d51c2b56e4.htm) | All the segments on this grid line will be added. |
| Public method | [AddMullions](c6a78e90-5ce1-5bf3-cb82-f3de750e0255.htm) | Add mullions on the specified segments of a grid. If any segment already has a mullion, no change is made to that segment. |
| Public method | [AddSegment](0e6a1adb-8953-4afb-9769-34f8142e50ee.htm) | Add a segment based on the specified segment curve of the gridline. |
...
| Public method | [RemoveSegment](024f4880-1bfd-0819-a1b3-8cd11113cfad.htm) | Remove the segment specified by the input curve. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AllSegmentCurves](122fa101-38a5-3f23-6c86-855f942df7e0.htm) | Retrieve the curves of all segments. |
...
| Public property | [ExistingSegmentCurves](8595a252-e9fd-5537-2a78-2517dd950d28.htm) | Retrieve all the existing segment curves of the grid line. |
| Public property | [FullCurve](6bc234da-f624-9ac2-a306-6e62cfc77945.htm) | Retrieve the geometry curve of the curtain grid line. |
...
| Public property | [IsUGridLine](71ec9099-79fa-07b0-495d-74ad73d6d4d8.htm) | Retrieve the direction of a grid line.If it is true,we say it is a UGridLine,otherwise it is VGridLine |
...
| Public property | [Lock](835099bf-8511-65d8-bd42-746e992c7bca.htm) | Retrieves or changes the lock state of the curtain grid line. |
...
| Public property | [SkippedSegmentCurves](8456b83c-bbb2-c22c-5bb1-23521721b545.htm) | Retrieve all the removed segment curves of the grid line. |
