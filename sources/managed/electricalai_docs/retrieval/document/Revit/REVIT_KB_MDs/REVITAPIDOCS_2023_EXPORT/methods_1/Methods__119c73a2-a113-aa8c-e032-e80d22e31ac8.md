...
|  |
| --- |
| [FabricationConfiguration Class](f7094105-2acf-03f1-7a7f-82dd24087a17.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [FabricationConfiguration](f7094105-2acf-03f1-7a7f-82dd24087a17.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AncillaryExists](2042758d-e451-923e-82f8-c74a38f30409.htm) | Checks to see if the specified ancillary exists. |
| Public method | [AreItemFilesLoaded](bdedf16d-79ae-abd0-9052-697366004b19.htm) | Checks if the fabrication item files have been loaded. |
...
| Public method | [CanBeSwapped](a8effafa-42c2-10bf-dda3-9a435c4075a2.htm) | Checks if the fabrication configuration can be swapped. |
...
| Public method | [CanUnloadItemFiles](eaece08e-f3cf-3bd6-489e-19d8cf8e8b1f.htm) | Checks if the fabrication item files are already in use and should not be unloaded. |
...
| Public method | [CustomDataExists](3b4d7726-f4de-f10f-4a14-8cf4a3912a4d.htm) | Checks to see if the specified custom data exists. |
| Public method | [DamperExists](3b6086d3-65f7-8b3f-51c8-d261ad0be933.htm) | Checks to see if the specified damper exists. |
...
| Public method | [GetAllDampers](b856c588-2a9d-fd34-4d4d-21ba8fcc1343.htm) | Gets all damper identifiers in the fabrication configuration. |
| Public method | [GetAllFabricationConnectorDefinitions](d694f14a-7afc-1f01-334a-94dd21985835.htm) | Gets fabrication connector identifiers from the fabrication configuration, filtered by shape and domain. |
| Public method | [GetAllInsulationSpecifications](daaeb400-b013-36e5-f4f1-d697b668a712.htm) | Gets all insulation specification identifiers in the fabrication configuration. |
| Public method | [GetAllLoadedItemFiles](2bc97834-4739-5bb2-83d5-c3ae296250ad.htm) | Get list of all loaded fabrication item files. |
| Public method | [GetAllLoadedServices](834e34e3-1656-e0f4-b993-735712a3dba7.htm) | Returns all the loaded fabrication services. |
| Public method | [GetAllMaterials](f8e1ab05-467f-6ee6-3103-052d27e8af74.htm) | Gets all material identifiers in the fabrication configuration. |
| Public method | [GetAllPartCustomData](19f74ecb-a0c6-5541-126d-9191b9b6db4a.htm) | Gets all possible fabrication part custom data identifiers. |
| Public method | [GetAllPartStatuses](0cd93d49-9295-cd01-dd68-3a7abe616690.htm) | Gets all possible fabrication part status identifiers. |
| Public method | [GetAllServices](ce53c061-fce3-80f7-ca41-80846e3b2159.htm) | Returns all fabrication services in the fabrication configuration. |
| Public method | [GetAllSpecifications](736406c3-c459-2fad-b966-7dc37f339b65.htm) | Gets all specification identifiers in the fabrication configuration. |
| Public method | [GetAllUsedItemFiles](0c62a934-d041-14d6-dc54-bd99b8a67111.htm) | Returns all the used fabrication item files. A fabrication item file is used if any fabrication parts in the model were created from it. |
| Public method | [GetAllUsedServices](4a7b444f-9a43-5188-5ee4-d13debe21eec.htm) | Returns all the used fabrication services. A service is used if any fabrication part in the service is created by user. |
| Public method | [GetAncillaries](b224007e-150d-c5a1-c703-d7abb8a37d29.htm) | Gets fabrication ancillaries of the specified type. |
| Public method | [GetAncillaryGroup](881dd623-3c7d-59e1-b19d-9f56e5f6d45a.htm) | Gets the fabrication ancillary group of the specified fabrication ancillary identifier. |
| Public method | [GetAncillaryGroupName](2367e7e5-4c90-0473-cddc-0281093af660.htm) | Gets the fabrication ancillary group and name for the specified fabrication ancillary identifier. |
| Public method | [GetAncillaryName](e9a3df25-b421-150f-649a-e9172f1f1706.htm) | Gets the fabrication ancillary name for the specified fabrication ancillary identifier. |
| Public method | [GetDamperName](e84d23a2-0615-50a1-2802-746f74a51818.htm) | Gets the damper name from its identifier. |
...
| Public method Static member | [GetFabricationConfiguration](041695a6-1434-bb23-6105-5783458b8ceb.htm) | Gets the fabrication configuration element in the document. |
| Public method | [GetFabricationConfigurationInfo](3912030b-b1af-8856-2ace-f6ceeb369cec.htm) | Gets the information about the fabrication configuration of the project. |
| Public method | [GetFabricationConnectorDomain](f02ed712-2e58-d96b-b807-02e0e3940087.htm) | Gets the fabrication connector domain from its identifier. |
| Public method | [GetFabricationConnectorGroup](23aa9453-cc47-939b-c691-341f9b8bf3a6.htm) | Gets the fabrication connector group from its identifier. |
| Public method | [GetFabricationConnectorName](eee278fa-1961-c38a-b1a7-df0af1472896.htm) | Gets the fabrication connector name from its identifier. |
| Public method | [GetFabricationConnectorShape](c5054b58-4830-46b1-4337-801e5ca19054.htm) | Gets the fabrication connector shape from its identifier. |
...
| Public method | [GetInsulationSpecificationAbbreviation](807829a2-4ad2-41ea-cf60-e125d7693dfe.htm) | Gets insulation specification abbreviation. |
| Public method | [GetInsulationSpecificationGroup](dec6f45a-0b84-46c9-37a6-8dc9dbdc024e.htm) | Gets the insulation specification group from its identifier. |
| Public method | [GetInsulationSpecificationName](63f50dfb-2da5-cb46-41b6-7524f6e4380c.htm) | Gets the insulation specification name from its identifier. |
| Public method | [GetItemFolders](d283e079-1113-f185-e9c0-d40fada72391.htm) | Gets a list of every fabrication item folder in the fabrication item folder structure. |
| Public method | [GetMaterialAbbreviation](fc7879dd-dd2c-71f5-429b-b640d4ac20be.htm) | Gets the abreviation of the material or the insulation or the double wall material. |
...
| Public method | [GetMaterialGroup](51b9427d-cfef-30be-45cf-fb282212a9a5.htm) | Gets material group from its identifier. |
...
| Public method | [GetMaterialName](828e75ce-67c4-be63-65a0-d547c2541d21.htm) | Gets material name from its identifier. |
...
| Public method | [GetPartCustomDataName](46f73ae4-794e-e195-4d52-47a7df0346c9.htm) | Gets the custom data name from its identifier. |
| Public method | [GetPartCustomDataType](46ec095d-1c5a-54e9-3229-4aa6172a274f.htm) | Gets the custom data type from its identifier. See FabricationCustomDataType enumerator. |
| Public method | [GetPartStatusDescription](70e3afea-50e2-5ff4-867d-c39094edbf65.htm) | Gets the status description from its identifier. |
...
| Public method | [GetProfile](63e8bb2b-b53c-b0e1-995c-8d24428b824b.htm) | Return the profile of the loaded fabrication configuration. Return empty string for global profile. |
| Public method | [GetService](428c7eb4-2dec-4038-3dd4-4dd2a1fd85bd.htm) | Get the service based on the service identifier from the fabrication configuration in the current document. |
| Public method | [GetServiceTypeName](70ab5511-d2f9-d818-d82b-33fd1016c361.htm) | Gets the service type name. |
| Public method | [GetSpecificationAbbreviation](bcb23a34-ee26-0c8e-5d79-4b9e45a4d927.htm) | Gets specification abreviation. |
| Public method | [GetSpecificationGroup](b3c66f8d-7aa8-ad2c-bfeb-6e69b7eb12b5.htm) | Gets the specification group from its identifier. |
| Public method | [GetSpecificationName](7f3081d2-948e-af1a-ef49-8d6e04ae6090.htm) | Gets the specification name from its identifier. |
...
| Public method | [HasValidConfiguration](dc0b2e19-bd72-b15d-3752-a2ea09938b7c.htm) | Checks whether a valid fabrication configuration has been set for the project. |
| Public method | [IsAncillaryKit](b4c6e352-3a70-eb07-84a1-2d107fb6da40.htm) | Gets whether the specified fabrication ancillary identifier is an ancillary kit or not. |
...
| Public method | [LoadItemFiles](d7aa286a-d55d-46da-b654-0c175f433abc.htm) | Loads the specified fabrication item files into the project. |
| Public method | [LoadServices](893d7a24-0fd6-410f-2459-99c3b16fbfe0.htm) | Loads the specified fabrication services into the project. |
| Public method | [LocateFabricationConnector](02a21b64-3880-17fa-6646-05ebe0c759fd.htm) | Gets the fabrication connector identifiers by group and name, filtered by shape and domain. |
| Public method | [LocateInsulationSpecification](a3f54ebb-06df-0683-2541-984ed525476e.htm) | Gets the insulation specification by group and name. |
| Public method | [LocateMaterial](d3466136-f845-f453-9456-9981cd4d4fdd.htm) | Gets material by group and name. |
| Public method | [LocateSpecification](39c265d3-b467-4277-d3ad-78e1d1c31fe4.htm) | Gets the specification identifier by group and name. |
...
| Public method | [ReloadConfiguration](4a40d755-029f-5a44-b2a4-b4bb749eae52.htm) | Reloads the fabrication configuration from its source fabrication configuration. |
...
| Public method | [UnloadItemFiles](3343cdd7-7050-0e6f-c294-936a3a9c7e03.htm) | Unload the specified fabrication item files from the project. |
| Public method | [UnloadServices](65e9d8c8-0371-8397-3a50-ec155e189999.htm) | Unload the specified fabrication services from the project. |
