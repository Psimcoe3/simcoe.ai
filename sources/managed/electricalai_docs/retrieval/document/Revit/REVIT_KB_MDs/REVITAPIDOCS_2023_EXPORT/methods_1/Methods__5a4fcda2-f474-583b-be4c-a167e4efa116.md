...
|  |
| --- |
| [ProjectLocation Class](1249d5fa-74f3-cf64-0a63-7ab370b67a5c.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [ProjectLocation](1249d5fa-74f3-cf64-0a63-7ab370b67a5c.htm)  type exposes the following members.
...
| Public method Static member | [Create](b13b3906-f110-577b-e436-01949dc3239e.htm) | Create an instance of ProjectLocation in the document. |
...
| Public method | [Duplicate](18ada300-7084-2281-63c8-13c40e14e5b7.htm) | Generate a copy of this project location with the specified name. |
...
| Public method | [GetProjectPosition](45724712-d710-eb12-5a48-63a31a54f09f.htm) | Gets the coordinates of a point in the ProjectLocation's coordinate system. |
| Public method | [GetSiteLocation](b15628ab-b246-233d-6587-9205d2ad04a3.htm) | Gets the site location to which this project location refers. |
...
| Public method Static member | [IsProjectLocationNameUnique](dc6a464b-1334-67c2-c28a-b42895f0094c.htm) | Verifies that there is no existing ProjectLocation with the given name belonging to the given SiteLocation. |
...
| Public method | [SetProjectPosition](ff73932a-dae4-37b3-5b4d-584e4bb95e2a.htm) | Sets the coordinates of a point in the ProjectLocation's coordinate system. |
