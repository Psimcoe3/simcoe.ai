...
|  |
| --- |
| [BoundaryConditions Class](58a98f0e-e2e5-4c8b-bea1-8228b30f1685.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [BoundaryConditions](58a98f0e-e2e5-4c8b-bea1-8228b30f1685.htm)  type exposes the following members.
...
| Public method | [GetBoundaryConditionsType](28e256af-2b2c-15a7-2d67-840189fdbef1.htm) | Returns the boundary conditions type. |
| Public method | [GetCurve](59a7f80e-394b-56ec-7df8-79b4a0217163.htm) | Returns curve that define geometry of the line boundary conditions. |
| Public method | [GetDegreesOfFreedomCoordinateSystem](7528eafa-4031-a508-1a9f-5a0f3488cad8.htm) | Gets the origin and rotation of coordinate system that is used by translation and rotation parameters, like X Translation or Z Rotation. |
...
| Public method | [GetLoops](caf2fb5e-e3dd-f284-320c-178d93d66b55.htm) | Returns curve loops that define geometry of the area boundary conditions. |
...
| Public method | [GetOrientTo](8e93c29c-cd8f-fb6f-3979-2e86ffebd575.htm) | Returns the boundary conditions orientation option. |
...
| Public method | [SetOrientTo](8d8d9e31-30ca-a099-d546-cdc1aeb61c7b.htm) | Sets the boundary condition orientation option. |
...
| Public property | [AssociatedLoadId](9e8cd409-59af-6426-ac76-d2cccab1908d.htm) | The Id of the internal load element associated with a boundary conditions. |
...
| Public property | [HostElementId](9e930666-e2e2-dcff-d441-b85daac15e00.htm) | The host element Id for the boundary conditions. |
...
| Public property | [Point](081e145b-8e09-a6bd-b77b-1e7a7fe8a4cd.htm) | Returns the position of point boundary conditions. |
