...
| C# |
| --- |
| ``` public string GetLoadClassificationConnectedLoad( 	int nRow, 	int nCol ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function GetLoadClassificationConnectedLoad ( _ 	nRow As Integer, _ 	nCol As Integer _ ) As String ``` |
