...
|  |
| --- |
| [Railing Class](4af1265f-859e-123b-ada5-a479324f3dee.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [Railing](4af1265f-859e-123b-ada5-a479324f3dee.htm)  type exposes the following members.
...
| Public method | [Flip](ad8cbb52-9732-6aaf-1187-1731f6116e81.htm) | Flips the railing. |
...
| Public method | [GetHandRails](7c33a83c-7114-6caf-16eb-275e0c98c330.htm) | Get all the handrails of the railing. |
...
| Public method | [GetMultistoryStairsPlacementLevels](aac188d3-7c62-e74c-3579-cdcb8dc5c7f3.htm) | Gets the ids of the base levels of the stairs upon which this railing is placed. |
...
| Public method | [GetPath](70531de6-1d62-d37f-2b20-721cc68d2f9e.htm) | Gets the railing path. |
...
| Public method | [GetSubelementOnLevel](b9d35dc7-42d9-1699-4985-bc80fe2c7045.htm) | Gets the subelement on given level. |
...
| Public method Static member | [IsValidHostForNewRailing](cc1aaa43-f61a-e65d-eac9-43370200295a.htm) | Checks whether new railing can be created and placed on the specified host. |
| Public method Static member | [IsValidPathForRailing](3f368fef-e0ac-1430-d409-1fa5136d1b8f.htm) | Checks whether a railing can be created along a railing path. |
...
| Public method | [RailingCanBeHostedByElement](7f73d2b0-b1ad-9070-4330-6c9d7f28a835.htm) | Checks whether the specified element can be used as a host for the railing. The host can be:  * stairs * stairs component * ramp * floor * slab edge * wall * roof |
...
| Public method | [RemoveHost](28367859-53d5-fbbe-2d55-16970e62e9b4.htm) | Removes the association between the railing and its host. |
| Public method | [Reset](fc09d693-e4f2-8971-cb2d-b64cd6325227.htm) | Resets the railing to the default one that the system generates. |
| Public method | [ResetSupportPosition](89c19f58-4556-ecb6-1110-ff69e55436b4.htm) | Resets the continuous rails support subelements position data. |
...
| Public method | [SetMultistoryStairsPlacementLevels](47227a43-299a-e762-1e2a-acafb14093a3.htm) | Sets the ids of the base levels of the stairs upon which this railing is placed. |
| Public method | [SetPath](2a1c1870-31f9-c80d-23b4-da44d0e86179.htm) | Sets the railing path. |
...
| Public property | [CanReset](a1ae830a-9923-a134-1f72-fff811863974.htm) | True if the railing can be reset, False otherwise. |
...
| Public property | [Flipped](3e0d0aea-7bfc-ac33-405e-2e26cbdc6e8f.htm) | Indicates if the railing is flipped. |
...
| Public property | [HasHost](c977dcea-a003-cd92-5381-91efe270d055.htm) | Indicates if the railing has a host. |
| Public property | [HostId](4fe4b0e6-591d-70d1-10f7-e192393fae26.htm) | The host of the railing. |
...
| Public property | [IsDefault](03ee5975-6d93-f6d1-0c6f-ab31c0331f34.htm) | Indicates if the railing is the default one that system generates. |
...
| Public property | [TopRail](2cde1842-b57b-6864-2f4a-c4852303a152.htm) | The top rail of the railing. |
