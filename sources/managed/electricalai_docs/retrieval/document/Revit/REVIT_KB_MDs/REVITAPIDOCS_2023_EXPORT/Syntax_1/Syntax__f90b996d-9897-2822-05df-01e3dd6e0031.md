...
| C# |
| --- |
| ``` public void SetMajorLayoutAsNumberWithSpacing( 	double overallWidth, 	double minorStartOverhang, 	int numberOfWires, 	double spacing ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub SetMajorLayoutAsNumberWithSpacing ( _ 	overallWidth As Double, _ 	minorStartOverhang As Double, _ 	numberOfWires As Integer, _ 	spacing As Double _ ) ``` |
