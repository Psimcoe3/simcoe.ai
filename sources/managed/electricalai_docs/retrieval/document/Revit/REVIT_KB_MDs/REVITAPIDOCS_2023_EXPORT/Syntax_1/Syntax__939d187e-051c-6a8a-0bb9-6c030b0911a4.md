...
|  |
| --- |
| [Members](d1baf5df-5375-db41-dbd0-c3b9d7da5b5d.htm)   [See Also](#seeAlsoToggle) |
...
| Visual Basic |
| --- |
| ``` Public Class DocumentClosingEventArgs _ 	Inherits RevitAPIPreDocEventArgs ``` |
...
[DocumentClosingEventArgs Members](d1baf5df-5375-db41-dbd0-c3b9d7da5b5d.htm)
