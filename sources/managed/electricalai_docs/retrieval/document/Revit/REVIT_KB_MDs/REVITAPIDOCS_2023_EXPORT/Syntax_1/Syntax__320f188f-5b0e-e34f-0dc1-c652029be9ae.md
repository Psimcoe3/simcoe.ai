...
| Visual Basic |
| --- |
| ``` Public Shared Function Create ( _ 	document As Document, _ 	profile As IList(Of Curve), _ 	sketchPlane As SketchPlane, _ 	curveIndexForDirection As Integer _ ) As BeamSystem ``` |
