...
| C# |
| --- |
| ``` public void RemoveParameter( 	FamilyParameter familyParameter ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub RemoveParameter ( _ 	familyParameter As FamilyParameter _ ) ``` |
...
| [Autodesk.Revit.Exceptions InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.htm) | Thrown when the family parameter deletion failed. |
