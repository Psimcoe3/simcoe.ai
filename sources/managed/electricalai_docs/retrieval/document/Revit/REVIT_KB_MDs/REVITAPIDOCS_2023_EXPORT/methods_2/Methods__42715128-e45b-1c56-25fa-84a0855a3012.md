...
|  |
| --- |
| [Level Class](577e5d4e-a558-118c-9dea-3b810b061775.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [Level](577e5d4e-a558-118c-9dea-3b810b061775.htm)  type exposes the following members.
...
| Public method Static member | [Create](d661b7cd-dec8-6ae6-a753-b14ac2568772.htm) | Creates a new instance of level based on an input elevation. |
...
| Public method | [FindAssociatedPlanViewId](ff23277a-3bb1-253d-e158-983b23aaf04a.htm) | Finds the id of the first available associated floor or structural plan view associated with this level. |
...
| Public method | [GetPlaneReference](4532a1e6-9a6e-4ba3-e708-b916ec154e4b.htm) | Returns a reference to this element as a plane. |
...
| Public property | [Elevation](b5d48a18-4aa9-7457-7a6a-6d4966eaf77f.htm) | Retrieves or changes the elevation above or below the ground level. |
...
| Public property | [ProjectElevation](895ef506-bfea-cc4e-31f8-aad2af6672e4.htm) | Retrieves the elevation relative to project origin, no matter what values of the Elevation Base parameter is set. |
