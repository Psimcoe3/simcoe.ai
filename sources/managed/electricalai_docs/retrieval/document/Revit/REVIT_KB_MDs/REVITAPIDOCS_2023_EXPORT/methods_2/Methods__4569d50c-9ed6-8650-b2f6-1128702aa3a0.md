...
|  |
| --- |
| [ExportDGNSettings Class](3df10700-a305-dba7-fc4a-5afb5387256c.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [ExportDGNSettings](3df10700-a305-dba7-fc4a-5afb5387256c.htm)  type exposes the following members.
...
| Public method Static member | [Create(Document, String)](4694dfb7-7978-2597-dcdf-6bd87aee1397.htm) | Create a DGN export settings with default values. |
| Public method Static member | [Create(Document, String, DGNExportOptions)](c3e93352-1185-5202-9585-ba8e3e760a54.htm) | Create DGN export settings with specified values in DGNExportOptions. |
...
| Public method Static member | [FindByName](ca567957-39e9-3750-b515-c91bf67186d6.htm) | Returns the pre-defined non-in-session exporting settings for DGN in the given document with the specified name. |
| Public method Static member | [GetActivePredefinedSettings](36729722-5758-bb63-2645-8cadd3981b75.htm) | Returns the active pre-defined non-in-session exporting settings for DGN in the given document. |
...
| Public method | [GetDGNExportOptions](bdbe8341-e660-3e86-0cb5-03bfac3927f7.htm) | Gets the options stored in the these settings. |
...
| Public method Static member | [ListNames](1a7d76ec-3042-cb83-cb8f-8c521398c843.htm) | Returns a list of names of dgn export settings. |
...
| Public method | [SetDGNExportOptions](afc5d70c-308f-7289-8391-eaaeb116ea86.htm) | Sets the options stored in these settings. |
