...
| C# |
| --- |
| ``` public ElementId Link( 	string file, 	SATImportOptions options, 	View pDBView ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function Link ( _ 	file As String, _ 	options As SATImportOptions, _ 	pDBView As View _ ) As ElementId ``` |
