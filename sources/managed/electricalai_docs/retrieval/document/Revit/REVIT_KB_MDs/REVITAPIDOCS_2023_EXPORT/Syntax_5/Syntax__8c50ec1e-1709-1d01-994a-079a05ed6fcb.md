...
| Visual Basic |
| --- |
| ``` Public Sub SetProcessingResult ( _ 	result As FailureProcessingResult _ ) ``` |
...
result
:   Type:  [Autodesk.Revit.DB FailureProcessingResult](f147e6e6-4b2e-d61c-df9b-8b8e5ebe3fcb.htm)    
     The result.
