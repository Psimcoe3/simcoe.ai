...
|  |
| --- |
| [PointLoad Class](3f703eb6-7eac-c80e-e693-ebcdd6b35bbe.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [PointLoad](3f703eb6-7eac-c80e-e693-ebcdd6b35bbe.htm)  type exposes the following members.
...
| Public method Static member | [Create(Document, ElementId, AnalyticalElementSelector, XYZ, XYZ, PointLoadType)](f843d229-c621-6b79-e77f-77064ea7de30.htm) | Creates a new hosted point load within the project. |
| Public method Static member | [Create(Document, XYZ, XYZ, XYZ, PointLoadType, SketchPlane)](5e913c65-0515-721a-d33f-d34cd58cb664.htm) | Creates a new non-hosted point load within the project using data at point. |
...
| Public method Static member | [IsValidHostId](c5304968-914f-7e7e-ea26-ffd6e1dee6d5.htm) | Indicates if the provided host id can host point loads The document containing both the host and the load The id of the analytical panel that is about to host a point load True if a point load can be placed on the input host id |
...
| Public property | [ForceVector](b21413c1-0b57-a52a-6de4-a43e4817e169.htm) | The force vector applied to the point load, oriented according to OrientTo setting. |
...
| Public property | [MomentVector](ae7ef94a-aaa7-a5d5-a567-3108a351c177.htm) | The moment vector applied to the point load, oriented according to OrientTo setting. |
...
| Public property | [Point](65e1dc52-453d-4eda-54a2-3c8a4c100dac.htm) | Returns the position of point load, measured in decimal feet. |
