...
|  |
| --- |
| [Form Class](49f6ae4c-1629-98ef-d9a9-799bb1fd43ec.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [Form](49f6ae4c-1629-98ef-d9a9-799bb1fd43ec.htm)  type exposes the following members.
...
| Public method | [AddProfile](35a465ec-d7be-cc7d-c76c-dd10e03b7046.htm) | Add a profile into the form, by a specified edge/param. |
...
| Public method | [CanManipulateProfile](e45f9bf7-cf84-cb97-dde2-56c7a72d28a1.htm) | Tell if a profile can be deleted/moved/rotated. |
| Public method | [CanManipulateSubElement](2ec8c922-c412-4ca4-de0d-99dd6c63d54c.htm) | Tell if a sub element can be deleted/moved/rotated/scaled. |
...
| Public method | [ConstrainProfiles](6912f3a9-e563-60d3-09dd-89919583481c.htm) | Constrain form profiles using the specified profile as primary. This is an advanced version of property "AreProfilesConstrained", allowing specify the primary profile. |
...
| Public method | [DeleteProfile](79b61601-f5ee-3cc4-aefe-a6bf6750fc54.htm) | Delete a profile of the form. |
...
| Public method | [DeleteSubElement](83a0b23d-f14f-2aa2-6add-83abdb2b47ce.htm) | Delete a face/edge/curve/vertex of the form, specified by a reference. |
...
| Public method | [GetControlPoints](04cad91d-8ab0-a4cb-05e6-801266a9cdf9.htm) | Given an edge or a curve or a face, return all control points lying on it (in form of geometry references). |
| Public method | [GetCurvesAndEdgesReference](9d505fbd-7fa2-937c-d0b8-7f4d78d97b51.htm) | Given a point, return all edges and curves that it is lying on. |
...
| Public method | [GetPathCurveIndexByCurveReference](b41baa61-77f3-41d6-d46b-a772e6c8d878.htm) | Given a reference to certain curve in the path, return its index. |
...
| Public method | [GetProfileAndCurveLoopIndexFromReference](995e6f14-0e79-e21b-120b-2b4644f622c8.htm) | Given a reference to certain curve or edge, get the index of its profile and curve loop respectively. |
...
| Public method | [GetVisibility](cbacc716-ecae-cc02-005f-ee8921eafcf5.htm) | Gets the visibility for the generic form. (Inherited from  [GenericForm](d64cecab-ceec-407e-6f09-0b83f192aa1a.htm)  .) |
...
| Public method | [IsAutoCreaseEdge](753ceae9-4951-89c8-72fe-4c353490184e.htm) | Tell if an edge is an auto-crease on a top/bottom cap face. |
| Public method | [IsBeginningFace](d2342e18-d33b-b748-bab2-f28c39e70f77.htm) | Given a face, tell if it is a beginning cap face. |
| Public method | [IsConnectingEdge](b9820236-41ca-e23a-3234-54a02f9637c8.htm) | Tell if an edge is a connecting edge on a side face. Connecting edges connect vertices on different profiles. |
...
| Public method | [IsCurveReference](d94d65e3-9a76-fad0-cc3a-95526f42be63.htm) | Tell if the pick is the reference to a curve of the form. |
...
| Public method | [IsEdgeReference](a81ed4ec-7bbf-1cb9-4df2-bbefc397395d.htm) | Tell if the pick is the reference to an edge of the form. |
| Public method | [IsEndFace](67c79458-4ea0-ae6a-4e8c-2cd18b32dfd4.htm) | Given a face, tell if it is an end cap face. |
...
| Public method | [IsFaceReference](4ac6fa18-0375-70d3-a584-114c6675a18b.htm) | Tell if the pick is the reference to a face of the form. |
...
| Public method | [IsProfileEdge](380d6918-e259-c5a2-4fa2-79602bc5830e.htm) | Tell if an edge or curve is generated from a profile. |
| Public method | [IsReferenceOnlyProfile](46e4fe02-ccb4-fb95-87bd-8312eba27e5d.htm) | Tell if the profile is made by referencing existing geometry in the Revit model. |
| Public method | [IsSideFace](6232e5d4-43e9-bfdf-8531-08eb62834505.htm) | Given a face, tell if it is a side face. |
...
| Public method | [IsVertexReference](2c4dabd2-7353-b3ac-f1b6-f94e96487d27.htm) | Tell if the pick is the reference to a vertex of the form. |
...
| Public method | [MoveProfile](5276bf3d-d91c-62ea-5004-5e565c2b0ece.htm) | Move a profile of the form, specified by a reference, and an offset vector. |
| Public method | [MoveSubElement](d925ab62-52a9-d161-a4f6-56386b5177a3.htm) | Move a face/edge/curve/vertex of the form, specified by a reference, and an offset vector. |
...
| Public method | [Rehost(Reference, XYZ)](a222958c-4b12-075b-ade4-d78642c40d90.htm) | Rehost Form to edge, face or curve. |
| Public method | [Rehost(SketchPlane, XYZ)](80d96216-f5fd-0aa7-954b-33b7b0ddcf9b.htm) | Rehost Form to sketch plane |
| Public method | [RotateProfile](2a6908b6-f1ea-aa45-9890-2e5699635de6.htm) | Rotate a profile of the form, by a specified angle around a given axis. |
| Public method | [RotateSubElement](e8be996f-6174-64b5-938b-ddf0818dd81d.htm) | Rotate a face/edge/curve/vertex of the form, by a specified angle around a given axis. |
| Public method | [ScaleProfile](51b12c40-3f05-3c5a-acd1-23b017bbff1b.htm) | Scale a profile of the form, by a specified origin and scale factor. |
| Public method | [ScaleSubElement](c6f922b5-2c99-c8f7-025e-1df81f4cc480.htm) | Scale a face/edge/curve/vertex of the form, by a specified origin and scale factor. |
...
| Public method | [SetVisibility](18f097f0-2f17-6140-834f-ec513867cab8.htm) | Sets the visibility for the generic form. (Inherited from  [GenericForm](d64cecab-ceec-407e-6f09-0b83f192aa1a.htm)  .) |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AreProfilesConstrained](2b231a7a-2cff-530d-4f7b-d51b2268362e.htm) | Get/set if the form's profiles are constrained. |
...
| Public property | [BaseOffset](d8bcb330-b182-4e67-ed96-2656afa5ee7b.htm) | Retrieve/set the base offset of the form object. It is only valid for locked form. |
...
| Public property | [Combinations](c7f28a22-305c-5006-87db-2719e91e58bb.htm) | The geometry combinations that this element belongs to. (Inherited from  [CombinableElement](c88bdbbc-dbbb-0817-a358-35f8686f68a2.htm)  .) |
...
| Public property | [CurveLoopReferencesOnProfile](89c48f40-ccec-5acd-f165-06b01004e80f.htm) | The curve references in certain curve loop, specified by profile index and curve loop index. |
...
| Public property | [HasOneOrMoreReferenceProfiles](beb69916-074b-a484-0485-355b71f10582.htm) | Tell if the form has any reference profile. |
| Public property | [HasOpenGeometry](08f123dc-a066-1635-cd12-41f060a6f0c5.htm) | Tell if the form has an open geometry. |
...
| Public property | [IsInXRayMode](22f103aa-4091-87b6-aa69-6336d3b24bf7.htm) | Get/set if the form is in X-Ray mode. |
...
| Public property | [IsSolid](8d62241f-2efe-6581-4a70-83a0be66413c.htm) | Identifies if the GenericForm is a solid or a void element. (Inherited from  [GenericForm](d64cecab-ceec-407e-6f09-0b83f192aa1a.htm)  .) |
...
| Public property | [Name](0cee40b9-1197-0662-6d82-35bad7aaebc4.htm) | Get and Set the Name property (Inherited from  [GenericForm](d64cecab-ceec-407e-6f09-0b83f192aa1a.htm)  .) |
...
| Public property | [PathCurveCount](2469b633-67ff-6f8e-bb07-c427d968aba9.htm) | The number of curves in the form path. |
| Public property | [PathCurveReference](433dd986-562d-c969-98c6-7a84f7f8090e.htm) | The curve reference in the path, specified by curve index. |
...
| Public property | [ProfileCount](274746a9-4c77-3b3d-c814-a2f1384361f2.htm) | The number of profiles in the form. |
| Public property | [ProfileCurveLoopCount](5ba5320b-8200-5d21-e5b2-2e08cb72c709.htm) | The number of curve loops in certain profile, specified by profile index. |
| Public property | [Subcategory](6c43c9dd-4536-6803-87ca-a8eb76fbfa7d.htm) | The subcategory. (Inherited from  [GenericForm](d64cecab-ceec-407e-6f09-0b83f192aa1a.htm)  .) |
| Public property | [TopOffset](338aee66-8550-80b2-7782-534b8c87a7e4.htm) | Retrieve/set the top offset of the form object. It is only valid for locked form. |
...
| Public property | [Visible](22be7737-971d-902b-cec3-25d3ae694df0.htm) | The visibility of the GenericForm. (Inherited from  [GenericForm](d64cecab-ceec-407e-6f09-0b83f192aa1a.htm)  .) |
