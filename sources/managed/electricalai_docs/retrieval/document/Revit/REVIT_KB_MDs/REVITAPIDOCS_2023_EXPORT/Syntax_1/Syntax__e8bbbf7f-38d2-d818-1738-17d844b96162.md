...
| C# |
| --- |
| ``` public void ShowBubbleInView( 	DatumEnds datumEnd, 	View view ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub ShowBubbleInView ( _ 	datumEnd As DatumEnds, _ 	view As View _ ) ``` |
...
| [Autodesk.Revit.Exceptions InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.htm) | This datum plane doesn't support bubble operations. -or- This DatumPlane doesn't have bubbles shown the view. |
