...
|  |
| --- |
| [RebarCoverType Class](b90685db-d2c5-aecb-ff1f-425ca2e5fae9.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [RebarCoverType](b90685db-d2c5-aecb-ff1f-425ca2e5fae9.htm)  type exposes the following members.
...
| Public method Static member | [Create](b7419d6c-e30b-47a0-aa37-4e77e5ccac67.htm) | Creates a new CoverType in the document. |
...
| Public property | [CoverDistance](f3945293-f356-cf97-b273-7ce1ace25468.htm) | A distance that can be used as a concrete cover value in a document. |
