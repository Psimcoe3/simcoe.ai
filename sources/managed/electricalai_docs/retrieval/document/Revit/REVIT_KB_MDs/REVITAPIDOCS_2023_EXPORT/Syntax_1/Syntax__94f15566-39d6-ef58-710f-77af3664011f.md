...
| Visual Basic |
| --- |
| ``` Public ReadOnly Property PrimaryHandrailLateralOffset As Double 	Get ``` |

 

| Visual C++ |
| --- |
| ``` public: property double PrimaryHandrailLateralOffset { 	double get (); } ``` |

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.htm) | The rail has no primary hand rail. |
