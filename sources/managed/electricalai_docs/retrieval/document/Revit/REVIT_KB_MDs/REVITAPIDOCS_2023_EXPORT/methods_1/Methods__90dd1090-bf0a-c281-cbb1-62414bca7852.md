...
|  |
| --- |
| [PathReinforcement Class](1593a849-b883-73d4-7c02-a2522877d71d.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [PathReinforcement](1593a849-b883-73d4-7c02-a2522877d71d.htm)  type exposes the following members.
...
| Public method Static member | [ConvertRebarInSystemToRebars](860c0773-13e2-00be-eeb8-25afa57fe2be.htm) | Converts all RebarInSystem elements owned by the input PathReinforcement to equivalent Rebar elements. |
...
| Public method | [GetCurveElementIds](6a17f4fa-5d3a-2e3b-ce1c-fefa0dd941dd.htm) | Retrieves the set of ElementIds of curves forming the boundary of the Path Reinforcement. |
...
| Public method | [GetHostId](61909903-e670-132a-cd41-07f85ff6302b.htm) | The element that contains the Path Reinforcement. |
...
| Public method Static member | [GetOrCreateDefaultRebarShape](4db777aa-4687-e1c1-3104-0fa1c8d9e576.htm) | Creates a new RebarShape object with a default name or returns existing one which fulfills Path Reinforcement bending data requirements. |
...
| Public method | [GetRebarInSystemIds](66d7ac46-c022-c65a-0c18-4fdedb77c5f6.htm) | Returns the ids of the RebarInSystem elements owned by the PathReinforcement element. |
...
| Public method | [IsAlternatingLayerEnabled](2f3af8f8-18c1-8b9f-2ed4-2d049260af86.htm) | Checks if alternating bars are present in Path Reinforcement. |
...
| Public method | [IsSolidInView](7cf5bee8-19dd-48a8-1dcb-3c98294a3b3a.htm) | **Obsolete.**   Checks if this Path Reinforcement is shown solidly in a 3D view. |
| Public method | [IsUnobscuredInView](051a0fc5-cd26-7756-1331-d532639d5ac3.htm) | Checks if Path Reinforcement is shown unobscured in a view. |
| Public method | [IsValidAlternatingBarOrientation](8bf22e76-2e49-688a-0701-fafddc316572.htm) | Checks if orientation for alternating bars is valid. |
| Public method | [IsValidPrimaryBarOrientation](96ef910c-7689-9aaa-3637-50826bce3f54.htm) | Checks if orientation for primary bars is valid. |
| Public method Static member | [IsValidRebarShapeId](0d570de9-c041-3bf2-dff7-47720ee6ace7.htm) | Identifies whether an element id corresponds to a Rebar Shape element which can be used in Path Reinforcement. |
...
| Public method Static member | [RemovePathReinforcementSystem](f363e5b7-056b-4fa2-7b0f-388614effd85.htm) | Deletes the specified PathReinforcement, and converts its RebarInSystem elements to equivalent Rebar elements. |
...
| Public method | [SetSolidInView](9b5218da-e8c2-ff19-974f-280e26efc5c9.htm) | **Obsolete.**   Sets this Path Reinforcement to be shown solidly in a 3D view. |
| Public method | [SetUnobscuredInView](5533aeb2-dc1f-a329-165e-2107272a0fc3.htm) | Sets Path Reinforcement to be shown unobscured in a view. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [AdditionalOffset](07b9ba68-2a6f-8948-a61e-4364be70902c.htm) | Additional offset of rebars in the Path Reinforcement. |
| Public property | [AlternatingBarOrientation](eaffd4ed-4eb5-ddc9-c174-07ecaca807c2.htm) | Orientation of alternating bars of Path Reinforcement. |
| Public property | [AlternatingBarShapeId](192a6b79-2b79-b4f3-a084-8dd0940d9e42.htm) | The RebarShape element that defines the shape of the alternating bars of the Path Reinforcement. |
...
| Public property | [PathReinforcementType](01592a23-de13-fd3e-7508-55e1d83994d1.htm) | Retrieves the type of the Path Reinforcement. |
...
| Public property | [PrimaryBarOrientation](a351b2f4-2f3e-e0e4-7bb1-0fab85004fdc.htm) | Orientation of primary bars of Path Reinforcement. |
| Public property | [PrimaryBarShapeId](06e0653f-9e58-c180-67b3-cbdd74f2d345.htm) | The RebarShape element that defines the shape of the primary bars of the Path Reinforcement. |
