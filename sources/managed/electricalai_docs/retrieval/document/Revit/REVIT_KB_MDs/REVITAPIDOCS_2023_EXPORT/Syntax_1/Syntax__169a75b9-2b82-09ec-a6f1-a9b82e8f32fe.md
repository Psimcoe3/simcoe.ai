...
| C# |
| --- |
| ``` public BRepBuilderGeometryId AddLoop( 	BRepBuilderGeometryId faceId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function AddLoop ( _ 	faceId As BRepBuilderGeometryId _ ) As BRepBuilderGeometryId ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | The supplied face id doesn't correspond to a face stored in this BRepBuilder object. -or- FinishFace() has already been called on faceId. -or- Please finish the previous loop by calling FinishLoop() before adding a new one. |
