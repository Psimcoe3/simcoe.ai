...
|  |
| --- |
| [CurtainCell Class](97401874-6fa9-eac0-6190-24687861168c.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [CurveLoops](f47e5418-42e4-75c4-4d63-f2f7fca639f9.htm) | The cell boundaries on the reference face. The boundaries can have more than one CurveLoop. Each item in the returned array represents a CurveLoop containing 3 or more than 3 edges. |
...
| Public property | [PlanarizedCurveLoops](792fe81c-dba9-8f4e-9dd3-a770392f2097.htm) | The planarized curve loops for cell boundaries. The boundaries can have more than one CurveLoop. Each item in the returned array represents a CurveLoop containing 3 or more than 3 edges. |
