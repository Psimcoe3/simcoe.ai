...
| C# |
| --- |
| ``` public static IFCData CreateDoubleOfType( 	double value, 	string typeName ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateDoubleOfType ( _ 	value As Double, _ 	typeName As String _ ) As IFCData ``` |
