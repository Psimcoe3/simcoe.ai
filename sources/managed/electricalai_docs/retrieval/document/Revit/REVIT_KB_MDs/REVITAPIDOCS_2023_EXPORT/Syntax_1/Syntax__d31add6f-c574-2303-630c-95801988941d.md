...
| Visual Basic |
| --- |
| ``` Public Shared Function CreateFromIFC ( _ 	document As Document, _ 	resourceReference As ExternalResourceReference, _ 	revitLinkedFilePath As String, _ 	recreateLink As Boolean, _ 	options As RevitLinkOptions _ ) As LinkLoadResult ``` |
...
| [Autodesk.Revit.Exceptions FileArgumentNotFoundException](ca9ccaa9-ed08-d40d-31a7-1af3ad2dcb84.htm) | There is not a valid Revit file at revitLinkedFilePath's location |
