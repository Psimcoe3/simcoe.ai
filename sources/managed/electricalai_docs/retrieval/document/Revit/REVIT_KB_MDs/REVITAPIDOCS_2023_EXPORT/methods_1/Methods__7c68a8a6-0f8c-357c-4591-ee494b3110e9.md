...
|  |
| --- |
| [MultiReferenceAnnotation Class](2224ac33-d7c0-bda8-70de-0005023c2149.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [MultiReferenceAnnotation](2224ac33-d7c0-bda8-70de-0005023c2149.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method Static member | [AreElementsValidForMultiReferenceAnnotation](b49935de-bcad-70d0-cc8d-e53e4cb34031.htm) | The method validates if the input elements match the element category id for the MultiReferenceAnnotationType. |
...
| Public method Static member | [AreReferencesValidForLinearDimension](3e6aaebc-28a1-da82-8022-ec76d26122c6.htm) | If the DimensionStyleType is Linear, validates that the references are valid for an aligned multi-reference annotation. |
| Public method Static member | [AreReferencesValidForLinearFixedDimension](75111b29-eff1-c970-7f70-ba3cbcf7766e.htm) | If the DimensionStyleType is LinearFixed, validates that the references are valid for an aligned multi-reference annotation. |
...
| Public method Static member | [Create](b3646880-ef76-d0d4-68d9-2c976163c340.htm) | Creates a new MultiReferenceAnnotation. |
...
| Public method Static member | [IsLinearFixedDimensionDirectionValid](15ea4e06-bb36-6328-e456-6c4528766a23.htm) | If the DimensionStyleType is LinearFixed, this function verifies that the dimension line direction matches either the view's vertical or horizontal direction. |
...
| Public property | [DimensionId](99cb3709-901d-d73d-4e0d-4c75d3e0237e.htm) | The child dimension owned by this multi-reference annotation. |
...
| Public property | [TagId](33f7bb8b-f277-0eee-e7ec-69c53e2d21e1.htm) | The child IndependentTag owned by this multi-reference annotation. |
