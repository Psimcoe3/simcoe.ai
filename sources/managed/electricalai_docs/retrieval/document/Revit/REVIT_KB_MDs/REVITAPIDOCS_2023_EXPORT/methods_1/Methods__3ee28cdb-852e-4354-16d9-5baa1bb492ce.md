...
|  |
| --- |
| [StructuralConnectionHandler Class](78653026-36f1-6ab3-f2c0-728692c99b3c.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [StructuralConnectionHandler](78653026-36f1-6ab3-f2c0-728692c99b3c.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AddElementIds](707dc3c9-bd26-65b2-14ae-2e345c5ad977.htm) | Adds element ids to the connection. All element ids in an array should be of applicable category. |
| Public method | [AddReferences](e3df730c-4e40-92ee-714c-f2beae290839.htm) | Adds references to the connection. All references should be of applicable category. |
...
| Public method Static member | [CreateGenericConnection](887e1ee2-72cd-b3f4-0d1b-e3cfc82b0f07.htm) | Creates a new instance of a Structural Connection Handler with a generic type, which defines the connection between given elements. |
...
| Public method | [GetConnectedElementIds](0c30ce4f-eef8-fd20-529f-c7b0983998dc.htm) | Retrieves list of element ids of connected elements. |
...
| Public method | [GetInputPoint](c7a4dc5e-bc26-0987-4995-2c5d2dbcee70.htm) | Returns point with specified id. Returns null if specified point does not exist |
| Public method | [GetInputPoints](1b74c240-55f5-c1ab-1e78-57bba4090a66.htm) | Returns a list of additional points defining certain connections. |
| Public method | [GetInputReferences](64f39922-a906-19ae-bfa0-0642910eefdb.htm) | Gets references of input elements. |
...
| Public method | [GetOrigin](de922052-21bc-5958-8c4b-d4398ead0a88.htm) | Retrieves origin point of Structural Connection Handler element. |
...
| Public method | [IsCustom](f0a922df-ec34-9170-0963-86edc9243628.htm) | Checks if Structural Connection Handler has the custom connection style. |
...
| Public method | [IsDetailed](218fb7c4-0752-74ea-2403-82f24b235e00.htm) | Checks if Structural Connection Handler has the detailed connection style. |
...
| Public method | [RemoveElementIds](ae145719-5699-3f78-d995-981319b4703f.htm) | Removes element ids from the connection. All element ids in an array should belong to the connection. |
| Public method | [RemoveReferences](aded3846-21ad-e351-5c2a-c7bbfe1b0682.htm) | Removes references from the connection. All references in an array should belong to the connection. |
| Public method | [SetDefaultElementOrder](7b74ec8e-5790-0caa-5045-ef0ff72128fc.htm) | Sorts the connected elements connection according to structural categories, element materials and geometries. The steel element is set rather than an element of other material. The priorities of the elements are set according structural categories in following order: columns, framings, walls, foundations, floors. In case of several Structural Framing elements order is determined by cutting - the cutting element is set as the primary one rather than element being cut. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [ApprovalTypeId](5257d862-ab65-0c35-bdb8-b6b69b627122.htm) | Retrieves or changes approval type of the Structural Connection Handler. |
...
| Public property | [CodeCheckingStatus](2f3f13cf-6064-1b99-332e-c4d8f83e9ec1.htm) | Code checking status of the structural connection. |
...
| Public property | [OverrideTypeParams](a856e3e4-892a-104a-d87c-aadf12887abe.htm) | Allow or disallow connection's type parameters to be overridden. |
...
| Public property | [SingleElementEndIndex](2d7a6f59-79d8-d628-160b-e78365966c9f.htm) | Element end index for single element connections (0: start, 1: end). |
