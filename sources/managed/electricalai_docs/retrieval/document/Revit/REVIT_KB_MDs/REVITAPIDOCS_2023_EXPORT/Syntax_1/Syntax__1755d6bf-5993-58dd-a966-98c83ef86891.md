...
| Visual Basic |
| --- |
| ``` Public Shared Function CreateViaThicken ( _ 	curveLoop As CurveLoop, _ 	thickness As Double, _ 	normal As XYZ _ ) As CurveLoop ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | The input thickness is too short for a curve. -or- the curve loop is not marked as open. |
