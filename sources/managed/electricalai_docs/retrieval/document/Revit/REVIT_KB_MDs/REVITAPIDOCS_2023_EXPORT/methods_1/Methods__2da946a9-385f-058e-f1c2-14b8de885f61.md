...
|  |
| --- |
| [FluidType Class](6de7a895-6747-7273-55cf-19f917a30c84.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [FluidType](6de7a895-6747-7273-55cf-19f917a30c84.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AddTemperature](b45f6462-c9d6-95c1-8561-a1024020532c.htm) | Adds a fluid temperature to the set. |
...
| Public method | [ClearAllTemperatures](b530979d-4f94-bd52-0c02-83b740cf6947.htm) | Clears all fluid temperatures in the set. |
| Public method Static member | [Create(Document, String)](bda91043-7a2f-c2a6-8de4-0ac6275240fa.htm) | Creates a new empty fluid type and adds it to the document. |
| Public method Static member | [Create(Document, String, FluidType)](d8fdb108-1784-fb1b-d5b1-10d10d08148f.htm) | Creates a new fluid type and adds it to the document. |
...
| Protected method | [GetBasicIEnumerator](8036c0e2-44b5-02e2-34e3-9d84261c1f83.htm) | Returns an enumerator that iterates through a collection. |
...
| Public method | [GetEnumerator](07f0208b-99ac-a800-d161-4821a1c7bd5e.htm) | Returns an enumerator that iterates through a collection. |
...
| Public method | [GetFluidTemperatureSetIterator](890a61fc-60fe-b8bf-6f64-ebf94618493a.htm) | Returns a FluidTemperatureSetIterator that iterates through the collection. |
| Public method Static member | [GetFluidType](18596b04-d15b-c946-8a71-53914510476e.htm) | Gets a fluid type by name. |
...
| Public method | [GetTemperature](c9aa98b4-430f-d035-4e32-a0c55392c6f6.htm) | Gets a copy of the FluidTemperature object matching a given temperature value. |
...
| Public method Static member | [IsFluidInUse](8cbe2182-6144-a90a-26c6-41526bff00f4.htm) | Identifies if the fluid type is in use. |
...
| Public method | [RemoveTemperature](91ab315a-b3ba-0fae-1c52-c750037a6fe8.htm) | Removes a fluid temperature via the temperature value from the set. |
