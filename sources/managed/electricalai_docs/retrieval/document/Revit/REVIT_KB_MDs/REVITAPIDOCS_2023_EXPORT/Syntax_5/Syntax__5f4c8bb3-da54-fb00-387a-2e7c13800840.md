...
| Visual Basic |
| --- |
| ``` Public Property NosingProfile As ElementId 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property ElementId^ NosingProfile { 	ElementId^ get (); 	void set (ElementId^ value); } ``` |

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | When setting this property: The profile is neither a valid element id nor invalidElementId. -or- When setting this property: The profile is not a valid nosing profile symbol. |
