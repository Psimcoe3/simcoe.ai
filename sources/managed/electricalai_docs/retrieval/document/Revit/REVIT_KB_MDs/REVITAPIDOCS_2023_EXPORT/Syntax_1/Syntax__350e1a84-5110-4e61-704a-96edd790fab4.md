...
| C# |
| --- |
| ``` public static bool IsAdaptivePlacementPoint( 	Document doc, 	ElementId refPointId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function IsAdaptivePlacementPoint ( _ 	doc As Document, _ 	refPointId As ElementId _ ) As Boolean ``` |
