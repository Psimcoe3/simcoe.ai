...
| C# |
| --- |
| ``` public static DirectShapeLibrary GetDirectShapeLibrary( 	Document ADoc ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function GetDirectShapeLibrary ( _ 	ADoc As Document _ ) As DirectShapeLibrary ``` |
