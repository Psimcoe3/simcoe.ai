...
| C# |
| --- |
| ``` public double GetDimensionValue( 	FabricationDimensionDefinition dim ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function GetDimensionValue ( _ 	dim As FabricationDimensionDefinition _ ) As Double ``` |
