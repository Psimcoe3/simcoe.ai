...
| Visual Basic |
| --- |
| ``` Public Shared Function CreateFreeForm ( _ 	doc As Document, _ 	barType As RebarBarType, _ 	host As Element, _ 	curves As IList(Of CurveLoop), _ 	<OutAttribute> ByRef error As RebarFreeFormValidationResult _ ) As Rebar ``` |
