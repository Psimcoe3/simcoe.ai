...
| Visual Basic |
| --- |
| ``` Public Property WorkflowFile As String 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property String^ WorkflowFile { 	String^ get (); 	void set (String^ value); } ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | When setting this property: The analysis requires a valid workflow file. |
