...
| C# |
| --- |
| ``` public static string GetIFCType( 	Element element, 	ExporterIFC exporterIFC ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function GetIFCType ( _ 	element As Element, _ 	exporterIFC As ExporterIFC _ ) As String ``` |
