...
|  |
| --- |
| [ElectricalLoadClassification Class](c8aeb888-f4dd-4b93-063e-6aa118c0e471.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method Static member | [Create](323c8700-09d4-badb-06e2-d126173b2f8a.htm) | Creates a new instance of load classification and adds it to the document. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [Abbreviation](0db5b2ff-f375-c8a9-135f-c611fa1e47af.htm) | The abbreviation of the load classification name |
| Public property | [ActualElectricalLoadLabel](3fe33973-722e-d21f-b55c-7a997040ee74.htm) | The name template for the actual load parameter on the load classification. |
...
| Public property | [DemandFactorId](ae578380-e6de-dea0-dfe3-27b2bb5a6bc3.htm) | The demand factor definition this load classification element uses. |
...
| Public property | [LoadSummaryDemandFactorLabel](369f3896-80ec-fbe0-4d7b-72e27ff29ffa.htm) | The name template for the demand factor parameter of the load classification. |
...
| Public property | [Motor](8c83c855-b589-df98-0f9a-d6942f10b01d.htm) | Indicates if this load classification is to be used for motors. |
...
| Public property | [PanelConnectedCurrentLabel](6fba9d40-590f-3e3b-aaac-3a354d69c2a0.htm) | The name template for the connected current parameter on the load classification. |
| Public property | [PanelConnectedLabel](4b4f489c-273a-cefd-dbca-10fc55710fad.htm) | The name template for the connected load parameter of the load classification. |
| Public property | [PanelEstimatedCurrentLabel](c08bf3b3-a85f-e1b5-be75-a9635f46222f.htm) | The name template for the estimated current parameter on the load classification. |
| Public property | [PanelEstimatedLabel](1d2a2be1-c058-ce8a-009b-8a896040ffba.htm) | The name template for the estimated demand parameter on the load classification. |
...
| Public property | [SpaceLoadClass](514b8c66-dffc-aef1-cb67-0e2f52f9340f.htm) | The electrical load class associated with a space. |
| Public property | [Spare](d838962d-bba2-9010-1540-e57e412948ac.htm) | Indicates if this load classification is to be used for spare. |
