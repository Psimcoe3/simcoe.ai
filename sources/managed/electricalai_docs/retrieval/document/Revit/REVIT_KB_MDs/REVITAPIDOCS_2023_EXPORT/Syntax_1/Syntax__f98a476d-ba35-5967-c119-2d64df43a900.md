...
| Visual Basic |
| --- |
| ``` Public Property RightLateralOffset As Double 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property double RightLateralOffset { 	double get (); 	void set (double value); } ``` |
...
| [Autodesk.Revit.Exceptions InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.htm) | When setting this property: The right support style is not carriage(open), so this related data cannot be set. |
