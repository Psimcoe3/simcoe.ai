...
| Visual Basic |
| --- |
| ``` Public Shared Function Create ( _ 	document As Document, _ 	curveLoops As IList(Of CurveLoop), _ 	ceilingTypeId As ElementId, _ 	levelId As ElementId, _ 	slopeArrow As Line, _ 	slope As Double _ ) As Ceiling ``` |
