...
|  |
| --- |
| [StairsRun Class](ea0e49a0-a007-79d0-c902-a24b1359ae28.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method Static member | [CreateSketchedRun](bb782d95-4792-8335-401c-97170542b96b.htm) | Creates a sketched run in the project document by providing a group of boundary curves and riser curves. |
| Public method Static member | [CreateSketchedRunWithSlopeData](617ef98f-bb7b-c4ec-0342-bf2b4d743ff8.htm) | Creates a sketched run in the project document by providing a group of boundary curves and riser curves, specifying slope type and height for boundary curves. |
| Public method Static member | [CreateSpiralRun](2f31d042-a202-a1a4-42fe-998b02e26a4d.htm) | Creates a spiral run in the project document by providing the center, start angle and included angle. |
| Public method Static member | [CreateStraightRun](54fd7462-c16c-41bf-705f-ede3af0bc572.htm) | Creates a straight run in the project document. |
...
| Public method | [GetAllSupports](a860f418-9de2-3600-5105-a48be8544a41.htm) | Retrieves all supports hosted by the stair's run. |
| Public method | [GetConnections](db619f61-5444-37f9-1057-97d35caf5eed.htm) | Returns information about the connections in which the stairs run participates. The stairs run may have no connection, or have at maximum two connections at the lower and upper ends. |
...
| Public method | [GetFootprintBoundary](98862b51-f40e-d085-d574-2e6896afdb32.htm) | Returns the run's boundary curves which are projected on the stairs base level. |
...
| Public method | [GetLeftSupports](030d4d7a-26c7-c8ec-a924-d15fa74938d3.htm) | Retrieves all supports on the left side of run boundaries. |
...
| Public method | [GetNumberSystemReference](37d8b848-520b-47d1-5cad-f5c4e41c5979.htm) | Gets the number system reference corresponding to the given reference options. |
...
| Public method | [GetRightSupports](d28ad844-a878-5953-df59-5f7f092207ea.htm) | Retrieves all supports on the right side of run boundaries. |
| Public method | [GetStairs](70bc6ef7-27a5-b1a6-aada-7ffedfbf0260.htm) | Returns the stairs to which the stairs run belongs. |
| Public method | [GetStairsPath](cb460743-dc63-545e-8d88-45061f2d2abd.htm) | Returns the stairs path curves on the run. The curves are projected on base level of the stairs. |
...
| Public method Static member | [SetLocationPathForSpiralRun](f8304e58-c7a3-410c-8369-8cd313043a16.htm) | Set Location path for a spiral run. |
| Public method Static member | [SetLocationPathForStraightRun](6ff2ff5e-36ad-eb4c-2aef-4f0b5208177d.htm) | Set location path for a straight run by giving a line. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [ActualRisersNumber](96279390-3c60-17bb-30a3-6be20f235db8.htm) | The actual number of stairs risers in the stairs run. |
| Public property | [ActualRunWidth](bdf55936-55bd-fc08-ffb4-8636f9523e9d.htm) | Specifies the value of the tread width excluding the width of independent side supports. |
| Public property | [ActualTreadsNumber](14adde99-ed13-07a8-26c9-d66b6faeaa62.htm) | The actual number of stairs treads in the stairs run. |
...
| Public property | [BaseElevation](9ba0ccee-9ac2-0c0a-12de-11a14f3ae5f0.htm) | The base elevation of the stairs run. |
| Public property | [BeginsWithRiser](26a3216c-bafa-e8d3-a55d-1a3bf0a1f522.htm) | True if the stairs run begins with a riser, false otherwise. |
...
| Public property | [EndsWithRiser](e41f2154-eb17-c301-592a-30e35c982e67.htm) | True if the stairs run ends with a riser, false otherwise. |
| Public property | [ExtensionBelowRiserBase](31d69dbe-84d3-e559-20a0-f50d98c16820.htm) | Specifies a value to extend/trim the run's first step against base elevation of the stairs if the stairs begins with a riser. |
| Public property | [ExtensionBelowTreadBase](62bf2199-bce0-9eb6-62f3-5a5987586273.htm) | Specifies a value to extend/trim the run's first step against base elevation of the stairs if the stairs begins with a tread. |
...
| Public property | [Height](ec9100da-66e5-b146-f2e5-6797ec63fe89.htm) | The calculated height of the stairs run. |
...
| Public property | [LocationLineJustification](042f94e0-29af-deac-5bcd-baec4075a866.htm) | The position of the run relative to the Up-direction path used to create the run. |
...
| Public property | [StairsRunStyle](07464cfb-9532-f76a-5b25-a013dd9c93e0.htm) | The style of the stairs run such as straight, winder, etc. |
| Public property | [TopElevation](d4292003-1fe1-1eeb-20f9-a5b25acaa1eb.htm) | The top elevation of the stairs run. |
