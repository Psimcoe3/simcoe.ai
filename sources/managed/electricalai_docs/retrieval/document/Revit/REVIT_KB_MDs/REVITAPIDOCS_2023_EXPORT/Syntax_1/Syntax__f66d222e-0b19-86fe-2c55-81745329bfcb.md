...
| C# |
| --- |
| ``` public ElementId GetAssociatedGlobalParameterValue( 	Element element ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function GetAssociatedGlobalParameterValue ( _ 	element As Element _ ) As ElementId ``` |
