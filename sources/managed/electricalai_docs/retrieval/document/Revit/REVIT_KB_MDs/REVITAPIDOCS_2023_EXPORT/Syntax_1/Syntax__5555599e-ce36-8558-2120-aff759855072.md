...
| C# |
| --- |
| ``` public void SetSurfaceLayout( 	UVGridlineType gridlines, 	SpacingRuleLayout layout ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub SetSurfaceLayout ( _ 	gridlines As UVGridlineType, _ 	layout As SpacingRuleLayout _ ) ``` |
