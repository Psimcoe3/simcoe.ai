...
| C# |
| --- |
| ``` public static bool ServerSupportsAssemblyCodeData( 	ExternalResourceReference extRef ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function ServerSupportsAssemblyCodeData ( _ 	extRef As ExternalResourceReference _ ) As Boolean ``` |
