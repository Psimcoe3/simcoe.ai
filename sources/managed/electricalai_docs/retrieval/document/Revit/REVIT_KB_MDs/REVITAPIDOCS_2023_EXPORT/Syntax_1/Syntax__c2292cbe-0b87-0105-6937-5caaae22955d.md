...
| C# |
| --- |
| ``` public RebarHookOrientation GetHookOrientationAtIndex( 	int barPositionIndex, 	int end ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function GetHookOrientationAtIndex ( _ 	barPositionIndex As Integer, _ 	end As Integer _ ) As RebarHookOrientation ``` |
