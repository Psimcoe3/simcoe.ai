...
| Visual Basic |
| --- |
| ``` Public Shared Sub SwitchJoinOrder ( _ 	document As Document, _ 	firstElement As Element, _ 	secondElement As Element _ ) ``` |
...
| [Autodesk.Revit.Exceptions InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.htm) | Unable to switch the join order of these elements. |
