...
|  |
| --- |
| [TopographySurface Class](64242f41-69e1-84be-f21b-84783e81364a.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [TopographySurface](64242f41-69e1-84be-f21b-84783e81364a.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AddPoints](d918a387-2f34-5ed8-6b56-b690ca756320.htm) | Adds points to a topography surface. |
...
| Public method Static member | [ArePointsDistinct](e1a09c30-06c8-dc1f-da89-e98657e11edf.htm) | Identify whether the input points are distinct in XY location. |
| Public method | [AsSiteSubRegion](cc8e617b-fe4e-08a2-9347-cfc44e9f1abe.htm) | Obtains the subregion object represented by this element. |
...
| Public method | [ChangePointElevation](6433254d-a875-0253-def2-e0573639af3e.htm) | Changes the elevation value for a point. |
| Public method | [ChangePointsElevation](099b30df-e4c9-fe81-6a32-6a55b57994a6.htm) | Changes the elevation value for points |
...
| Public method | [ContainsPoint](d0e5a2f0-eb77-4efb-91f2-ce5428b53ab1.htm) | Identifies whether the given point exists in the topography surface. |
| Public method Static member | [Create(Document, IList XYZ )](824b6a30-f775-149f-2e6a-5198c5299d14.htm) | Creates a new topography surface element and adds it to the document. |
| Public method Static member | [Create(Document, IList XYZ , IList PolymeshFacet )](5fa47ddd-7dbd-ae8a-69bc-9e260ec56d99.htm) | Creates a new topography surface element from facets and adds it to the document. |
...
| Public method | [DeletePoints](06206e0f-db70-d184-1f13-d9a787e8fd98.htm) | Deletes points from a Topography surface. |
...
| Public method | [FindPoints](b76317e1-c51f-8c51-28d4-e9488dc468d4.htm) | Filters and returns only the points of the topography surface which lie within the input bounding box. |
| Public method | [GetBoundaryPoints](f34dbefb-94de-43e8-967d-8662f6593dac.htm) | Gets the points which are on the boundary of the topography surface. |
...
| Public method | [GetHostedSubRegionIds](e491ee31-108d-a79a-267e-2fe01a0d5065.htm) | Gets the ids of all subregion elements hosted on this topography surface. |
| Public method | [GetInteriorPoints](b32902d7-16d8-58ca-ed8f-7229f6734276.htm) | Gets all of the points that are not boundary points for the topography surface. |
...
| Public method | [GetPoints](f2fbdda9-c064-4167-7b4a-3a7e3086cf69.htm) | Gets the points that define this topography surface. |
...
| Public method | [IsBoundaryPoint](e9bceb03-79f8-d0e6-0216-39eb0993addf.htm) | Identifies whether the given point is an existing boundary point of the current topography surface. |
...
| Public method Static member | [IsValidFaceSet](327b0f6c-951f-93aa-f22a-271ebb118f89.htm) | Identifies whether the facets can construct a valid topography surface. |
| Public method Static member | [IsValidRegion](a0aa044c-9935-6a6b-1d59-a4a380685920.htm) | Identify whether the points can construct a valid region for a topography surface. |
...
| Public method | [MovePoint](3068f86b-519e-55b4-f571-26ed441f3836.htm) | Moves a point in a TopographySurface to a new designated location. |
| Public method | [MovePoints](189b0ff1-9666-b875-eeb9-dbd12dc5013f.htm) | Moves a collection of points in a topography surface by a designated vector. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [ArePointsEditable](5f106a73-01ff-9460-fb7a-58033451dded.htm) | Identifies whether the points of this topography surface can be edited independently. Topography surfaces created from external data will not allow editing of individual points. |
...
| Public property | [AssociatedBuildingPadId](87a734f3-ccd0-78cc-a2f5-f5f2ef6fb9be.htm) | The element id of the building pad which causes this topography surface to be formed. |
...
| Public property | [IsAssociatedWithBuildingPad](b1271349-2f66-dd23-94b5-0f6e5d19d680.htm) | Identifies if this element represents a topography surface associated with a building pad. |
...
| Public property | [IsSiteSubRegion](0b588314-98cf-1c23-9cbc-631ebcaff784.htm) | Identifies if this element represents a subregion. |
...
| Public property | [MaterialId](d3404230-355c-c1d3-abe9-a66a7eefcdc2.htm) | The id of the material applied to this element. |
