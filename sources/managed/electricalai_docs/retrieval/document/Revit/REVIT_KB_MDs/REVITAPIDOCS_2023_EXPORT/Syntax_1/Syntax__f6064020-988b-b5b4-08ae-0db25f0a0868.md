...
| Visual Basic |
| --- |
| ``` Public Function GetTransformedCenterlineCurves ( _ 	adjustForSelfIntersection As Boolean, _ 	suppressHooks As Boolean, _ 	suppressBendRadius As Boolean, _ 	barPositionIndex As Integer _ ) As IList(Of Curve) ``` |
