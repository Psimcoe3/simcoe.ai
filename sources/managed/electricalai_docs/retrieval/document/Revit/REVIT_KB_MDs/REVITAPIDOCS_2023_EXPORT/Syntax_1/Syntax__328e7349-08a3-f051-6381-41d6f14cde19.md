...
| C# |
| --- |
| ``` public void SetComponents( 	IList<LoadComponent> components ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub SetComponents ( _ 	components As IList(Of LoadComponent) _ ) ``` |
...
components
:   Type:  System.Collections.Generic IList   [LoadComponent](62ee3920-2a87-4fd1-d9e8-af9655d04456.htm)    
