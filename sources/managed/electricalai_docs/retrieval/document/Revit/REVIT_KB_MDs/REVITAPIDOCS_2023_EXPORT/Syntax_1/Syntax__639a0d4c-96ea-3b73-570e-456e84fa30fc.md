...
| C# |
| --- |
| ``` public TableCellCalculatedValueData GetCellCalculatedValue( 	int nRow, 	int nCol ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function GetCellCalculatedValue ( _ 	nRow As Integer, _ 	nCol As Integer _ ) As TableCellCalculatedValueData ``` |
