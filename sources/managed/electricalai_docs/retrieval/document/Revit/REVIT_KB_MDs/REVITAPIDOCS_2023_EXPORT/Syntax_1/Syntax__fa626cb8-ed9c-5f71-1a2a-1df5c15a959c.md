...
| Visual Basic |
| --- |
| ``` Public Property DimensionLineDirection As XYZ 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property XYZ^ DimensionLineDirection { 	XYZ^ get (); 	void set (XYZ^ value); } ``` |
...
| [Autodesk.Revit.Exceptions ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.htm) | When setting this property: dimensionLineDirection is not length 1.0. |
