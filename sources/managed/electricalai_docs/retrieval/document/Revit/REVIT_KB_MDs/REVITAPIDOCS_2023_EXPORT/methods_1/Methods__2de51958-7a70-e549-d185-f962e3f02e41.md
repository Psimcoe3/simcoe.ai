...
|  |
| --- |
| [MultiReferenceAnnotationType Class](046b4d91-40b3-4dd0-be1b-635fb30956c2.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [MultiReferenceAnnotationType](046b4d91-40b3-4dd0-be1b-635fb30956c2.htm)  type exposes the following members.
...
| Public method Static member | [CreateDefault](25edda1f-9be3-5f7e-2d3b-255293c08b2a.htm) | Creates the first MultiReferenceAnnotationType element and adds it to the document. |
...
| Public method | [GetAllowedTagCategory](06cf5deb-d580-4ce1-f0fd-a17b5558b3c9.htm) | Returns the category ID for the tag types which can be used by this multi-reference annotation type. |
...
| Public method | [IsAllowedDimensionStyle](d55188f4-3723-7444-8086-5c23e58333ed.htm) | Checks if the dimension style can be used with multi-reference annotations. |
| Public method | [IsAllowedReferenceCategory](44d8f0d4-67f2-3c2a-0941-350401e9ec9b.htm) | Checks if the reference category can be used with multi-reference annotations. |
| Public method Static member | [IsAllowedTagCategory](2bff739f-d084-8596-0633-28013e778e6c.htm) | Returns true if tag types belonging to this category can be used with multi-reference annotation types. |
| Public method | [IsAllowedTagType](4f7f0cf5-ed38-ec2c-cfc9-7568b29a4601.htm) | Checks if the tag type can be assigned to this multi-reference annotation type. |
...
| Public property | [DimensionStyleId](2849b4f5-70fd-747b-e31c-d286ee518645.htm) | The dimension style which will be used by the child dimension of the multi-reference annotation. |
...
| Public property | [GroupTagHeads](c8bbdb4c-9c69-b4b8-7382-c3d9f54f380c.htm) | Controls if parameter values for the annotation's references will be reported in one grouped tag head or if every reference will get its own tag head. |
...
| Public property | [ReferenceCategoryId](5d89b166-9eb2-924b-7c8b-ec41508825d0.htm) | The category of elements to which this annotation applies. |
| Public property | [ShowDimensionText](48eb0247-c2f6-ea03-b347-f9d999662428.htm) | Controls if text from the multi-reference annotation's dimension will be shown. |
| Public property | [TagTypeId](27b53b40-5506-9a4a-321a-cd8db9b09ceb.htm) | The tag type which will be used by the child tag the multi-reference annotation. |
