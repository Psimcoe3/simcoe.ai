...
|  |
| --- |
| [AnalysisDisplayStyle Class](927357e1-9874-8b73-72c8-ff2bb78bfa82.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method Static member | [CreateAnalysisDisplayStyle(Document, String, AnalysisDisplayDiagramSettings, AnalysisDisplayColorSettings, AnalysisDisplayLegendSettings)](dae780a2-bbbc-500f-6da0-4f8f4863d67c.htm) | Factory method - creates analysis display style object of type Diagram for the given document. |
...
| Public method Static member | [CreateAnalysisDisplayStyle(Document, String, AnalysisDisplayVectorSettings, AnalysisDisplayColorSettings, AnalysisDisplayLegendSettings)](86c163a1-4064-d171-de8d-7ab8ca5e8af5.htm) | Factory method - creates analysis display style object of type Vectors for the given document. |
...
| Public method Static member | [FindByName](f83830e4-d802-a189-7e1f-9402d71e971d.htm) | Finds analysis display style by name. |
| Public method | [GetColoredSurfaceSettings](9d153cac-e6d9-ef6d-d123-694099ef2ef6.htm) | Get colored surface settings object from the style. |
| Public method | [GetColorSettings](39084694-2f09-5348-d224-34bd26dcc63d.htm) | Get color settings object from the style. |
| Public method | [GetDeformedShapeSettings](7649f0c1-7724-e74c-c98f-4cdf3954f658.htm) | Get deformed shape settings object from the style. |
...
| Public method | [GetDiagramSettings](4da4bb7d-8e9a-ac26-0574-dd65188c4374.htm) | Get diagram settings object from the style. |
| Public method Static member | [GetElements](aef1d924-fbe9-7909-3cca-4d6fe4042198.htm) | Returns set of all analysis display styles elements in the given document. |
...
| Public method | [GetLegendSettings](6cfa8710-83b5-1619-2a2f-18b24fc6912e.htm) | Get legend settings object from the style. |
| Public method | [GetMarkersAndTextSettings](ae9345e9-d6ce-50d4-7c9c-3f27c7253d88.htm) | Get markers and text settings object from the style. |
...
| Public method | [GetVectorSettings](8282d13b-225b-7499-a8a2-d9c684913389.htm) | Get vector settings object from the style. |
| Public method | [HasColoredSurfaceSettings](21362785-8b7e-9246-4c00-646271bd2207.htm) | If true style has colored surface settings. |
| Public method | [HasDeformedShapeSettings](1f0d7b6d-dd0e-fd50-7195-64abdb409b4f.htm) | If true style has deformed shape settings. |
| Public method | [HasDiagramSettings](39305b90-7e90-0393-032e-595a147d4ae2.htm) | If true style has diagram settings. |
| Public method | [HasMarkersAndTextSettings](b46418f4-b80f-9910-3c9f-53bf5adc8c13.htm) | If true style has markers and text settings. |
...
| Public method | [HasVectorSettings](8b867913-8b3b-a871-249a-79be0514240f.htm) | If true style has vector settings. |
...
| Public method Static member | [IsNameUnique](9e28e09e-31d2-fd52-57d7-1c50715a631c.htm) | Verify the uniqueness of the name among all analysis display style elements of the document. |
...
| Public method Static member | [IsTextTypeIdValid](bf01d634-9d7c-9bc5-330a-0d883ae92e12.htm) | Verify if text type id is valid. |
...
| Public method | [SetColoredSurfaceSettings](40616a4b-f378-83e8-33fe-e3267694d11d.htm) | Set colored surface settings object for the style. |
| Public method | [SetColorSettings](0c668426-1570-4bbd-6706-611c1a7903d8.htm) | Set color settings object for the style. |
| Public method | [SetDeformedShapeSettings](9da27661-c81e-0343-cca3-2ae3a8e90f41.htm) | Set deformed shape settings object for the style. |
| Public method | [SetDiagramSettings](bae5dfd5-548c-212d-5a73-45f62ea839de.htm) | Set diagram settings object for the style. |
...
| Public method | [SetLegendSettings](5f064028-6655-ec4b-3b3c-686ec59ea3c1.htm) | Set legend settings object for the style. |
| Public method | [SetMarkersAndTextSettings](4e164aee-d8cb-2201-8a6a-52837cc6342e.htm) | Set markers and text settings object for the style. |
| Public method | [SetName](1df4c7d0-2a04-4a22-4e88-0d50b9c54169.htm) | Set name of analysis display style element. |
| Public method | [SetVectorSettings](02ebf3f0-e9fb-8091-a65d-3fa2a5b6f869.htm) | Set vector settings object for the style. |
