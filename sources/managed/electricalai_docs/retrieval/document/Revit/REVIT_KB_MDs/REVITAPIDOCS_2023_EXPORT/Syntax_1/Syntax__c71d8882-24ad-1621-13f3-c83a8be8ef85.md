...
| C# |
| --- |
| ``` public ElementId Import( 	string file, 	SATImportOptions options, 	View pDBView ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function Import ( _ 	file As String, _ 	options As SATImportOptions, _ 	pDBView As View _ ) As ElementId ``` |
