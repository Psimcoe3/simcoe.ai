...
|  |
| --- |
| [ConceptualConstructionType Class](59d96c60-67ae-cb70-d3a6-59e18a434eca.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [ConceptualConstructionType](59d96c60-67ae-cb70-d3a6-59e18a434eca.htm)  type exposes the following members.
...
| Public method Static member | [GetAllConceptualConstructionsForCategory](3752bcdb-0982-44cc-e31c-2c2ccf4c86e9.htm) | Get all the ids of constructions applicable to the input massSubCategory |
...
| Public method Static member | [GetFloorOrSlabConstructionType](4a20ade5-4456-b707-679e-ee4ef9e98b1f.htm) | Get a Floor or Slab ConceptualConstructionType by its ConceptualConstructionFloorSlabType. |
| Public method | [GetGBSId](75f60a0b-3afa-13b7-559a-b70122c92fad.htm) | Gets the Green Building Studio identifier associated with the construction. |
...
| Public method Static member | [GetOpeningConstructionType](e8d1aefe-8978-d5af-706c-44a8b79027a1.htm) | Get an Opening ConceptualConstructionType by its ConceptualConstructionOpeningType. |
...
| Public method Static member | [GetRoofConstructionType](a7f16a35-0726-2a8b-369f-c64031c90e83.htm) | Get a Roof ConceptualConstructionType by its ConceptualConstructionRoofType. |
| Public method Static member | [GetShadeConstructionType](363f5434-3f4a-5748-80f8-3279ee1d1067.htm) | Get a Shade ConceptualConstructionType by its ConceptualConstructionShadeType. |
...
| Public method Static member | [GetWallConstructionType](e331e491-dfd1-0eb5-a9bf-66ee72297d9e.htm) | Get a Wall ConceptualConstructionType by its ConceptualConstructionWallType. |
| Public method Static member | [GetWindowOrSkylightConstructionType](5ff744e9-1b68-ac93-4731-68b304548ce8.htm) | Get a Window or Skylight ConceptualConstructionType by its ConceptualConstructionWindowSkylightType. |
...
| Public method Static member | [IsValidConceptualConstructionId](220c0588-536a-5806-6d35-54dbb4110ef2.htm) | Indicates if the ElementId is an id of a ConceptualConstructionType. |
| Public method Static member | [IsValidConceptualConstructionIdForCategory](eaeb8997-5870-bd9a-6a41-58de6834e2cb.htm) | Indicate if a ConceptualConstruction is appropriate to assign to a MassSurfaceData of a particular Mass subcategory. |
...
| Public method Static member | [IsValidSubcategoryForMassSurfaceDatas](75031bc8-15f5-cb88-1275-cb7d88ab04e4.htm) | Validate if a subcategory is appropriate for assignment to Massing surfaces (MassSurfaceData). This is the list of acceptable values:  1. OST\_MassInteriorWall 2. OST\_MassExteriorWall 3. OST\_MassExteriorWallUnderground 4. OST\_MassRoof 5. OST\_MassFloor 6. OST\_MassSlab 7. OST\_MassShade 8. OST\_MassGlazing 9. OST\_MassSkylights 10. OST\_MassOpening |
| Public method | [IsValidSurfaceSubcategoryForConstruction](5f71a8d2-2c1f-427b-818b-139f01f33db5.htm) | Indicates if this ConceptualConstructionType is appropriate for the input MassSurfaceData subcategory. |
...
| Public property | [MassSurfaceSubCategoryId](7ab3f987-cb65-4c2f-0f9f-e0f74e29416d.htm) | The surface type subcategory element id associated with the ConceptualConstructionType. |
| Public property | [MaterialId](84212ac3-afd4-e6a8-1a8e-9830d78da630.htm) | Material used for visualization of this construction. |
