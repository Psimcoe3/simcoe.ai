...
|  |
| --- |
| [PipingSystem Class](6abbdfa2-69a5-eef1-2663-89a5faf91831.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [PipingSystem](6abbdfa2-69a5-eef1-2663-89a5faf91831.htm)  type exposes the following members.
...
| Public method Static member | [CanBeHydraulicLoopBoundary](4547afe6-e906-85f1-df6e-a7100eeae62f.htm) | Checks if the element can be used as a hydraulic loop boundary. |
...
| Public method Static member | [Create(Document, ElementId)](130a3ca6-58fc-3548-bfe8-473e51fa736b.htm) | Creates a new instance of a piping system and adds it to the document. |
| Public method Static member | [Create(Document, ElementId, String)](bdfb862c-8547-1f6b-50fe-f28b40a50689.htm) | Creates a new instance of a piping system and adds it to the document. |
| Public method Static member | [CreateHydraulicSeparation](26d64a31-4fb6-cc54-af42-fc2bc1db479d.htm) | Creates new system which is hydraulically separated from the existing system. |
...
| Public method Static member | [DeleteHydraulicSeparation](5524b379-b150-2181-3a33-d985ff2aa81f.htm) | Deletes hydraulically separated systems and merges the system components into the connected system. |
...
| Public method | [GetFixtureUnits](ca222d0d-8eb9-2a9c-625b-3c243e0d9c29.htm) | Gets the fixture units of this piping system. |
| Public method | [GetFlow](949e7120-6845-a62f-6156-b0504e243f84.htm) | Gets the flow of this piping system. |
...
| Public method | [GetPumpSets](2a46ea1c-73e9-a258-4ad4-239a9011f7e9.htm) | Gets the set of element Id's for all pump sets in the system, if any. |
...
| Public method | [GetStaticPressure](f50549b4-7aca-2766-36bb-aa6b53dfb5f5.htm) | Gets the static pressure of this piping system. |
...
| Public method | [GetVolume](2d77154e-9741-3cf9-d239-fae91b3735b4.htm) | Gets the volume of this piping system. |
...
| Public method | [IsFlowServerMissing](bfdbd8f4-f15a-e58b-2bd0-473d75f9fa6c.htm) | Indicates if any flow server which was used in the piping system is not available. |
...
| Public method Static member | [IsHydraulicLoopBoundary](7b33e27d-98c2-82de-2dd8-a2c4969e09e3.htm) | Checks if the element is a valid hydraulic loop boundary. |
...
| Public method | [IsPressureDropServerMissing](15b75922-cc13-8780-63a3-c024b89e6121.htm) | Indicates if any pressure drop server which was used in the piping system is not available. |
...
| Public property | [BaseEquipmentConnector](15ef1a11-38c9-04ca-a75d-92d63f129047.htm) | The connector within base equipment which is used to connect with system. |
...
| Public property | [IsWellConnected](cfeb4015-ae73-b0f7-fe1c-f8b603ff446e.htm) | Indicates if the system is well connected or not. |
...
| Public property | [PipingNetwork](fd5c6d0f-3c77-6afd-a752-5ee7c7b8e1a1.htm) | Pipes and fittings which are contained in this system. |
...
| Public property | [SystemType](b667a00d-e76c-240c-99b0-354fd0eb12fc.htm) | The type of this piping system. |
