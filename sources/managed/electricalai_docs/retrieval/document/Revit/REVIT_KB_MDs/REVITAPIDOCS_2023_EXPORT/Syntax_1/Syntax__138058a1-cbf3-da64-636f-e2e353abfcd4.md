...
| Visual Basic |
| --- |
| ``` Public Function NewFamilyInstanceCreationData ( _ 	location As XYZ, _ 	symbol As FamilySymbol, _ 	host As Element, _ 	structuralType As StructuralType _ ) As FamilyInstanceCreationData ``` |
