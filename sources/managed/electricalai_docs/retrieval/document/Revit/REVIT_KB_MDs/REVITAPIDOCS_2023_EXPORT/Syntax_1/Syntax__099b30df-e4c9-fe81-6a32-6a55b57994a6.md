...
| C# |
| --- |
| ``` public void ChangePointsElevation( 	IList<XYZ> points, 	double elevationValue ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub ChangePointsElevation ( _ 	points As IList(Of XYZ), _ 	elevationValue As Double _ ) ``` |
...
| [Autodesk.Revit.Exceptions ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.htm) | The given value for elevationValue must be no more than 30000 feet in absolute value. |
