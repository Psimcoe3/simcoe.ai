...
| C# |
| --- |
| ``` public static RadialArray Create( 	Document aDoc, 	View dBView, 	ElementId id, 	int count, 	Line axis, 	double angle, 	ArrayAnchorMember anchorMember ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function Create ( _ 	aDoc As Document, _ 	dBView As View, _ 	id As ElementId, _ 	count As Integer, _ 	axis As Line, _ 	angle As Double, _ 	anchorMember As ArrayAnchorMember _ ) As RadialArray ``` |
