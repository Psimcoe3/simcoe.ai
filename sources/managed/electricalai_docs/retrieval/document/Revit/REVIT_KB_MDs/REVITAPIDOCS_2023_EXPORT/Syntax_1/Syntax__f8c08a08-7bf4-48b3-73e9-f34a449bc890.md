...
| C# |
| --- |
| ``` public static IFCGeometryInfo CreateSurfaceGeometryInfo( 	double epsilon ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateSurfaceGeometryInfo ( _ 	epsilon As Double _ ) As IFCGeometryInfo ``` |
