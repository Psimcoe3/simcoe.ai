...
| C# |
| --- |
| ``` public static ExternalResourceReference CreateLocalResource( 	Document doc, 	ExternalResourceType resourceType, 	ModelPath path, 	PathType pathType ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateLocalResource ( _ 	doc As Document, _ 	resourceType As ExternalResourceType, _ 	path As ModelPath, _ 	pathType As PathType _ ) As ExternalResourceReference ``` |
