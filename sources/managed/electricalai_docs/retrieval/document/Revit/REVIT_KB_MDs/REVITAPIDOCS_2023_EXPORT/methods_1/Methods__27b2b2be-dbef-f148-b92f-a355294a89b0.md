...
|  |
| --- |
| [AnalyticalToPhysicalAssociationManager Class](0f7f395b-3f70-aa6e-e584-b70c11f767ad.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [AnalyticalToPhysicalAssociationManager](0f7f395b-3f70-aa6e-e584-b70c11f767ad.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AddAssociation](99f09bfb-736a-901f-f22d-1f64baab8243.htm) | Adds a new association between an analytical element and a physical element. |
...
| Public method Static member | [GetAnalyticalToPhysicalAssociationManager](a0df87ca-af1c-a17f-7f8c-e6a7af41a267.htm) | Returns the AnalyticalToPhysicalAssociationManager for this document. |
| Public method | [GetAssociatedElementId](59274411-94e7-633b-2d9e-8989a903cc48.htm) | Returns id of the element which is in association with the element with the given ElementId. |
...
| Public method | [HasAssociation](2534dbba-e2c6-e85d-5b96-c7b610993b15.htm) | Verifies if the element has already defined an association. |
...
| Public method | [RemoveAssociation](05d00613-cf7f-ea84-61a4-b6ce4805dafd.htm) | This method will remove the association for the element with the given ElementId. |
