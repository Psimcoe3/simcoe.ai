...
#### NoAnalyticalElemensLeftInExistingRelationship Property
...
| Visual Basic |
| --- |
| ``` Public Shared ReadOnly Property NoAnalyticalElemensLeftInExistingRelationship As FailureDefinitionId 	Get ``` |

 

| Visual C++ |
| --- |
| ``` public: static property FailureDefinitionId^ NoAnalyticalElemensLeftInExistingRelationship { 	FailureDefinitionId^ get (); } ``` |
