...
| Visual Basic |
| --- |
| ``` Public Shared Function GetLiningIds ( _ 	document As Document, _ 	elemId As ElementId _ ) As ICollection(Of ElementId) ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | This id does not represent a duct, fitting, or accessory element. |
