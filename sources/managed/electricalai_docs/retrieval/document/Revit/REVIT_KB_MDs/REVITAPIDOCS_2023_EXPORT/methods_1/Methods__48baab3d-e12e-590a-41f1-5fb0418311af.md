...
|  |
| --- |
| [ElectricalAnalyticalNode Class](562d1f7d-c9df-bee5-4659-4f8607ee4333.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [ElectricalAnalyticalNode](562d1f7d-c9df-bee5-4659-4f8607ee4333.htm)  type exposes the following members.
...
| Public method | [CanConnectToUpstreamNode](9a2c6050-dcab-dff8-96bb-35183a60ddf7.htm) | Verifies that the current node can connect to the upstream node. |
...
| Public method | [CanDisconnectFromUpstreamNode](a5d77780-b6e8-6657-b0b1-e629bd145ee6.htm) | Verifies that the current node can disconnect from the upstream node. |
...
| Public method | [ConnectToUpstreamNode](ff97d96b-a3ed-7ad6-c428-a4a274088c9a.htm) | Connects to upstream node. |
| Public method Static member | [Create](c751bc8b-9141-efbb-3b86-1be8b94a8c69.htm) | Creates an electrical analytical node. |
...
| Public method | [DisconnectFromUpstreamNode](9d1cdc60-34df-2ca6-8022-8742731743a1.htm) | Disconnects from upstream node. |
...
| Public method | [GetAnalyticalPropertyData](1b6aa6c7-35a8-46cf-8e05-efa5665f8f5d.htm) | Gets the electrical analytical node property data,    a null reference (  Nothing  in Visual Basic)  if not available. |
...
| Public method | [GetDownstreamNodeIds](5ff642a5-6bb9-fc6f-6b1a-52f337a9be5d.htm) | Gets the downstream node ids. |
...
| Public method | [GetUpstreamNodeIds](8f3adbf1-ccaa-dc1f-8440-a8cdf9ba747c.htm) | Gets upstream node ids. |
...
| Public property | [NodeType](69a337fb-627e-d669-de4e-91dcad69c541.htm) | The type of electrical analytical node. |
...
| Public property | [TotalLoad](1fe925a7-744c-52cc-956f-7590167d1046.htm) | The Total Connected Load. |
