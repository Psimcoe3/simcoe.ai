...
| C# |
| --- |
| ``` public IList<TableCellCombinedParameterData> GetCellCombinedParameters( 	int nCol ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function GetCellCombinedParameters ( _ 	nCol As Integer _ ) As IList(Of TableCellCombinedParameterData) ``` |
