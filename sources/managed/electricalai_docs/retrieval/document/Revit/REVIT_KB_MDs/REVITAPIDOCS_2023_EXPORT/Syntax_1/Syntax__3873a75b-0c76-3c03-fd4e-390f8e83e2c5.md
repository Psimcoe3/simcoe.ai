...
| C# |
| --- |
| ``` public bool RemoveIntersectingReference( 	ElementId intersectingReference ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function RemoveIntersectingReference ( _ 	intersectingReference As ElementId _ ) As Boolean ``` |
