...
| C# |
| --- |
| ``` public static bool CheckRangeOfSliverSpaceTolerance( 	double silverSpaceTolerance ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CheckRangeOfSliverSpaceTolerance ( _ 	silverSpaceTolerance As Double _ ) As Boolean ``` |
