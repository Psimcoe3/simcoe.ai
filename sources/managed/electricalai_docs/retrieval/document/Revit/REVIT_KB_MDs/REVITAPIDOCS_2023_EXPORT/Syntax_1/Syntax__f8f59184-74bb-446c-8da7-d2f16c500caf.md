...
In one section, all section members have same velocity. Default unit is Feet per second. For Duct, unit type is UT\_HVAC\_Velocity. For Pipe, unit type is UT\_Piping\_Velocity
