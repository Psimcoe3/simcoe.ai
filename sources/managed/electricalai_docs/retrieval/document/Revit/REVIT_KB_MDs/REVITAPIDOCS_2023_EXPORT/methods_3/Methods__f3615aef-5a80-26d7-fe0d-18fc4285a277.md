...
|  |
| --- |
| [Family Class](f51d019d-6ff3-692b-d1d2-b497cab564de.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method | [CanHaveStructuralSection](75ba21e6-72ec-de95-5e45-8d20630260e3.htm) | Identifies if this Family can have a structural section. |
...
| Public method Static member | [CanLoadFamilies](f9fbccbe-7727-69b5-6253-dcedbbedafde.htm) | Checks whether the document is in a state that allows the loading of families. |
...
| Public method | [ExtractPartAtom](d477cf8f-0dfe-4055-a787-315c84ef5530.htm) | Writes a PartAtom XML from the contents of a family object. |
...
| Public method | [GetFamilySymbolIds](8989a269-c516-0ace-5365-864a61df1103.htm) | Gets the ids of the FamilySymbols owned by this Family. |
| Public method | [GetFamilyTypeParameterValues](a9c8ff23-17ec-1b87-e58a-4be589217766.htm) | Returns all applicable values for a FamilyType parameter of this family. |
...
| Public method | [HasLargeSketches](c49820d6-d8f2-de9a-544d-f896a32e39c8.htm) | Checks whether the family contains sketches with a large number of elements. |
...
| Public method | [IsAppropriateCategoryId](430baffa-8a85-0745-5c37-72ae41386b74.htm) | Identifies if the input category id can be assigned as the new category for this family. |
...
| Public property | [CurtainPanelHorizontalSpacing](4dc5e3ce-5241-551b-e27b-f488d4f87269.htm) | For Curtain Panel families, the horizontal spacing of the driving mesh. |
| Public property | [CurtainPanelTilePattern](7f206977-92a7-b92d-98e6-8b314c742bc8.htm) | For Curtain Panel families, the choice of tile pattern. |
| Public property | [CurtainPanelVerticalSpacing](a739a1d1-b06e-d6f9-0c2c-da31b28568eb.htm) | For Curtain Panel families, the vertical spacing of the driving mesh. |
...
| Public property | [FamilyCategory](e00c2b8b-b92d-526b-11b6-71c7e1d5d1b7.htm) | Retrieves or sets a Category object that represents the category or sub category in which the elements ( this family could generate ) reside. |
| Public property | [FamilyCategoryId](c1e0b7fa-8ea0-b6f6-a300-4c3e231bdb95.htm) | The id of the category or sub category in which the elements that this family could generate reside. |
| Public property | [FamilyPlacementType](7fcd2fda-21c3-9b9b-8ef3-ae2e53e02a05.htm) | Identifies the type of placement required by a given family. |
...
| Public property | [IsConceptualMassFamily](4941e795-86ed-3590-f236-f435588747b2.htm) | Whether the Family is a Conceptual Mass family. |
| Public property | [IsCurtainPanelFamily](da0becae-cb65-fffd-1e97-b4aab5533004.htm) | Whether the Family is a Curtain Panel family. Curtain Panel family symbols are used as the ObjectTypes of  [DividedSurface](782e1ac7-4e74-9a32-6b03-0a20f7d55217.htm)  elements. |
| Public property | [IsEditable](d7d3ef05-d2bd-b770-47df-96b7fd280f9f.htm) | True if the family supports editing, false otherwise. |
| Public property | [IsInPlace](eb138fd5-6092-5257-e6e1-073013cb8582.htm) | True if the family is an in-place family, false if the family is a loadable family. |
...
| Public property | [IsOwnerFamily](f4a13e1e-dbfc-923a-7492-8203deb46a53.htm) | True if the family is the owner family for its own editable document, false otherwise. |
| Public property | [IsParametric](1d4166dd-057d-9d9b-e28f-7bd250bbe587.htm) | Identifies whether the family contains parametric relations between some of its elements. |
...
| Public property | [IsUserCreated](074099dc-3e29-1a4b-1768-2e59f865cf10.htm) | Determine whether the family has been defined by the user. |
...
| Public property | [ShowSpatialElementCalculationPoint](aa96a732-8680-f9b3-58d3-4b4ea05633f2.htm) | For families that can have a calculation point for spatial elements, hide or show the calculation point.  [SpatialElementCalculationPoint](01206063-c774-da20-48ef-2cabf599e106.htm)  elements. |
| Public property | [StructuralCodeName](f17d5d2b-e799-947f-8c19-2fd56c55b426.htm) | The family's structural code name. |
| Public property | [StructuralFamilyNameKey](ae168be8-b154-fad1-72f4-6133d17ca74d.htm) | The family's structural section shape name key. |
| Public property | [StructuralMaterialType](b8770014-b218-1b8d-c996-d722828429f4.htm) | The family's structural material type. |
| Public property | [StructuralSectionShape](dd92fb5d-7aca-13c1-7402-2f67efba64ec.htm) | The family's structural section shape. |
