...
| C# |
| --- |
| ``` public static FilterRule CreateNotEqualsRule( 	ElementId parameter, 	string value ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateNotEqualsRule ( _ 	parameter As ElementId, _ 	value As String _ ) As FilterRule ``` |
