...
| C# |
| --- |
| ``` public LinkLoadResult LoadFrom( 	ExternalResourceReference resourceReference, 	WorksetConfiguration config ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Function LoadFrom ( _ 	resourceReference As ExternalResourceReference, _ 	config As WorksetConfiguration _ ) As LinkLoadResult ``` |
