...
|  |
| --- |
| [StartingViewSettings Class](aaa6f49c-faeb-851e-45e9-d3d5799c1753.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [StartingViewSettings](aaa6f49c-faeb-851e-45e9-d3d5799c1753.htm)  type exposes the following members.
...
| Public method Static member | [GetStartingViewSettings](84788ba0-4edd-5483-eb22-898dbc21520b.htm) | Returns the starting view settings for the specified document. |
...
| Public method | [IsAcceptableStartingView](7118b9ba-d29e-78d2-9293-705de4726980.htm) | Checks whether the given Id is an acceptable starting view. InvalidElementId corresponds to "Last Viewed" and is therefore also acceptable. |
...
| Public property | [ViewId](dd5cd741-e211-9bb3-666c-ee056520c2d9.htm) | Indicates the specific view that will be opened when the model is loaded. InvalidElementId indicates that no view has been specified. In that case, Revit will open the last views that were open at the time the file was saved. |
