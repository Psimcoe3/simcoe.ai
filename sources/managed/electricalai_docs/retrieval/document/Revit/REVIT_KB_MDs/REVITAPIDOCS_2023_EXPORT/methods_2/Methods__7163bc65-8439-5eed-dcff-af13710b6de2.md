...
|  |
| --- |
| [PathOfTravel Class](99c2bb04-151f-c325-84b2-40dee81447d6.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [PathOfTravel](99c2bb04-151f-c325-84b2-40dee81447d6.htm)  type exposes the following members.
...
| Public method Static member | [CreateMultiple(View, IList XYZ , IList XYZ )](ea3cb957-77e1-624f-0d88-7c93c894290f.htm) | Creates multiple new paths of travel between same size sets of start and end points. |
| Public method Static member | [CreateMultiple(View, IList XYZ , IList XYZ , IList PathOfTravelCalculationStatus )](ed0c9c0a-febb-c674-f548-11d728127dc3.htm) | Creates multiple new paths of travel between same size sets of start and end points and provides creation result statuses. |
...
| Public method Static member | [FindEndsOfShortestPaths](607571b1-bebe-f647-28c1-30b409475c65.htm) | For a floor plan view, calculates the paths from each start point to its closest destination and return the path end points. |
| Public method Static member | [FindShortestPaths](ed038de8-768b-f9ce-91f5-c25ac559d5fe.htm) | For a floor plan view, calculates paths from each start point to its closest destinations. Returns the path, represented by an array of XYZ points. |
| Public method Static member | [FindStartsOfLongestPathsFromRooms](d76f7dbc-c20e-ea61-8c6b-a4bd59f444c2.htm) | For a floor plan view, calculates paths from points inside rooms to the closests of the destinations. Returns the start points of the longest path(s). If multiple paths have the same longest length, returns multiple start points. |
| Public method | [GetCurves](7c222d22-ce15-daf8-aec8-01ed3098530c.htm) | Gets the array of curves representing the path of travel. |
...
| Public method | [GetWaypoints](dad6abd9-812c-f9bb-e7b9-d4a3c2e32bef.htm) | return the waypoints set for the Path of Travel |
...
| Public method | [InsertWaypoint](75f4e1f0-a543-5f50-9958-030c0fa2a2dd.htm) | Insert a waypoint at the specified index |
...
| Public method Static member | [IsInRevealObstaclesMode](f158a901-fc99-dc87-d8de-79b739b86a43.htm) | Returns current state of Reveal Obstacles mode for the given view. |
...
| Public method | [RemoveWaypoint](180917fd-f296-54f9-a824-301b99376fb5.htm) | Remove a waypoint. |
...
| Public method Static member | [SetRevealObstaclesMode](d2a2f84c-a90e-9ef0-28aa-025af61b8be3.htm) | Sets Reveal Obstacles mode for the given view. |
| Public method | [SetWaypoint](32d98435-a0bb-148f-1139-4b338b4ccd6b.htm) | Updates the specified waypoint. |
| Public method | ToString | Returns a string that represents the current object. (Inherited from  Object  .) |
| Public method | [Update](738b8438-8952-7af5-86d9-a1d631ec903b.htm) | Updates the path of travel by recalculating the path between the original start and end points. |
| Public method Static member | [UpdateMultiple(Document, IList ElementId )](2fba2f22-8d88-8b2c-c75e-8908223ec20c.htm) | Updates the specified paths of travel by recalculating each path using their original start and end points. |
| Public method Static member | [UpdateMultiple(Document, IList ElementId , IList PathOfTravelCalculationStatus )](680761c8-b660-6f65-f259-8141eb4c2c57.htm) | Updates the specified paths of travel by recalculating each path using their original start and end points and provides creation result statuses. |
...
| Public property | [LineStyle](012d6c63-fd01-a578-5b42-9a9ca095c843.htm) | The line style of the path. |
...
| Public property | [PathEnd](a763a360-481d-14e3-bcde-e3b7aea2bc82.htm) | The end point of the path. The Z coordinate will equal the view's level elevation. To update path calculations, call update. |
| Public property | [PathMidpoint](ab45a2d1-62d0-8823-0947-823f2d130e93.htm) | The midpoint of the path. The Z coordinate will equal the view's level elevation. |
| Public property | [PathStart](967e4fe9-ad0b-d275-05e9-e0bdf37c650a.htm) | The start point of the path. The Z coordinate will equal the view's level elevation. To update path calculations, call update. |
