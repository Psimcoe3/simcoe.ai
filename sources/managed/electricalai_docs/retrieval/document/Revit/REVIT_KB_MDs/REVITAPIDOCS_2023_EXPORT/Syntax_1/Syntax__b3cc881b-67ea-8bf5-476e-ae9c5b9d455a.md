...
| C# |
| --- |
| ``` public static RevisionNumberingSequence CreateNumericSequence( 	Document document, 	string name, 	NumericRevisionSettings settings ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateNumericSequence ( _ 	document As Document, _ 	name As String, _ 	settings As NumericRevisionSettings _ ) As RevisionNumberingSequence ``` |
