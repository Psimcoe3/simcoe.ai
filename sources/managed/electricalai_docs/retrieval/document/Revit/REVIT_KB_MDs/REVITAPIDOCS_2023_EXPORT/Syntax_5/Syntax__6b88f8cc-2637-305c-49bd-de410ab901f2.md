...
| Visual Basic |
| --- |
| ``` Public Property NotchHorizontalGap As Double 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property double NotchHorizontalGap { 	double get (); 	void set (double value); } ``` |

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.htm) | When setting this property: The given value for notchHorizontalGap must be between 0 and 30000 feet. |
