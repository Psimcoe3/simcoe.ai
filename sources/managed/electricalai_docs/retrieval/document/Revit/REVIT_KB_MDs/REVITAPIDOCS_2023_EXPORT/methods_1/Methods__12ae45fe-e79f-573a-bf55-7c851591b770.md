...
|  |
| --- |
| [DirectShape Class](bfbd137b-c2c2-71bb-6f4a-992d0dcf6ea8.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
|  | Name | Description |
| --- | --- | --- |
| Public method | [AddExternallyTaggedGeometry](2c551429-8b90-ed46-3e29-a6b3dbc1cb95.htm) | Adds the externally tagged geometry object to the DirectShape. |
| Public method | [AddReferenceCurve(Curve)](4937aae0-c440-6d0e-9977-f117a7322f64.htm) | Adds a reference curve to the DirectShape. |
| Public method | [AddReferenceCurve(Curve, DirectShapeReferenceOptions)](a2d32e9b-f749-7b43-b926-6c7ce54c0b3d.htm) | Adds a reference curve to the DirectShape. |
| Public method | [AddReferencePlane(Plane)](303571c6-19cb-3e6e-cd1e-99fc2a4bda79.htm) | Adds a reference plane to the DirectShape. The reference plane can either be bounded or unbounded. |
| Public method | [AddReferencePlane(Plane, BoundingBoxUV)](5a7635a2-04f5-d322-8b91-8b5584bff327.htm) | Adds a reference plane to the DirectShape. The reference plane can either be bounded or unbounded. |
| Public method | [AddReferencePlane(Plane, DirectShapeReferenceOptions)](436a9374-049e-d2df-df83-d0a6c22aa7b6.htm) | Adds a reference plane to the DirectShape. The reference plane can either be bounded or unbounded. |
| Public method | [AddReferencePlane(Plane, BoundingBoxUV, DirectShapeReferenceOptions)](4f235c9c-730f-dd05-4eb5-2b95166019ae.htm) | Adds a reference plane to the DirectShape. The reference plane can either be bounded or unbounded. |
| Public method | [AddReferencePoint(XYZ)](76610683-c067-3981-af51-47bb90e0f22e.htm) | Adds a reference point to the DirectShape. |
| Public method | [AddReferencePoint(XYZ, DirectShapeReferenceOptions)](18f765f4-0e13-b5eb-2d27-b486f93d8908.htm) | Adds a reference point to the DirectShape. |
| Public method | [AppendShape(IList GeometryObject )](c4ab9ba7-2507-2b4a-f660-8e8337212644.htm) | Appends the collection of GeometryObjects into the model shape representation stored in this DirectShape. |
| Public method | [AppendShape(ShapeBuilder)](0271f20a-5245-141f-77fe-e0cc0659bf42.htm) | Appends shape built by the supplied ShapeBuilderObject to shape representation stored in this DirectShape. The data stored in the supplied ShapeBuilder object will be cleared. |
| Public method | [AppendShape(IList GeometryObject , DirectShapeTargetViewType)](d56956bb-c2ec-8504-fb6a-717e26e1f891.htm) | Appends the collection of GeometryObjects into the model or view specific shape representation stored in this DirectShape. Passing DirectShapeTargetViewType.Default as view type will cause the model shape to be updated. |
| Public method | [AreOptionsValid](d613f35a-83ad-cc32-25a9-449b9ba04723.htm) | Validates that the given DirectShapeOptions are allowed for this particular DirectShape. |
| Public method | [AreOptionsValidForTransientDirectShape](83b95bbf-6e6d-25ab-053b-441447ac389f.htm) | Validates that the given DirectShapeOptions are allowed if this DirectShape is transient. |
...
| Public method | [CanCreateParts](00584d60-2960-36ab-f305-d2f4dda220f8.htm) | Indicates if it is possible to create parts from this DirectShape element. |
...
| Public method Static member | [CreateElement](bee8a24f-704e-44d9-e187-9e031548a6d2.htm) | Creates a DirectShape object and adds it to document. |
| Public method Static member | [CreateElementInstance](2a44c4e3-5056-eb56-f849-a7e9dcc478da.htm) | Creates a DirectShape object and adds it to document. |
| Public method Static member | [CreateGeometryInstance](8a5a08cc-14ea-9c69-26b4-5f1b0562bf53.htm) | Creates a copy of a definition shape that was created earlier. |
...
| Public method | [GetExternallyTaggedGeometry](a32792d0-1633-37c5-6ed0-02bdb9b6c4b5.htm) | Gets the externally tagged geometry by its external ID that is stored in this DirectShape. |
...
| Public method | [GetOptions](2bc77946-040e-7c75-0258-373adb8d2966.htm) | Gets a copy of the current options for this DirectShape. |
...
| Public method | [HasExternalGeometry](e17297d9-8bc9-2408-515d-2e9058e4fb5c.htm) | Checks whether the externally tagged geometry is already present in this DirectShape. |
...
| Public method Static member | [IsSupportedDocument](8651e9ac-f5cf-840b-d271-c8db2a244377.htm) | Tests whether a DirectShape or a DirectShapeType may be created in this document. |
| Public method Static member | [IsValidCategoryId](c8881d31-d410-842a-1375-5ba688191cf8.htm) | Test the category id to make sure the category is allowed for a DirectShape or DirectShapeType. |
| Public method | [IsValidGeometry](bd083561-a6e1-605e-14ce-cfe07598f3f6.htm) | Validates geometry to be stored in a DirectShape. Suitable geometry validation is performed. Additionally, the geometry must make sense as a shape representation for the category assigned to this DirectShape object. |
| Public method Static member | [IsValidReferenceCurve](af56ade3-831a-b432-c39e-bafbfed03e63.htm) | Validates that the input curve is suitable for creating a direct shape reference curve. Bounded and unbounded lines are accepted. Other bounded and unbounded curve types with natural bounds are accepted if they are not closed. Unbounded periodic curves are not allowed. |
| Public method Static member | [IsValidReferencePlaneBoundingBoxUV](fa8aa1c6-5bf2-ee0f-c264-509e53ac05b2.htm) | Validates that the input BoundingBoxUV is suitable for bounding a reference plane surface. The input BoundingBoxUV must be set and not degenerate. |
...
| Public method | [RemoveExternallyTaggedGeometry](f25a46b4-5eb7-f503-1599-bfb3b549d632.htm) | Removes the externally tagged geometry object by its external ID from this DirectShape. |
| Public method | [ResetExternallyTaggedGeometry](c209aeeb-03c9-9dbb-6b85-dd7e26188c5c.htm) | Removes all of the externally tagged geometry in this DirectShape. |
...
| Public method | [SetName](9ff002c5-3197-9feb-bd85-a497ad2c6f14.htm) | Sets the name for the DirectShape element. |
| Public method | [SetOptions](a7163c75-af77-624c-ca60-e5271827c03f.htm) | Sets the options to use for this DirectShape. |
...
| Public method | [SetTypeId](077e58a6-977e-be35-6e20-dd07daa1fdd0.htm) | Sets the DirectShapeType for the DirectShape element. |
| Public method | ToString | Returns a string that represents the current object. (Inherited from  Object  .) |
| Public method | [UpdateExternallyTaggedGeometry](c15c6964-0514-7c53-fdf0-9900ec68636f.htm) | Updates the externally tagged geometry object in the DirectShape. |

# Properties

|  | Name | Description |
| --- | --- | --- |
| Public property | [ApplicationDataId](e755cb13-e327-da62-5748-23b976c1bac0.htm) | A text string that identifies the data to the creating application. |
| Public property | [ApplicationId](e4d69298-2138-d7f7-35eb-4519452a3438.htm) | A text string that identifies the creating application. |
...
| Public property | [TypeId](349629c7-eb65-d4bd-801b-115e1a52878d.htm) | Element id of a DirectShapeType object that holds properties to be shared by this element. Optional. |
