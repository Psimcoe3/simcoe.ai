...
|  |
| --- |
| [LineLoad Class](ee5ec273-350a-1cdb-d136-0c454bb1446a.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [LineLoad](ee5ec273-350a-1cdb-d136-0c454bb1446a.htm)  type exposes the following members.
...
| Public method Static member | [Create(Document, ElementId, XYZ, XYZ, LineLoadType)](1b88a5e9-03ee-2a20-652d-f68586776dda.htm) | Creates a new hosted line load within the project. |
| Public method Static member | [Create(Document, ElementId, Int32, XYZ, XYZ, LineLoadType)](f4ad118f-7ba8-3050-2738-7ecc1704f0fb.htm) | Creates a new hosted line load within the project. |
| Public method Static member | [Create(Document, XYZ, XYZ, XYZ, XYZ, LineLoadType, SketchPlane)](350622e6-20af-8bb3-d9ae-b0bcb4d69011.htm) | Creates a new non-hosted line load within the project using data at point. |
...
| Public method | [GetCurve](9c5b8a89-b69e-63a3-b93e-8ee058e92874.htm) | Returns curve that define geometry of the line load. |
...
| Public method | [IsOrientToPermitted](8681b54f-c427-9024-9ede-98ec917d0f8d.htm) | Indicates if the provided orientation is permitted for this load. (Inherited from  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  .) |
...
| Public method Static member | [IsValidHostId](f294365b-5eee-57c0-ad6a-cbdd7bd7637f.htm) | Indicates if the provided host id can host line loads The document containing both the host and the load The id of the analytical panel that is about to host a line load True if a line load can be placed on the input host id |
...
| Public method | [SetPoints](41589a19-523d-ab5f-d72e-4e3bd7bc020d.htm) | Sets start and end point of the line load. |
...
| Public property | [EndPoint](55965bc2-8cc9-1609-2a9a-0566e478d97d.htm) | Returns the three dimensional location of the end point for the line load. |
| Public property | [ForceVector1](50cbbc07-492f-b5f3-2753-1da47d52a8db.htm) | The force vector applied to the start point of the line load, oriented according to OrientTo setting. |
| Public property | [ForceVector2](3b7d9168-aaa1-9efa-cc74-d384736e62c7.htm) | The force vector applied to the end point of the line load, oriented according to OrientTo setting. |
...
| Public property | [HostElementId](c0fc581d-431e-0749-e7d9-7218e9b426c8.htm) | The host element ID for the load. (Inherited from  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  .) |
...
| Public property | [IsHosted](76965c6d-473a-9ad9-8a72-baa7a47b055a.htm) | Indicates if the Load is hosted or non-hosted. (Inherited from  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  .) |
...
| Public property | [IsProjected](482ec1fe-b5f4-75fb-2f17-440a6170aa37.htm) | Indicates if the load is projected. |
| Public property | [IsReaction](3d159400-28fb-9f92-b4b1-1aab870c21f0.htm) | The load is reaction option. (Inherited from  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  .) |
...
| Public property | [IsUniform](e315fe82-508c-b64e-0f9a-4863596544f2.htm) | Indicates if the load is uniform. |
...
| Public property | [LoadCase](f0d56d0d-dc16-1fb2-f27f-70a989f6bbcf.htm) | The load case for the load. (Inherited from  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  .) |
| Public property | [LoadCaseId](8bb0908c-30a7-f090-7586-b1bab8e8cc42.htm) | The load case ID for the load. (Inherited from  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  .) |
| Public property | [LoadCaseName](9bf650db-2f9c-08c3-ad05-33ce349b9134.htm) | The name of the load case to which this load belongs. (Inherited from  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  .) |
| Public property | [LoadCategoryName](4a1c7865-8f07-b291-6cc8-fb23a842dad8.htm) | The name of the category to which this load belongs. (Inherited from  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  .) |
| Public property | [LoadNatureName](3f764b90-19b0-8fbb-50ae-f38400a89676.htm) | A string representing the nature of the load. (Inherited from  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  .) |
...
| Public property | [MomentVector1](0094b002-656b-9c6b-2a9c-9a4d9eb97705.htm) | The moment vector applied to the start point of the line load, oriented according to OrientTo setting. |
| Public property | [MomentVector2](ca5f8ab4-f017-81f7-46b9-de5154beaa70.htm) | The moment vector applied to the end point of the line load, oriented according to OrientTo setting. |
...
| Public property | [OrientTo](c1252918-899f-23f0-c3e8-c0e5817ef812.htm) | The load orientation option. (Inherited from  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  .) |
...
| Public property | [StartPoint](77e175b5-7495-7a20-98fc-6aa5706a7687.htm) | Returns the three dimensional location of the start point for the line load. |
...
| Public property | [WorkPlaneId](19d3d2d4-82e9-465a-5cf4-d3e613ad238f.htm) | Id of the work plane which may determine the orientation of the load. (Inherited from  [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm)  .) |
