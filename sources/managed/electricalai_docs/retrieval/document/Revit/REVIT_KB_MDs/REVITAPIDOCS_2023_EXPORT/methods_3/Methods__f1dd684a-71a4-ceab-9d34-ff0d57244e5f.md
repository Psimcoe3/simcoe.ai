...
|  |
| --- |
| [RadialArray Class](9264d95c-d206-a3c9-1759-b2eab38d3110.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [RadialArray](9264d95c-d206-a3c9-1759-b2eab38d3110.htm)  type exposes the following members.
...
| Public method Static member | [ArrayElementsWithoutAssociation](9a06b1f5-4894-09a8-cd90-b2ca8814511a.htm) | Creates a new radial array from a set of elements based on an input rotation axis. |
| Public method Static member | [ArrayElementWithoutAssociation](248559b9-c065-e05b-e8df-d60e8ed5e47d.htm) | Creates a new radial array from a single element based on an input rotation axis. |
...
| Public method | [GetCopiedMemberIds](f85c5b4b-2835-8f8b-fccf-3f690c1806b9.htm) | Retrieves the copied member Ids of the Array. (Overrides  [BaseArray GetCopiedMemberIds](ce0d8197-a99f-0ef2-32a8-51d4cc2aa101.htm)  .) |
...
| Public method | [GetOriginalMemberIds](463da165-3dc6-315a-d2d7-95118d32445a.htm) | Retrieves the original member Ids of the Array. (Overrides  [BaseArray GetOriginalMemberIds](8c15fb58-a534-abd4-0715-841ea1c1447f.htm)  .) |
...
| Public method Static member | [IsRotationAngleValid](36ec5016-3a12-dbe9-1d5d-e0c723b978f3.htm) | This indicates whether the input angle is valid. |
| Public method Static member | [IsValidArraySize](8ff3a73a-a9ad-b793-b05b-37d0b1a601bc.htm) | This indicates whether the input count is valid. |
...
| Public property | [Label](816d60e1-d4ea-cda1-4736-aa5f7d05594a.htm) | The family parameter label of the BaseArray. (Inherited from  [BaseArray](d7f9a542-0333-2e10-83a2-98afcee00b80.htm)  .) |
...
| Public property | [Name](4eecb0d1-7633-86b7-d95c-42a4362f0b2c.htm) | Get and Set the Name property (Inherited from  [BaseArray](d7f9a542-0333-2e10-83a2-98afcee00b80.htm)  .) |
| Public property | [NumMembers](d2367107-a551-96ce-19b2-b96ef41678a7.htm) | Retrieves or changes the number of the arrayed members. (Overrides  [BaseArray NumMembers](66183f2d-7dee-631d-3dcb-0d484d134c91.htm)  .) |
