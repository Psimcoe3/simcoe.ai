...
|  |
| --- |
| [FlexPipe Class](4b0e0656-4760-4a91-a777-ce50869a827a.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [FlexPipe](4b0e0656-4760-4a91-a777-ce50869a827a.htm)  type exposes the following members.
...
| Public method Static member | [IsFlexPipeTypeId](5078748d-39a2-f720-0982-8b550cc43361.htm) | Checks if given type is valid flexible pipe type. |
...
| Public method Static member | [IsPipingSystemTypeId](89bd462f-a178-5c9b-a897-44423c97bd2d.htm) | Checks if given type is valid piping system type. |
...
| Public property | [EndTangent](fa54b3c9-d87c-014b-6bc7-f38ef05cf5bd.htm) | Gets or sets the tangent vector at the end of the curve. The invalid or zero vector is ignored when setting the tangent. |
| Public property | [FlexPipeType](5b7ab8d0-bd8d-f834-5d2e-a2504d3a91ce.htm) | The flex pipe type of this flex pipe. |
| Public property | [FlowState](5f2838c6-d4ed-24fc-a79e-134c1e62cfd3.htm) | The flow state of the pipe. |
...
| Public property | [Points](8aac116b-26f3-061a-6cff-fd0bcb0be110.htm) | The points of the flex pipe. |
...
| Public property | [StartTangent](6ec88166-0a20-e0cc-da8e-bc74d27709ea.htm) | Gets or sets the tangent vector at the start of the curve. The invalid or zero vector is ignored when setting the tangent. |
