...
| C# |
| --- |
| ``` public static Conduit Create( 	Document document, 	ElementId conduitType, 	XYZ startPoint, 	XYZ endPoint, 	ElementId levelId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function Create ( _ 	document As Document, _ 	conduitType As ElementId, _ 	startPoint As XYZ, _ 	endPoint As XYZ, _ 	levelId As ElementId _ ) As Conduit ``` |
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | This conduit type is invalid. -or- This level id is invalid. -or- The points of startPoint and endPoint are too close: for MEPCurve, the minimum length is 1/10 inch. |
