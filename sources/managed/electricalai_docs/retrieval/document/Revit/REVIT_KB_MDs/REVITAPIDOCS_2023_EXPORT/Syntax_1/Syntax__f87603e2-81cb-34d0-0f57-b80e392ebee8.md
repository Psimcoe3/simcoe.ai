...
| C# |
| --- |
| ``` public static View3D Create3DOrthographic( 	Document document, 	ElementId assemblyInstanceId, 	ElementId viewTemplateId, 	bool isAssigned ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function Create3DOrthographic ( _ 	document As Document, _ 	assemblyInstanceId As ElementId, _ 	viewTemplateId As ElementId, _ 	isAssigned As Boolean _ ) As View3D ``` |
