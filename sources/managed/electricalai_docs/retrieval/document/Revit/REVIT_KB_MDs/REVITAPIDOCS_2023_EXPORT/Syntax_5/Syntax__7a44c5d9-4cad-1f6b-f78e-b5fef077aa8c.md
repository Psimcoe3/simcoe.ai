...
| C# |
| --- |
| ``` public static ElementId GetTopLevelLink( 	Document document, 	ModelPath path ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function GetTopLevelLink ( _ 	document As Document, _ 	path As ModelPath _ ) As ElementId ``` |
