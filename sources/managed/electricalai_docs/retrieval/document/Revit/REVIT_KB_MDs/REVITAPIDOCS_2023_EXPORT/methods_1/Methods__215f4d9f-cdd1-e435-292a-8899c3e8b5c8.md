...
|  |
| --- |
| [FabricArea Class](b8e6a637-e069-500d-b7d3-3500e1728681.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method | [CopyCurveLoopsInSketch](5605fe73-f63e-ee85-2670-4765dc11641b.htm) | Creates copies of the CurveLoops in the FabricArea sketch. |
| Public method Static member | [Create(Document, Element, XYZ, ElementId, ElementId)](8f5c6758-dea3-6659-c0e9-b75bc4764150.htm) | Creates a FabricArea based on a host boundary. |
| Public method Static member | [Create(Document, Element, IList CurveLoop , XYZ, XYZ, ElementId, ElementId)](4a88ee1b-9a7b-47f3-f4d9-8f30c2526a0c.htm) | Creates a FabricArea from an array of curves. |
...
| Public method | [GetBoundaryCurveIds](eae59f38-12a2-87cb-a153-642aa88d6c55.htm) | Retrieves the identifiers of the set of curves forming the boundary of the Fabric Area. |
...
| Public method | [GetFabricSheetElementIds](7c1f56f7-0dd8-d0b6-c49e-b70c3e34bafd.htm) | Retrieves the identifiers of all the FabricSheet Elements in the FabricArea. |
...
| Public method | [GetReinforcementRoundingManager](6dc448b9-1be0-95f7-a38d-c540a440c5e3.htm) | Returns an object for managing reinforcement rounding override settings. |
...
| Public method | [GetTotalSheetMass](53bbfc7e-3255-6e68-7339-5dd39af0d75b.htm) | Calculates the total sheet mass: Volume of Wire \* Unit Weight. |
...
| Public method | [GetValidViewsForTags](be0c10c4-f8b0-0149-0a73-2879cdec5076.htm) | Gets ids of the views where tags and symbols can be placed for the FabricArea and/or FabricSheets |
...
| Public method | [IsCoverOffsetValid](81963ad4-c71e-481d-3b62-d7942bcaaab3.htm) | Identifies if the specified value is valid for use as a cover offset. |
...
| Public method | [IsValidMajorLapSplice](0dfb7466-d504-e38b-7c1b-9f1d2a2eb736.htm) | Identifies if the specified value is valid for use as a major lap splice. |
| Public method | [IsValidMinorLapSplice](604dc875-594e-1e63-4cc0-1fe22848b09d.htm) | Identifies if the specified value is valid for use as a minor lap splice. |
...
| Public method Static member | [RemoveFabricReinforcementSystem](f3972463-e0b1-6998-a12e-20ee51fbd6f0.htm) | Deletes the specified FabricArea, and converts its FabricSheet elements to equivalent Single Fabric Sheet elements. |
...
| Public property | [CoverOffset](d08480ca-f6c6-93ad-c5c4-a86e157a55eb.htm) | The additional cover offset of the fabric distribution. |
...
| Public property | [Direction](b1176d0f-6911-da51-cdf9-7a6f1a185761.htm) | The Major Direction of the Fabric Area. |
| Public property | [DirectionOrigin](e35286fe-842d-2727-c8de-632e537f9c62.htm) | The Origin Point of the Major Direction of the Fabric Area. |
...
| Public property | [FabricAreaType](132f328f-c6e9-685e-c7e0-a24eaae6c234.htm) | The type of the Fabric Area. |
| Public property | [FabricLocation](fc995172-e9d1-10a0-9c95-29f5a7ead0a2.htm) | The Fabric location in the host. |
| Public property | [FabricSheetTypeId](1cf0d022-cc11-723b-88ee-6521b3700b29.htm) | The id of the Fabric Sheet Type for this element. |
...
| Public property | [HostId](f61a779d-6368-ac14-4d9b-e038eafa27ed.htm) | The id of the Host element for the fabric area. |
...
| Public property | [LapSplicePosition](3bcff20d-5715-10c6-a3b6-affee02e1263.htm) | The fabric lap splice position in the fabric distribution. |
...
| Public property | [MajorLapSpliceLength](df89be76-3196-4b46-f7fd-7fd70c5d07b7.htm) | The fabric lap splice length in the fabric distribution in the major direction. |
| Public property | [MajorSheetAlignment](cc8ee7a1-806a-c522-112f-e38fec71a708.htm) | The fabric sheet alignment in the fabric distribution in the major direction. |
| Public property | [MinorLapSpliceLength](49211af1-a01d-a89a-79de-af8b87bf5c7c.htm) | The fabric lap splice length in the fabric distribution in the minor direction. |
| Public property | [MinorSheetAlignment](95451caf-0948-3236-be43-892771a42c26.htm) | The fabric sheet alignment in the fabric distribution in the minor direction. |
...
| Public property | [SketchId](54174aa5-f45a-c7f5-5b65-5a3a9ea3af95.htm) | The id of the Sketch element for this element. |
| Public property | [TagViewId](8ab10b80-d3ee-199f-b87d-8356a85d0109.htm) | The element of the view in which to tag new members of this element. |
