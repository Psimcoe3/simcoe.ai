...
| C# |
| --- |
| ``` public static IList<ElementId> GetMassLevelDataIds( 	Document document, 	ElementId massInstanceId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function GetMassLevelDataIds ( _ 	document As Document, _ 	massInstanceId As ElementId _ ) As IList(Of ElementId) ``` |
