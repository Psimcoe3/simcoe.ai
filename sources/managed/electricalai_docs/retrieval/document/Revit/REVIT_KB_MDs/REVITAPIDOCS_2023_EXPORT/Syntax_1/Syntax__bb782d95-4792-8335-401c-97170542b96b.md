...
| Visual Basic |
| --- |
| ``` Public Shared Function CreateSketchedRun ( _ 	document As Document, _ 	stairsId As ElementId, _ 	baseElevation As Double, _ 	boundaryCurves As IList(Of Curve), _ 	riserCurves As IList(Of Curve), _ 	stairsPath As IList(Of Curve) _ ) As StairsRun ``` |
