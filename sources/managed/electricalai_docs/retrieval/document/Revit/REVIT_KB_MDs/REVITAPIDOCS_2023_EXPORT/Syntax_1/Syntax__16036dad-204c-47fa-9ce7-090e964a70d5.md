...
| Visual Basic |
| --- |
| ``` Public Shared Function RebarShapeMatchesCurvesAndHooks ( _ 	rebarShape As RebarShape, _ 	barType As RebarBarType, _ 	norm As XYZ, _ 	curves As IList(Of Curve), _ 	startHook As RebarHookType, _ 	endHook As RebarHookType, _ 	startHookOrient As RebarHookOrientation, _ 	endHookOrient As RebarHookOrientation _ ) As Boolean ``` |
