...
| C# |
| --- |
| ``` public static AdaptivePointOrientationType GetPointOrientationType( 	Document doc, 	ElementId refPointId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function GetPointOrientationType ( _ 	doc As Document, _ 	refPointId As ElementId _ ) As AdaptivePointOrientationType ``` |
