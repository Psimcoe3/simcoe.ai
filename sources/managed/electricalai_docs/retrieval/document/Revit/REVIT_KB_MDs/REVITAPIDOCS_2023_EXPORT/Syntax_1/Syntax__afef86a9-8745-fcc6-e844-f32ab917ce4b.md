...
| C# |
| --- |
| ``` public void SetAttribute( 	string name, 	ISet<IFCAnyHandle> values ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub SetAttribute ( _ 	name As String, _ 	values As ISet(Of IFCAnyHandle) _ ) ``` |
...
values
:   Type:  [System.Collections.Generic ISet](http://msdn2.microsoft.com/en-us/library/dd412081)   [IFCAnyHandle](8b893943-70fa-94bf-90be-1523d516ecb3.htm)
