...
| C# |
| --- |
| ``` public void SetLineIncluded( 	bool include, 	AreaReinforcementLayerType layer, 	int linePositionIndex ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub SetLineIncluded ( _ 	include As Boolean, _ 	layer As AreaReinforcementLayerType, _ 	linePositionIndex As Integer _ ) ``` |
