...
|  |
| --- |
| [Zone Class](b47e1280-b436-5f9d-17dc-5b315b50c5ee.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [Zone](b47e1280-b436-5f9d-17dc-5b315b50c5ee.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AddSpaces](455eec6f-75c4-1f73-ef11-326975163398.htm) | Add a set of existing spaces to Zone element. |
...
| Public method Static member | [CreateAreaBasedLoad](ea2f5648-08c1-2c26-80fa-1d143b6b4c0c.htm) | Creates a new instance of an area based load and adds it to the document. |
...
| Public method | [GetDomainData](7edb0818-7c6a-2bfc-6269-bab9c8baea35.htm) | Gets the domain data for the zone. |
...
| Public method | [RemoveSpaces](2d015441-724c-d576-fcd6-5a00d9b94d44.htm) | Remove a set of existing spaces to the current Zone element. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [Area](b409f897-1eb4-a930-8560-b120812f1c30.htm) | Get the Area of the Zone. |
...
| Public property | [Boundary](c1608fa1-1360-a8b0-1e4f-08c71467cefd.htm) | Returns the boundary of the Zone. |
...
| Public property | [CalculatedCoolingLoad](6ae85609-7bff-d53b-1333-3eb588c2a892.htm) | Get the Calculated Cooling Load of the Zone. |
| Public property | [CalculatedHeatingLoad](dbf07896-7e8b-5f87-2473-4b75f2154f14.htm) | Get the Calculated Heating Load of the Zone. |
| Public property | [CalculatedSupplyAirflow](f2911c1c-a373-e120-8e41-66a20d82c573.htm) | Get the Calculated Supply Airflow of the Zone. |
...
| Public property | [CoolingAirTemperature](dee8a5e9-2804-2a14-abf7-443af84aca34.htm) | Get or set the Cooling Air Temperature of the Zone. |
| Public property | [CoolingSetPoint](35ef2e5a-26b0-0531-26e6-33ec30bcce0b.htm) | Get or set the Cooling Set Point of the Zone. |
...
| Public property | [DehumidificationSetPoint](946a9b55-58a5-a173-a5b1-75214a2b7e3b.htm) | Get or set the DeHumidification Set Point of the Zone. |
...
| Public property | [GrossArea](caeed906-74d7-056a-1cca-c99429a87858.htm) | Get the Gross Area of the Zone. |
| Public property | [GrossVolume](8e1c141b-e240-b760-45ba-f3bc941b1b49.htm) | Get the Gross Volume of the Zone. |
...
| Public property | [HeatingAirTemperature](2dfef226-72d9-ca2b-d622-4c1ea0130575.htm) | Get or set the Heating Air Temperature of the Zone. |
| Public property | [HeatingSetPoint](badb40e3-19a0-155b-38a0-573c3bcba79f.htm) | Get or set the Heating Set Point of the Zone. |
| Public property | [HumidificationSetPoint](25894808-e69d-ec8d-f79d-d3ee49506c68.htm) | Get or set the Humidification Set Point of the Zone. |
...
| Public property | [IsDefaultZone](1c7ab253-c877-1483-341b-6e0ecec7a849.htm) | Reports whether this zone is default or not. |
...
| Public property | [Name](080e5a91-8c72-8c1e-ca29-2a1f0229218a.htm) | Get or Set the Name of the Zone. (Overrides  [Element Name](e372092e-ff47-71c2-1272-50ab08e5a41d.htm)  .) |
...
| Public property | [Perimeter](c2cd4dc0-7b4d-65cf-39cb-68ce826ee1e3.htm) | Get the Perimeter of the Zone. |
| Public property | [Phase](968ffbac-2fdd-994e-3f70-2070cab24c41.htm) | Get the Phase of the Zone. |
...
| Public property | [ServiceType](d55f087f-6d1a-99d7-07a7-7806729d4f38.htm) | Get or set the Service Type of the Zone. |
| Public property | [Spaces](c3e6c1c6-f009-c08c-ac71-4182c5000981.htm) | Get the Spaces of the Zone. |
...
| Public property | [Volume](9a86a1f5-1991-caad-7262-af88ee564e0d.htm) | Get the Volume of the Zone. |
