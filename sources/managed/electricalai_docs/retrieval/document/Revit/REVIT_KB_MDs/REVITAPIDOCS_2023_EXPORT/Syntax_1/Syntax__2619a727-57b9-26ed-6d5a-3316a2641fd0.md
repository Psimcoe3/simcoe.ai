...
| C# |
| --- |
| ``` public virtual bool Insert( 	Definition key, 	Binding item, 	ForgeTypeId groupTypeId ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Overridable Function Insert ( _ 	key As Definition, _ 	item As Binding, _ 	groupTypeId As ForgeTypeId _ ) As Boolean ``` |
