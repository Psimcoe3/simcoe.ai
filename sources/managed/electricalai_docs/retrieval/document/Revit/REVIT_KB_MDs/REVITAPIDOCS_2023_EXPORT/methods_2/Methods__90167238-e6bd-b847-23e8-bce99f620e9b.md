...
|  |
| --- |
| [FreeFormElement Class](27b9411a-d368-1541-b7db-b5157a58c581.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [FreeFormElement](27b9411a-d368-1541-b7db-b5157a58c581.htm)  type exposes the following members.
...
| Public method | [CanOffsetFace](c81b5066-cb87-192a-2095-9b96e08e9806.htm) | Determines if the input face of the FreeFormElement can be offset. |
...
| Public method Static member | [Create](a8aa4123-03a0-14c7-f4e5-7bc5a076aa8d.htm) | Creates a new FreeFormElement from a copy of the input geometry. |
...
| Public method | [SetFaceOffset](74cb7799-030d-aa76-0009-f2ac59aee9a8.htm) | Offsets a planar face of the free form element a certain distance in the normal direction. |
...
| Public method | [UpdateSolidGeometry](99abedef-afcb-2117-9196-0289668f85bc.htm) | Updates the geometry of the FreeForm element to the given shape preserving References to the existing geometry where possible (see remarks for rules). |
