...
| C# |
| --- |
| ``` public static ElementId GetElementIdForExternalDefinition( 	Document doc, 	ExternalDefinition externalDefinition ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function GetElementIdForExternalDefinition ( _ 	doc As Document, _ 	externalDefinition As ExternalDefinition _ ) As ElementId ``` |
