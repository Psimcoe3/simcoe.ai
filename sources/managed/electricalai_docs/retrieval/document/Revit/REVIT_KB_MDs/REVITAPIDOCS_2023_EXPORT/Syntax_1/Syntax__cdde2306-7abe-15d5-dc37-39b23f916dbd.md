...
| C# |
| --- |
| ``` public ScheduleFilter( 	ScheduleFieldId fieldId, 	ScheduleFilterType filterType ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub New ( _ 	fieldId As ScheduleFieldId, _ 	filterType As ScheduleFilterType _ ) ``` |
