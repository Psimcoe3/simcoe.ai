...
| C# |
| --- |
| ``` public static FilterRule CreateEqualsRule( 	ElementId parameter, 	string value ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function CreateEqualsRule ( _ 	parameter As ElementId, _ 	value As String _ ) As FilterRule ``` |
