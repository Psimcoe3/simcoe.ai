...
| Visual Basic |
| --- |
| ``` Public Property TranslationX As AnalyticalFixityState 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property AnalyticalFixityState TranslationX { 	AnalyticalFixityState get (); 	void set (AnalyticalFixityState value); } ``` |

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | When setting this property: The fixity state translationX is not valid for Analytical Link Type parameters. |
