...
| C# |
| --- |
| ``` public void AddConstraintDiameter( 	ElementId paramId, 	RebarShapeArcReferenceType arcRefType ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub AddConstraintDiameter ( _ 	paramId As ElementId, _ 	arcRefType As RebarShapeArcReferenceType _ ) ``` |
