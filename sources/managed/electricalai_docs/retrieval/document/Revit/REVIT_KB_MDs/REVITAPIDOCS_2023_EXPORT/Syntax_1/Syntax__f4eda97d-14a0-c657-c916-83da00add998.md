...
| Visual Basic |
| --- |
| ``` Public Shared Sub CreateReferenceCallout ( _ 	document As Document, _ 	parentViewId As ElementId, _ 	viewIdToReference As ElementId, _ 	point1 As XYZ, _ 	point2 As XYZ _ ) ``` |
