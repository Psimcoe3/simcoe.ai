...
|  |
| --- |
| [FilledRegionType Class](850ae173-379b-bfd6-7295-3950ccc229ca.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [FilledRegionType](850ae173-379b-bfd6-7295-3950ccc229ca.htm)  type exposes the following members.
...
| Public method Static member | [IsValidLineWeight](36e69e7b-4bb3-b27a-f8e0-7d2afc3baf3a.htm) | Indicates whether the given line weight value is valid. |
...
| Public property | [BackgroundPatternColor](3300fa4e-2a5d-0366-6a89-42b55a4383fc.htm) | The background fill pattern color. |
| Public property | [BackgroundPatternId](eec4b9cd-f084-9732-097c-981620303fdd.htm) | The background fill pattern Id. |
...
| Public property | [ForegroundPatternColor](539f5a5e-e9a1-cafb-0d2b-350645041f87.htm) | The foreground fill pattern color. |
| Public property | [ForegroundPatternId](5ac029c0-7345-16eb-3ea7-8028eff9a121.htm) | The foreground fill pattern Id. |
...
| Public property | [IsMasking](fd52beff-fc1d-ff30-3e60-454a1d863a44.htm) | If true then the FilledRegion will cover the lines and edges of objects behind it. If false then lines and edges will remain visible. |
...
| Public property | [LineWeight](bf852993-cbe3-330f-e8d5-7a17c45c8ce8.htm) | The line weight of the fill pattern. |
