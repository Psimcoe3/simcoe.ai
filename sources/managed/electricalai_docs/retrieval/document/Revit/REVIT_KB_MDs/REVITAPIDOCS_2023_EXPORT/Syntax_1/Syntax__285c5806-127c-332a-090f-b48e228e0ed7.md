...
| C# |
| --- |
| ``` public void SetAttribute( 	string name, 	ISet<string> values ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Sub SetAttribute ( _ 	name As String, _ 	values As ISet(Of String) _ ) ``` |
...
values
:   Type:  [System.Collections.Generic ISet](http://msdn2.microsoft.com/en-us/library/dd412081)   [String](http://msdn2.microsoft.com/en-us/library/s1wwdcbf)
