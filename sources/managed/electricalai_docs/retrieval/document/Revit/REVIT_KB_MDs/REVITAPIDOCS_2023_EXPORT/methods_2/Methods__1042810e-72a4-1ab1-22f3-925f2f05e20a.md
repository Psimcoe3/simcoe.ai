...
|  |
| --- |
| [NumberingSchema Class](8f2b22da-5963-301f-44d8-10c68828c436.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [NumberingSchema](8f2b22da-5963-301f-44d8-10c68828c436.htm)  type exposes the following members.

# Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [AppendSequence](0a89ca78-ca34-93fa-4fa7-71883a535497.htm) | Appends all elements of one numbering sequence to the end of another sequence. |
...
| Public method | [AssignElementsToSequence](fd765b3c-368b-cf14-6bb0-b772f503370f.htm) | Assigns the input elements to a sequence identified by the given partition name. |
...
| Public method | [ChangeNumber](dc93cd7f-dc11-45da-3ed6-c459d1c55c97.htm) | Replaces an existing number with a new one (that does not exist yet). |
...
| Public method Static member | [GetMinimumNumberOfDigits](80ac3f63-6383-ba62-380f-0e61b98e8dd7.htm) | Returns the minimum number of digits to be used for formating the Number parameter of all enumerable elements of the given document. |
...
| Public method Static member | [GetNumberingSchema](fb3e529c-bccd-40fb-c24d-c5de5296edea.htm) | Returns an instance of the specified Numbering Schema in the given document. |
| Public method | [GetNumberingSequences](0eea26e0-24c0-154b-b7ac-c24b47eafa96.htm) | Returns all numbering sequences within this numbering schema. |
| Public method | [GetNumbers](3153106d-9f77-eb5d-20af-cd651e91b640.htm) | Returns all numbers currently used in the given numbering sequence |
...
| Public method Static member | [GetSchemasInDocument](9bd7a9f5-49af-1d41-9f55-932723b7023e.htm) | Returns a set of Ids of all Numbering Schema elements for a given document. |
...
| Public method Static member | [IsValidPartitionName](a250660a-5dcb-47a6-1960-e3750fd4df8a.htm) | Tests if the given string can be used as a name for a numbering partition. |
...
| Public method | [MergeSequences](45697dc7-68b2-4fa8-1bea-8f65983f23a0.htm) | Merges all elements from given numbering sequences to a new sequence. |
| Public method | [MoveSequence](9ae38f60-e76f-5bd7-1d71-bd57cf06f641.htm) | Moves all elements of a numbering sequence from one partition to another. |
...
| Public method | [RemoveGaps](a97a1aff-4afe-7aa7-098a-f71229efdccd.htm) | Removes gaps, if any, in a numbering sequence |
...
| Public method Static member | [SetMinimumNumberOfDigits](5b78eda1-9ad6-9c9d-bfe4-bdb6752c262f.htm) | Sets a new value for the minimum number of digits to be used for formating the Number parameter of all numbered elements of the given document. |
| Public method | [ShiftNumbers](8962e7e3-0860-acd5-c488-d8f93867b1c1.htm) | Shifts all numbers in the sequence so the starting number has the given value. |
...
| Public property Static member | [MaximumStartingNumber](f7a8b906-ee60-2a71-bc1a-30fa81b4f299.htm) | A static property defining the maximum number a numbering sequence can use as its starting number (the lowest number in the sequence). |
...
| Public property | [NumberingParameterId](94659f29-c7f2-9643-f443-9451a3177cc2.htm) | Id of the parameter that stores values of the numbers on enumerated elements. |
...
| Public property | [SchemaType](6c9d8ec5-3622-95ca-e3dc-c663f0a3b155.htm) | Identifies the kind of elements/objects this numbering schema is used for. |
