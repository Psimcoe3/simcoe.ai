...
|  |
| --- |
| [ElectricalSetting Class](d0c5bb12-7cf7-35e0-fc72-51e491c56bc2.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
|  | Name | Description |
| --- | --- | --- |
| Public method | [AddDistributionSysType](298ea72a-5647-a71d-d6d5-9da1dab5ecbd.htm) | Add a new distribution system type to project. |
| Public method | [AddVoltageType](49eaeba6-d43d-5af8-a80e-4f0259d137c7.htm) | Add a new type definition of voltage into project. |
| Public method | [AddWireMaterialType](bda3127d-4237-2400-aae0-2e3d9d861a98.htm) | Add a new type of wire material. |
| Public method | [AddWireType](96fef9f1-166b-082d-1ec7-e844ac51297f.htm) | Add a new wire type to project. |
...
| Public method Static member | [GetCircuitNamingSchemeSettings](33a63ebf-0879-2386-9a91-b52d78b60462.htm) | Gets the circuit naming scheme settings of the project. |
...
| Public method Static member | [GetElectricalSettings](302abeae-4875-bb5d-db5d-d6e6cfa8afb8.htm) | Get the electrical settings of the project. |
...
| Public method | [GetSpecificFittingAngles](b0948977-6da0-58fb-3a38-5d10e685ecc4.htm) | Gets the list of specific fitting angles. |
| Public method | [GetSpecificFittingAngleStatus](0d6e6888-83d5-89fb-77ba-dfab13f2ca81.htm) | Gets the status of given specific fitting angle. |
...
| Public method | [IsValidSpecificFittingAngle](3ba25c52-38b9-2908-c073-3632537977a6.htm) | Checks that the given value is a valid specific fitting angle. The specific fitting angles are angles of 90, 60, 45, 30, 22.5 or 11.25 degrees. |
...
| Public method | [RemoveDistributionSysType](1170cd1f-0209-53f6-dd7c-f294bc4e3e8f.htm) | Remove an existing distribution system type from the project. |
| Public method | [RemoveVoltageType](657db947-8a83-86fa-da81-2451fc2026d6.htm) | Remove the voltage type from project. |
| Public method | [RemoveWireMaterialType](d3193518-abc6-0c64-cbf8-332b04bef8ad.htm) | Remove the wire material type from project. |
| Public method | [RemoveWireType](2a4cbba1-f777-47b5-e3c2-941950f172ba.htm) | Remove wire type definition from project. |
...
| Public method | [SetSpecificFittingAngleStatus](799e261d-93b7-062c-efcb-f370550ce67c.htm) | Sets the status of given specific angle. |
...
| Public property | [CircuitLoadCalculationMethod](2554ffbc-6e19-677a-cd3a-a267d2664d10.htm) | The method to calculate circuit load |
| Public property | [CircuitNamePhaseA](f6cce876-b1cd-7884-cba4-06c57f790f8e.htm) | Circuit Naming by Phase - Phase A Label. |
| Public property | [CircuitNamePhaseB](3036634e-8530-fac4-8f76-d08e662ad858.htm) | Circuit Naming by Phase - Phase B Label. |
| Public property | [CircuitNamePhaseC](95cfc9a6-b8d8-1290-ce7a-b43c61cbee96.htm) | Circuit Naming by Phase - Phase C Label. |
| Public property | [CircuitPathOffset](6eec48f1-11dd-bb3b-cdc2-86aba7677698.htm) | The default circuit path offset for newly created circuit. |
| Public property | [CircuitRating](68c26af5-18b0-0a5f-5250-9a63c190c1eb.htm) | The default circuit rating for newly created circuit. |
| Public property | [CircuitSequence](174553d3-a7c0-e253-5e36-19a5c57f0132.htm) | The sequence in which power circuits are created. |
...
| Public property | [DistributionSysTypes](64780ae2-610f-35a1-18be-88b7be2e4abc.htm) | Get all distribution system types of the project. |
...
| Public property | [VoltageTypes](537601fb-42b8-f7b0-bd1a-58b4e4adf437.htm) | Get all voltage type definitions information of the project. |
| Public property | [WireConduitTypes](62dab13d-2046-6d3d-59af-2a8cf4b7fd74.htm) | Get electrical conduit types information of the project. |
| Public property | [WireMaterialTypes](dd5bc515-19eb-79b3-a5e3-2c7586b11599.htm) | Get electrical wire material types information of the project. |
| Public property | [WireTypes](2cf6315a-b891-db9d-677a-89a8d73dd7cf.htm) | Get all wire type definition information of the project. |
