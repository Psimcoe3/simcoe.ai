...
|  |
| --- |
| [Truss Class](e0cdc591-cac6-57c7-6190-f0d48cc0e4a9.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |

The  [Truss](e0cdc591-cac6-57c7-6190-f0d48cc0e4a9.htm)  type exposes the following members.
...
| Public method | [AttachChord](a0fc36fe-2c63-1a2c-0643-627b8560f09c.htm) | Attach a truss's specific chord to a specified element, the element should be a roof or floor. |
...
| Public method Static member | [Create](2d6a9c76-9a39-8161-a203-e4f8084495ef.htm) | Creates a new Truss. |
...
| Public method | [DetachChord](a4540c86-9de5-1b40-1839-99d7224d4cde.htm) | Detach a truss's specific chord from the element to which it is attached. |
...
| Public method Static member | [DropTruss](397bb02f-794d-a0e9-5ea8-4ca3dc9a459c.htm) | Drop truss Family, it will disassociate all members from the truss and delete the truss. |
...
| Public method | [GetTrussMemberInfo](885bcdab-10c1-5857-29db-3b95fe43be6d.htm) | Query if a given element is a member of a truss, its lock status and its usage, etc. |
...
| Public method | [RemoveProfile](4c7c3d83-3288-ba90-0f6d-b3797422d818.htm) | Remove the profile of a truss. |
...
| Public method | [SetProfile](5d80c385-94dd-4601-f83a-1e7db3662a25.htm) | Add or modify the profile of a truss. |
| Public method | [TogglePinMember](675dc4a6-ee96-22d5-367e-ed2b44d8562d.htm) | Pin/Unpin a truss member. |
...
| Public property | [Curves](1cc0d1e3-a946-f2bd-56ca-fcd407dc552c.htm) | Get all the truss curves. |
...
| Public property | [Members](ac8c1ca8-0d19-706e-403b-3be82c6f082f.htm) | Get all the members of truss. |
...
| Public property | [TrussType](e5aac783-7724-bc13-3d49-002edf50ef66.htm) | Retrieve/set an object that represents the type of the truss. |
