...
class PathOfTravelCalculationRequestType:
    CalculateForCorrespondingStartEndPairs = 0
    CalculateForAllPossibleStartEndPairs = 1
    CalculateFarthestPointsToMultipleDestinations = 2
    GetRevealObstaclesModeInView = 3
    SetRevealObstaclesModeInView = 4
    LockCache = 5
    UnlockCache = 6
    CalculateForPathsWithWaypoints = 7
    GetDistanceMapModeInView = 8
    SetDistanceMapModeInView = 9
    CalculateShortestPathsToMultipleDestinations = 10
