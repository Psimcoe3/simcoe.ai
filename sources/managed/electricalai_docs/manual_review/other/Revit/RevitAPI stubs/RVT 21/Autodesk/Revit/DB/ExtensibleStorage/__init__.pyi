...
class Field:
    ...
    def CompatibleDisplayUnitType(self, type: DisplayUnitType) -> bool: ...
...
class Entity:
    ...
    @overload
    def Get(self, fieldName: str, displayUnits: DisplayUnitType) -> FieldType: ...
    @overload
    def Get(self, field: Field, unitTypeId: ForgeTypeId) -> FieldType: ...
    @overload
    def Get(self, field: Field, displayUnits: DisplayUnitType) -> FieldType: ...
    @overload
    ...
    @overload
    def Set(self, fieldName: str, value: FieldType, displayUnits: DisplayUnitType) -> None: ...
    @overload
    def Set(self, field: Field, value: FieldType, unitTypeId: ForgeTypeId) -> None: ...
    @overload
    def Set(self, field: Field, value: FieldType, displayUnits: DisplayUnitType) -> None: ...
    @overload
...
class Schema:
    ...
    def EraseSchemaAndAllEntities(schema: Schema, overrideWriteAccessWithUserPermission: bool) -> None: ...
...
class FieldBuilder:
    ...
    @property
    def IsValidObject(self) -> bool: ...
    def SetUnitType(self, units: UnitType) -> FieldBuilder: ...
