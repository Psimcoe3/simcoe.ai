...
class FabricationNetworkChangeService:
    ...
    def IsValidObject(self) -> bool: ...
    @overload
    def ChangeService(self, selection: ISet, serviceId: int, groupId: int, restrictGroup: bool) -> FabricationNetworkChangeServiceResult: ...
    @overload
    def ChangeService(self, selection: ISet, serviceId: int, groupId: int) -> FabricationNetworkChangeServiceResult: ...
...
class FabricationPartSizeMap:
    @overload
    def __init__(self, size: str, widthDiameter: float, depth: float, isProductList: bool, profileType: ConnectorProfileType, serviceId: int, groupId: int): ...
    @overload
