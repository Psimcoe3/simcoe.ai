...
class FamilyItemFactory(ItemFactoryBase):
    ...
    def NewBlend(self, isSolid: bool, topProfile: CurveArray, baseProfile: CurveArray, sketchPlane: SketchPlane) -> Blend: ...
...
class Application(APIObject):
    ...
    def NewImageImportOptions(self) -> ImageImportOptions: ...
