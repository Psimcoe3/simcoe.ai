...
class RebarShape(ElementType):
    ...
    def SetEndTreatmentTypeId(self, treatmenetId: ElementId, iEnd: int) -> None: ...
...
class RebarBendData:
    ...
    def BarDiameter(self) -> float: ...
    @BarDiameter.setter
    def BarDiameter(self, barDiameter: float) -> None: ...
    @property
...
class ReinforcementRoundingManager:
    ...
    @property
    def LengthDisplayUnit(self) -> DisplayUnitType: ...
    @property
    def IsValidObject(self) -> bool: ...
    def Dispose(self) -> None: ...
...
class ReinforcementSettings(Element):
    ...
    def GetReinforcementSettings(cda: Document) -> ReinforcementSettings: ...
...
class StructuralConnectionHandler(Element):
    ...
    @overload
    def Create(document: Document, idsToConnect: List[ElementId]) -> StructuralConnectionHandler: ...
    ...
    def GetSubPartIds(self) -> List[ElementId]: ...
    def GetOrigin(self) -> XYZ: ...
